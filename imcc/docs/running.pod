...
More I<-d> give more debug output
...
If B<-r> or B<-c> are not present, a PASM file is generated. If the
B<-o> option is not used, either F<a.pasm> or F<a.pbc> in the current
working dir are created.
