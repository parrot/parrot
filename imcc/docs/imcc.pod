...
IMCC is the B<I>nterB<m>ediate B<C>ode B<C>ompiler for Parrot.  It's integrated into the
C<parrot> executable.
...
the extension C<.pir>. At times in the past the extension C<.imc> was used as well, but C<.pir> is preferred.
