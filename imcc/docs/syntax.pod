...
=head2 Deprecated directives for subroutine parameters and return
...
be stored.  Available flags, not yet implemented in the old calling
convention: C<:slurpy> and C<:optional>.  [XXX Chip - finish this
update]

=item .param <reg> [:<flag> ...]

At the top of a subroutine, specify where parameter(s) of the current
subroutine should be stored.  Available flags, not yet implemented in
the old calling convention: C<:slurpy> and C<:optional>.  [XXX Chip -
finish this update]
...
=head2 Deprecated directives for making a PCC call
...
value(s) should be stored.  Available flags, not yet implemented in
the old calling convention: C<:slurpy> and C<:optional>.  [XXX Chip -
finish this update]
