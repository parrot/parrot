...
=head1 NOTE ABOUT CHANGES IN PROGRES
...
":flat" adverb for arguments and ":slurpy" for parameters, will make
...
be flattened out into a list, append ":flat" to the argument name in
the ".arg" directive or in the shortcut parameter list.
