...
void Parrot_half_pop_i(struct Parrot_Interp *);
void Parrot_half_pop_n(struct Parrot_Interp *);
void Parrot_half_pop_s(struct Parrot_Interp *);
void Parrot_half_pop_p(struct Parrot_Interp *);
