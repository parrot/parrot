...
op_lib_t *Parrot_DynOp_core_3_10_0(PARROT_INTERP, long init);
 ...
 opcode_t * Parrot_interp_info_p_i(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_interp_info_p_ic(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_interp_info_s_i(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_interp_info_s_ic(opcode_t *, PARROT_INTERP);
