...
op_lib_t *PARROT_CORE_OPLIB_INIT(PARROT_INTERP, long init);
 ...
 opcode_t * Parrot_get_sc_object_p_s_i(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_get_sc_object_p_sc_i(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_get_sc_object_p_s_ic(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_get_sc_object_p_sc_ic(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_get_sc_p_s(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_get_sc_p_sc(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_create_sc_p_s(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_create_sc_p_sc(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_set_sc_object_s_i_p(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_set_sc_object_sc_i_p(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_set_sc_object_s_ic_p(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_set_sc_object_sc_ic_p(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_set_sc_object_s_i_pc(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_set_sc_object_sc_i_pc(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_set_sc_object_s_ic_pc(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_set_sc_object_sc_ic_pc(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_set_sc_for_object_p_p(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_set_sc_for_object_pc_p(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_set_sc_for_object_p_pc(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_set_sc_for_object_pc_pc(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_get_sc_for_object_p_p(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_get_sc_for_object_p_pc(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_get_package_through_who_p_p_s(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_get_package_through_who_p_pc_s(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_get_package_through_who_p_p_sc(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_get_package_through_who_p_pc_sc(opcode_t *, PARROT_INTERP);
 ...
 opcode_t * Parrot_decontainerize_p_p(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_decontainerize_p_pc(opcode_t *, PARROT_INTERP);
 ...
 opcode_t * Parrot_set_invocation_spec_p_p_s_p(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_set_invocation_spec_p_p_sc_p(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_set_boolification_spec_p_i_p(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_set_boolification_spec_p_ic_p(opcode_t *, PARROT_INTERP);
