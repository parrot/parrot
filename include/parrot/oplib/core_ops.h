...
op_lib_t *Parrot_DynOp_core_3_10_0(PARROT_INTERP, long init);
 ...
 opcode_t * interpinfo_i_i(opcode_t *, PARROT_INTERP);
 opcode_t * interpinfo_i_ic(opcode_t *, PARROT_INTERP);
 opcode_t * interpinfo_p_i(opcode_t *, PARROT_INTERP);
 opcode_t * interpinfo_p_ic(opcode_t *, PARROT_INTERP);
 opcode_t * interpinfo_s_i(opcode_t *, PARROT_INTERP);
 opcode_t * interpinfo_s_ic(opcode_t *, PARROT_INTERP);
