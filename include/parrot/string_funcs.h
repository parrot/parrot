...
PARROT_API INTVAL string_bool( Interp *interp, const STRING *s );
...
PARROT_API STRING * string_compose( Interp *interp, STRING *src );
...
PARROT_API void string_cstring_free( char *p );
PARROT_API void string_deinit( Parrot_Interp interp );
PARROT_API STRING * string_downcase( Interp *interp, const STRING *s );
...
PARROT_API STRING * string_escape_string( Interp *interp, const STRING *src );
...
PARROT_API STRING * string_increment( Interp *interp, const STRING *s );
PARROT_API INTVAL string_index( Interp *interp, const STRING *s, UINTVAL idx );
...
PARROT_API INTVAL string_ord( Interp *interp, const STRING *s, INTVAL idx );
PARROT_API void string_pin( Interp *interp, STRING * s );
PARROT_API const char* string_primary_encoding_for_representation( Interp *interp,
    parrot_string_representation_t representation );

PARROT_API STRING* string_printf( Interp *interp, const char *format, ... );
...
PARROT_API STRING * string_titlecase( Interp *interp, const STRING *s );
PARROT_API void string_titlecase_inplace( Interp *interp, STRING *s );
PARROT_API char * string_to_cstring( Interp *interp,
    const STRING * const s /* NULLOK */ );

PARROT_API INTVAL string_to_int( Interp *interp, const STRING *s );
PARROT_API FLOATVAL string_to_num( Interp *interp, const STRING *s );
PARROT_API STRING * string_unescape_cstring( Interp *interp,
    const char *cstring,
    char delimiter,
    const char *enc_char );

PARROT_API void string_unpin( Interp *interp, STRING * s );
PARROT_API STRING * string_upcase( Interp *interp, const STRING *s );
PARROT_API void string_upcase_inplace( Interp *interp, STRING *s );
