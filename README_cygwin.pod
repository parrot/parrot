...
=item *** fatal error - unable to remap ....

Evidently, this problem results from a relocated C<cygwin1.dll>.  For more on
this problem, I<see> http://www.cygwin.com/ml/cygwin/2009-05/msg00413.html

The fix is to issue a C<rebaseall> command in Cygwin's C<rebase> package.
For information on how to do this, I<see>
http://www.heikkitoivonen.net/blog/2008/11/26/cygwin-upgrades-and-rebaseall/
For more information on the problem, I<see also>
I<and see> http://code.google.com/p/chromium/wiki/CygwinDllRemappingFailure

=item Exception: STATUS_ACCESS_VIOLATION ....

If this exception results, please ensure you have only a single version of
C<cygwin1.dll> present on your system or, alternatively, ensure no application
interferes with Cygwin. For more information on this problem, I<see> the
Cygwin/X FAQ at
...
If the build aborts, it might be necessary to include already built DLLs in
the rebase. For instructions on how to resolve this problem, I<see> the
"PROBLEMS" section 
http://cpansearch.perl.org/src/BFREE/OpenGL-0.57/README.cygwin
