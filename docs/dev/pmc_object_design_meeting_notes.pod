...
B<Att:> SELF ist just a synonym for I<pmc> - the object - above is talking about SELF.method() and alikes. See F<lib/Parrot/Pmc2c.pm>.
...
A METHOD defined in a PMC won't work unless it's been specifically coded to work in a PIR-based subclass. See L<http://xrl.us/s7ns>.
