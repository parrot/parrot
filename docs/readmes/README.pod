...
=item * As a rule, prefer C<=item *> with which to set out items or to set out an outline. 
...
=over 8 
      ...
      Copyright (C) [year]-[year], Parrot Foundation
