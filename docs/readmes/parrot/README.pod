...
For where to go from here, I<see> 'docs/parrot.pod' and I<see> 'docs/intro.pod'.  If you experience problems, please I<see> the section "How To Submit A Bug Report" in 'docs/submissions.pod'.  These documents are in POD format, and you can view them with the command,
...
For development discussions, I<see> the information in 'docs/gettingstarted.pod'.

=head1 FEEDBACK, PATCHES, etc.

For more information on how to report bugs and to submit patches, I<see> 'docs/submissions.pod'.
