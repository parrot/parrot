...
All allocated items are managed in memory pools. Memory pools holds 
...
parrot bytecode are managed here. Exceptions currently are objects
...
The general object of this kind is a buffer-like object, which consists
of a I<Buffer> at the beginning and a variable but fixed sized part after the
buffer structure. Examples of this are a I<STRING> or an I<IntList>.
