...
Templates for to be generated files usually have the extension '.in'.
There is variable substitutes and funny macros like 'CONDITIONED_LINE'
and INVERSE_CONDITIONED_LINE'.
