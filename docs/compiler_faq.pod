...
You can access attributes by a short name, a fully qualified name, or by an
index.
...
Just define a method named C<__init> in the namespace of the class.
