...
doesn't handle inheritance" bit.  Please refer to PDD03 at this moment while 
we rewrite or merge this document.  We apologize for the inconvenience.
...
unique number which is used to find the correct function table. This 
is the C<func_num> parameter in the following functions. While Parrot
...
Register a function C<funcptr> for MMD function table C<func_num> for
