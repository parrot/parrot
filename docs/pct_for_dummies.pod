...
The generated directories and files have the following structure:
 ...
 foo/
    ...
    /src/
        /parser/
               /actions.pm     # the language's grammar rules
               /grammar.pm     # a file containing the parse actions
                               # these files should be updated to change your
                               # language
        /builtins/
...
please send an email to C<perl6-internals@perl.org>.
