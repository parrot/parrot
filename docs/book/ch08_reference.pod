...
X<.pcc_begin directive>

Start a call sequence. Always paired with C<.pcc_end>

=head2 .pcc_begin_return

X<.pcc_begin_return directive>

Start a return sequence. Always paired with C<.pcc_end_return>

=head2 .pcc_begin_yield

X<.pcc_begin_yield directive>

Start a return of a coroutine sequence. Always paired with C<.pcc_end_yield>

=head2 .pcc_call

X<.pcc_call directive>
...
The R<file> is either an F<.imc> (F<.pir>) or F<.pasm> source file or a
