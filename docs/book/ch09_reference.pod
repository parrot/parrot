...
looking up PIR syntax you should check A<CHP-9-SECT-1>"PASM Opcodes",
A<CHP-9-SECT-2>"PIR Directives", and A<CHP-9-SECT-3>"PIR
Instructions".
...
information to return, as listed in A<CHP-9-TABLE-2>Table 11-2.
...
A<CHP-9-TABLE-3>Table 11-3. When R<hexbits> isn't specified,
