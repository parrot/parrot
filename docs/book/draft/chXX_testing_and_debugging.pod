...
You don't have to understand the code behind a PIR
instruction. To test it, you only have to understand
...
for testing Parrot, like the fact that PIR code has to be
