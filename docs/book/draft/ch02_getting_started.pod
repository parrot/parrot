...
Once you've installed Parrot, run it.  Create a test file called F<news.pir>.
C<.pir> files contain PIR (Parrot Intermediate Representation); this is a
...
Parrot supports directives used within PIR code to change the behavior
