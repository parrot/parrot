...
machine's native instruction set, generally called opcodes.
...
X<ge (greater than or equal);opcode>
...
X<le (less than or equal);opcode>
...
X<new_callback opcode>

  new_callback R<DEST>, R<SUB>, R<DATA>, R<SIG>

Create a callback stub R<DEST> for a subroutine R<SUB> with user
