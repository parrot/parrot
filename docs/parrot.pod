...
C<perl6-internals@perl.org> mailing list. Dan Sugalski
(C<dan@sidhe.org>) is the chief architect, and Simon Cozens
(C<simon@netthink.co.uk>) is the current release manager.
