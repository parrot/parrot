...
=item C<PackFile_ConstTable_pack> will be removed

=item C<PackFile_ConstTable_pack_size> will be removed

=item C<PackFile_destroy> renamed to C<Parrot_pf_new>

=item C<PackFile_fixup_subs> => C<Parrot_pf_fixup_subs>

=item C<PackFile_new> renamed to C<Parrot_pf_new>

=item C<PackFile_new_dummy>

=item C<PackFile_pack> renamed to C<Parrot_pf_pack>

=item C<PackFile_pack_size> renamed to C<Parrot_pf_pack_size>
...
=item C<Parrot_ex_throw_from_c_noargs>
