...
=head1 SYNOPSIS
    ...
    int main(int argc, char *argv[]) {
        ...
        /* set the name of the executable embedding Parrot */
        Parrot_set_executable_name(interp,
            string_from_cstring(interp, argv[0], 0));
...
interpreter that will be destroyed last.  You can only have one main
...
=item C<void Parrot_set_executable_name(Parrot_Interp, Parrot_String)>

Sets the name of the executable embedding Parrot; some Parrot code (and
languages) rely on this.
