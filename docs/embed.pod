...
=item C<Parrot_Interp Parrot_Interp Parrot_new(Parrot_Interp parent)>
...
=item C<void Parrot_on_exit(Parrot_Interp interp, void (*handler)(Parrot_Interp, int, void *), void *arg)>
