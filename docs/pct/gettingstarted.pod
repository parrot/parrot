...
The acronyms you should learn are:
...
make a small edit to a file located in C<config/gen/languages.pm>. You'll see
an array named C<languages> being initialized with a list of languages. Just
add the name of the directory of your language, in this example's case C<foo>.
Save the file, and run the following command from the Parrot root directory:
...
of output you want. This is the C<target> option:
 ...
 $ ../../parrot foo.pbc --target=pir I<file.foo>
