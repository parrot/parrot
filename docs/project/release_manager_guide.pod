...
Announce the new release to parrot-porters and to the IRC channel #parrot
...
F<RESPONSIBLE_PARTIES>, F<LANGUAGES_STATUS>, etc.

You might also select a name for your release (e.g., perhaps
...
once the release is done.  This process is explained in L<Appendix 1|"Appendix 1 - Releasing from a branch">.
...
Update this file to remove the pending release you're in the middle of.
