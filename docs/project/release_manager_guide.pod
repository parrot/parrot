...
A couple of weeks in advance: Ask people to run C<make fulltest> and C<make
codetest> and report (and hopefully fix!) any problems they find.
...
Make sure everything works:
 ...
 $ make codetest        2>&1 | tee make_codetest.log
