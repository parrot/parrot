...
once the release is done.  This process is explained in L<Appendix 1>.
...
The date of the next release is in L<Appendix 2>.

=item C<rt.tracking>

Create a new ticket for the next release.  Change the URL fragment here to use
that ticket's number.  Please use the release month in the ticket, and *don't*
...
You may check with C<perl t/native_pbc/*.t>
...
Make sure everything works:
 ...
 $ make -s all world fulltest html 2>&1 | tee make_log.txt
...
in step 3, above.
 ...
 $ export SVNPARROT=http://svn.perl.org/parrot
...
Submit the use Perl announcement story to Slashdot, Newsforge, LWN, etc.
...
The Parrot repository layout as of end of Apr 2005:
...
that release.
 ...
 - Feb 19th (0.5.3) Patrick Michaud
 - Mar 18th (0.6.0) Bernhard Schmalhofer
 - Apr 15th (0.6.1) Jerry Gay
 - May 20th (?)     chromatic
