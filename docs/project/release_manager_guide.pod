...
If you have commit privs to the parrotcode repository, be sure to test
locally in combust before committing.  Otherwise, make the changes
in your working copy and send a patch to webmaster@parrotcode.org.
