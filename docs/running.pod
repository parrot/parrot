...
may be available on your system:
  ...
  jit           generate native code at compile time
...
Older currently ignored options include:
  ...
  switch, cgp, function, switch-jit, cgp-jit
...
cgp, switch, and switch-jit, cgp-jit are currently aliases for
fast.
...
jumps to JIT-compiled native code for supported opcodes.
