...
prefixed with "0b", in binary.  There must be exactly one integer for
each value or register given.
...
return-value opcodes:
    ...
    0b0011  TYPE
               ...
               0b00 = S    XXX   even in pasm?  The register types
               0b00 = P    XXX   are right there on the very same
               0b00 = N    XXX   pasm source line.
...
or method, use the C<set_returns> opcode to tell Parrot where the
