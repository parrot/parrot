...
=item set_attr
  ...
  void set_attr(INTERP, PMC* self, INTVAL idx, PMC* value) [deprecated: See RT #48585]
...
A Pair PMC represents one key => value mapping.
Thus it is like a one element hash or a two element array.
