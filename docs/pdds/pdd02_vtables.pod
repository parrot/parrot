...
=item void set_string_unicode(INTERP, PMC* self, STRING* value)

Sets the PMC to the passed in string value.

=item void set_string_other(INTERP, PMC* self, STRING* value)
...
=item void bitwise_or_int_keyed(INTERP, PMC* self, KEY* key, INTVAL value, PMC* dest, KEY* dest_key)

=item void bitwise_or_int_keyed_int(INTERP, PMC* self, INTVAL* key, INTVAL value, PMC* dest, INTVAL* dest_key)

Calculate the bitwise-OR of B<self> keyed by B<key> and B<value>,
and store the result in B<dest_key>.
...
=item void bitwise_or_same_keyed(INTERP, PMC* self, KEY* key, PMC* value, KEY* value_key, PMC* dest, KEY* dest_key)

=item void bitwise_or_same_keyed_int(INTERP, PMC* self, INTVAL* key, PMC* value, INTVAL* value_key, PMC* dest, INTVAL* dest_key)

Calculate the bitwise-OR of B<self> keyed by B<key> and B<value> keyed
by B<value_key>, and store the result in B<dest_key>.  The B<self> and
B<value> parameters refer to PMCs that are guaranteed to be the same type,
so optimizations I<may> be made.
...
=item void bitwise_and_int_keyed(INTERP, PMC* self, KEY* key, INTVAL value, PMC* dest, KEY* dest_key)

=item void bitwise_and_int_keyed_int(INTERP, PMC* self, INTVAL* key, INTVAL value, PMC* dest, INTVAL* dest_key)

Calculate the bitwise-AND of B<self> keyed by B<key> and B<value>,
and store the result in B<dest_key>.
...
=item void bitwise_and_same_keyed(INTERP, PMC* self, KEY* key, PMC* value, KEY* value_key, PMC* dest, KEY* dest_key)

=item void bitwise_and_same_keyed_int(INTERP, PMC* self, INTVAL* key, PMC* value, INTVAL* value_key, PMC* dest, INTVAL* dest_key)
...
=item void bitwise_xor_int_keyed(INTERP, PMC* self, KEY* key, INTVAL value, PMC* dest, KEY* dest_key)

=item void bitwise_xor_int_keyed_int(INTERP, PMC* self, INTVAL* key, INTVAL value, PMC* dest, INTVAL* dest_key)

Calculate the bitwise-XOR of B<self> keyed by B<key> and B<value>,
and store the result in B<dest_key>.
...
=item void bitwise_xor_same_keyed(INTERP, PMC* self, KEY* key, PMC* value, KEY* value_key, PMC* dest, KEY* dest_key)

=item void bitwise_xor_same_keyed_int(INTERP, PMC* self, INTVAL* key, PMC* value, INTVAL* value_key, PMC* dest, INTVAL* dest_key)
...
=item void concatenate_unicode(INTERP, PMC* self, STRING* value, PMC* dest)

=item void concatenate_other(INTERP, PMC* self, STRING* value, PMC* dest)
...
=item void increment_keyed(INTERP, PMC* self, INTVAL* key)
...
=item void decrement_keyed(INTERP, PMC* self, INTVAL* key)
...
=item void substr_keyed(INTERP, PMC* self, KEY* key, INTVAL length, PMC* dest, KEY* dest_key)

=item void substr_keyed_int(INTERP, PMC* self, INTVAL* key, INTVAL length, PMC* dest, INTVAL* dest_key)
