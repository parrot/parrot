...
=item void unshift_pmc_keyed(INTERP, PMC* self, PMC* key, PMC* value, PMC* value_key)
...
=item void add_keyed(INTERP, PMC* self, PMC* key, PMC* value, PMC* value_key, PMC* dest, PMC* dest_key)
...
=item void subtract_keyed(INTERP, PMC* self, PMC* key, PMC* value, PMC* value_key, PMC* dest, PMC* dest_key)
...
=item void multiply_keyed(INTERP, PMC* self, PMC* key, PMC* value, PMC* value_key, PMC* dest, PMC* dest_key)
...
=item void divide_keyed(INTERP, PMC* self, PMC* key, PMC* value, PMC* value_key, PMC* dest, PMC* dest_key)
...
=item void modulus_keyed(INTERP, PMC* self, PMC* key, PMC* value, PMC* value_key, PMC* dest, PMC* dest_key)
...
=item void bitwise_or_keyed(INTERP, PMC* self, PMC* key, PMC* value, PMC* value_key, PMC* dest, PMC* dest_key)
...
=item void bitwise_and_keyed(INTERP, PMC* self, PMC* key, PMC* value, PMC* value_key, PMC* dest, PMC* dest_key)
...
=item void bitwise_xor_keyed(INTERP, PMC* self, PMC* key, PMC* value, PMC* value_key, PMC* dest, PMC* dest_key)
...
=item void bitwise_shl_same(INTERP, PMC* self, PMC* value, PMC* dest)
...
=item void bitwise_shl_keyed(INTERP, PMC* self, PMC* key, PMC* value, PMC* value_key, PMC* dest, PMC* dest_key)

=item void bitwise_shl_keyed_int(INTERP, PMC* self, INTVAL key, PMC* value, INTVAL* value_key, PMC* dest, INTVAL* dest_key)
...
=item void bitwise_shr_same(INTERP, PMC* self, PMC* value, PMC* dest)
...
=item void bitwise_shr_keyed(INTERP, PMC* self, PMC* key, PMC* value, PMC* value_key, PMC* dest, PMC* dest_key)

=item void bitwise_shr_keyed_int(INTERP, PMC* self, INTVAL key, PMC* value, INTVAL* value_key, PMC* dest, INTVAL* dest_key)
...
=item void concatenate_keyed(INTERP, PMC* self, PMC* key, PMC* value, PMC* value_key, PMC* dest, PMC* dest_key)
...
=item INTVAL cmp_string_keyed(INTERP, PMC* self, PMC* key, PMC* value, PMC* value_key)
...
=item void logical_or_keyed(INTERP, PMC* self, PMC* key, PMC* value, PMC* value_key, PMC* dest, PMC* dest_key)
...
=item void logical_and_keyed(INTERP, PMC* self, PMC* key, PMC* value, PMC* value_key, PMC* dest, PMC* dest_key)
...
=item void logical_xor_keyed(INTERP, PMC* self, PMC* key, PMC* value, PMC* value_key, PMC* dest, PMC* dest_key)
...
=item void repeat_keyed(INTERP, PMC* self, PMC* key, PMC* value, PMC* value_key, PMC* dest, PMC* dest_key)
...
=item void repeat_int_keyed(INTERP, PMC* self, PMC* key, INTVAL value, PMC* dest, PMC* dest_key)
...
=item void substr_keyed(INTERP, PMC* self, PMC* key, INTVAL offset, INTVAL length, PMC* dest, PMC* dest_key)
...
=item STRING* substr_str_keyed(INTERP, PMC* self, PMC* key, INTVAL offset, INTVAL length)
...
=item void* invoke_pmc(INTERP, PMC* self, PMC* sub, void* next)
...
=item INTVAL can_keyed(INTERP, PMC* self, PMC* key, STRING* method)
=item INTVAL can_keyed_int(INTERP, PMC* self, INTVAL key, STRING* method)

Determine whether the PMC in B<self> keyed by B<key> can perform the method
specified by name in B<method>. Returns TRUE if it can; otherwise, returns
FALSE.
...
=item INTVAL does_keyed(INTERP, PMC* self, PMC* key, STRING* method)
=item INTVAL does_keyed_int(INTERP, PMC* self, INTVAL key, STRING* method)

Determine whether the PMC in B<self> keyed by B<key> implements the interface
specified by name in B<method>. Returns TRUE if it can; otherwise, returns
FALSE.
