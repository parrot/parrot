...
The inner function is the code that actually does the work. This is generally a
chunk of C code, though the interpreter will be able to call perl code soon.
...
The function starts with the first open brace, which should generally be on the
