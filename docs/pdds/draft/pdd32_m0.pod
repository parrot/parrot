...
M0 will need to implement similar functionality to dlfunc and dlvar, but most
likely the atoms to build up that functionality, since they contain too much
magic to be M0 ops.
