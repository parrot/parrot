...
The inclusion of CF is necessary for M0 interpreters written in high-level
languages where the first element of an array is not equivalent to the array
itself.
