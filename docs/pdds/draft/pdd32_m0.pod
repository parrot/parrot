...
Registers may also be given descritive names through register name directives
as follows.  This is purely as a convenince to humans reading/writing M0 and
has no effect on the generated bytecode.
