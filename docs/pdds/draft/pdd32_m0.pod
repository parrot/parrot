...
type will merely be syntactic sugar for accessing a PMC.
...
of the register in an M0 context's register set.  The proposed structure uses
the first 8 registers for context-specific information and has 62 of each
primitive type:
    ...
    5       VS  - pointer to variables table
