...
type:
    ...
    6       RETCHUNK - name of chunk to return to when invoking this cf
    7       CONSTS - pointer to constants segment
    8       MDS - pointer to metadata segment
    9       BCS - pointer to bytecode segment
    10      INTERP - global interpreter data (see C<Interpreter Data>)
