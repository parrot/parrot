...
produces three PMCs, one with a PMC type, one with an integer type and one
with a string type.
...
Need discussion on whether C<EXCEPTION_OUT_OF_BOUNDS> is a good exception for this, or
