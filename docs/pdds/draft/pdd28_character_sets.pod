...
insert an entry into the global grapheme table,
C<Parrot_grapheme_table>, at array index 0, consisting of the bytestream
C<0x00000438 0x000000030F> - that is, the Unicode decomposition of the
grapheme.
...
We'll see later on why this is a phenomenally useful thing to have.
