...
be via the extension mechanism (see L<docs/pdds/pdd11_extending.pod>, 
...
implementation, see L<docs/pdds/pdd14_bignum.pod>.
...
L<docs/pdds/pdd02_vtables.pod> that implement the basic behaviour of
...
for bigint/bignum implementation, outlined in L<docs/pdds/pdd14_bignum.pod>.
