...
release. The subclass opcode stays.
...
=item optional comma in sub flags

The optional comma to separate subroutine flags will be removed in Parrot 0.4.17.
[RT#45679]. This will no longer be valid PIR code:
