...
=item * C<.HLL> <string> ',' <string> [post 0.8.1]
...
=item * C<:lexid> will become C<:subid> [post 0.8.1]

C<:lexid> will be renamed to C<:subid>.
...
=item PARROT_API changes to PARROT_EXPORT

The PARROT_API name suggests something that is not the case yet.  This will
