...
As of Parrot 0.4.16 all type names for .local other than string, num, int, and pmc
are deprecated. Using C<float> for C<num> or a basic PMC name like C<Array> for C<pmc>
will no longer be possible in Parrot 0.4.17.
[RT#42769]. 
