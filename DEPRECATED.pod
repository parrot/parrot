...
=item compilers/past and compilers/post [#44011]

The compilers/past and compilers/post tools are deprecated in
favor of compilers/past-pm and compilers/pct .  They are expected
to be completely removed from the repository in an upcoming release.
