...
There are several files here, all with the C<.vim> extension. C<pir.vim>
...
.pasm, and .pmc with the right syntax. The syntax files should be installed to
C<~/.vim/syntax/>; C<filetype_parrot.vim> should be installed to
C<~/.vim/ftdetect>; C<indent_pir.vim> should be called C<~/.vim/indent/pir.vim>.
