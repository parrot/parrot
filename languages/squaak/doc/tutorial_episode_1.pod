...
=item * exceptional control statements such as break and return
...
implementations. Most of them are not complete yet; some are actively
maintained actively and others aren't. If, after reading this tutorial,
you feel like contributing to one of these languages, you can check out the
mailing list or join IRC (see the references section for details).
...
name. After this, go to this directory and type:
...
=item * Parrot mailing list: parrot-porters@perl.org
