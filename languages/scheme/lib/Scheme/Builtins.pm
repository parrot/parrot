...
my %built_ins = (
    write => [
        ...
        [ '',                '.local pmc',  'elem' ],
        [ '',                qw( typeof S0 arg1 ) ],
        [ '',                qw( ne S0 'Undef' write_N_UNDEF ) ],
        [ '',                'print',       '"()"' ],
        [ '',                'branch', 'write_FINISHED' ],
        [ 'write_N_UNDEF',   'ne',     'S0', q{'Integer'}, 'write_N_INTEGER' ],
        [ '',                'print',  'arg1' ],
        [ '',                'branch', 'write_FINISHED' ],
        [ 'write_N_INTEGER', 'ne',     'S0', q{'Array'}, 'write_N_ARRAY' ],
        [ '',                '#', '_dumper( arg1 )' ],
        [ '',                'print',  '"("' ],
        ...
        [ 'write_KET',       'print',  '")"' ],
        [ '',                'branch', 'write_FINISHED' ],
        [ 'write_N_ARRAY',   'ne',     'S0', q{'Boolean'}, 'write_N_BOOLEAN' ],
        [ '',                'if', 'arg1',  'write_TRUE' ],
        [ 'write_FALSE',     'print',  q{'#f'} ],
        [ '',                'branch', 'write_FINISHED' ],
        [ 'write_TRUE',      'print',  q{'#t'} ],
        [ '',                'branch', 'write_FINISHED' ],
        [ 'write_N_BOOLEAN', 'ne',     'S0', q{'String'}, 'write_N_STRING' ],
        [ '',                'print',  q{'"'} ],
        [ '',                'print',  'arg1' ],
        [ '',                'print',  q{'"'} ],
        [ '',                'branch', 'write_FINISHED' ],
        [ 'write_N_STRING', 'ne',     'S0', q{'SchemeSymbol'}, 'write_N_SYMBOL' ],
        [ '',                'print',  'arg1' ],
        [ '',                'branch', 'write_FINISHED' ],
        [ 'write_N_SYMBOL',  '' ],
        [ '',                'print',  'arg1' ],
