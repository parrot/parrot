// $ANTLR 3.0b4 grammar/antlr_3/bc.g 2006-08-24 22:45:19
...
public class BcParserLexer extends Lexer {
    ...
    public void mSTRING() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // grammar/antlr_3/bc.g:35:10: ( '\\\"' (~ '\\\"' )* '\\\"' )
            // grammar/antlr_3/bc.g:35:10: '\\\"' (~ '\\\"' )* '\\\"'
            {
            match('\"'); 
            // grammar/antlr_3/bc.g:35:15: (~ '\\\"' )*
            loop3:
            do {
                int alt3=2;
    ...
    public void mLETTER() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // grammar/antlr_3/bc.g:37:10: ( 'a' .. 'z' )
            // grammar/antlr_3/bc.g:37:10: 'a' .. 'z'
            {
            matchRange('a','z'); 
    ...
    public void mINTEGER() throws RecognitionException {
        try {
            ruleNestingLevel++;
            // grammar/antlr_3/bc.g:40:11: ( ( ('0'..'9'|'A'..'F'))+ )
            // grammar/antlr_3/bc.g:40:11: ( ('0'..'9'|'A'..'F'))+
            {
            // grammar/antlr_3/bc.g:40:11: ( ('0'..'9'|'A'..'F'))+
            int cnt4=0;
            ...
            do {
                ...
                switch (alt4) {
            	case 1 :
            	    // grammar/antlr_3/bc.g:40:12: ('0'..'9'|'A'..'F')
            	    {
    ...
    public void mNUMBER() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // grammar/antlr_3/bc.g:43:5: ( INTEGER ( '.' INTEGER )? | '.' INTEGER )
            int alt6=2;
            ...
            if ( ((LA6_0>='0' && LA6_0<='9')||(LA6_0>='A' && LA6_0<='F')) ) {
                ...
                NoViableAltException nvae =
                    new NoViableAltException("42:1: NUMBER : ( INTEGER ( '.' INTEGER )? | '.' INTEGER );", 6, 0, input);

                throw nvae;
            }
            switch (alt6) {
                case 1 :
                    // grammar/antlr_3/bc.g:43:5: INTEGER ( '.' INTEGER )?
                    {
                    mINTEGER(); 
                    // grammar/antlr_3/bc.g:43:13: ( '.' INTEGER )?
                    int alt5=2;
                    ...
                    switch (alt5) {
                        case 1 :
                            // grammar/antlr_3/bc.g:43:14: '.' INTEGER
                            {
                            match('.'); 
                            mINTEGER(); 
                    ...
                    break;
                case 2 :
                    // grammar/antlr_3/bc.g:45:5: '.' INTEGER
                    {
                    match('.'); 
                    mINTEGER(); 
    ...
    public void mASSIGN_OP() throws RecognitionException {
        try {
            ...
            default:
                NoViableAltException nvae =
                    new NoViableAltException("52:1: ASSIGN_OP : ( '=' | '+=' | '-=' | '*=' | '/=' | '%=' | '^=' );", 7, 0, input);
    ...
    public void mREL_OP() throws RecognitionException {
        try {
            ...
            default:
                NoViableAltException nvae =
                    new NoViableAltException("53:1: REL_OP : ( '==' | '<=' | '>=' | '!=' | '<' | '>' );", 8, 0, input);
    ...
    public void mDefine() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // grammar/antlr_3/bc.g:57:14: ( 'define' )
            // grammar/antlr_3/bc.g:57:14: 'define'
            {
            match("define"); 
    ...
    public void mBreak() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // grammar/antlr_3/bc.g:58:14: ( 'break' )
            // grammar/antlr_3/bc.g:58:14: 'break'
            {
            match("break"); 
    ...
    public void mQuit() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // grammar/antlr_3/bc.g:61:14: ( 'quit' )
            // grammar/antlr_3/bc.g:61:14: 'quit'
            {
            match("quit"); 
    ...
    public void mLength() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // grammar/antlr_3/bc.g:63:14: ( 'length' )
            // grammar/antlr_3/bc.g:63:14: 'length'
            {
            match("length"); 
    ...
    public void mReturn() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // grammar/antlr_3/bc.g:64:14: ( 'return' )
            // grammar/antlr_3/bc.g:64:14: 'return'
            {
            match("return"); 
    ...
    public void mFor() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // grammar/antlr_3/bc.g:65:14: ( 'for' )
            // grammar/antlr_3/bc.g:65:14: 'for'
            {
            match("for"); 
    ...
    public void mWhile() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // grammar/antlr_3/bc.g:67:14: ( 'while' )
            // grammar/antlr_3/bc.g:67:14: 'while'
            {
            match("while"); 
    ...
    public void mSqrt() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // grammar/antlr_3/bc.g:68:14: ( 'sqrt' )
            // grammar/antlr_3/bc.g:68:14: 'sqrt'
            {
            match("sqrt"); 
    ...
    public void mScale() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // grammar/antlr_3/bc.g:69:14: ( 'scale' )
            // grammar/antlr_3/bc.g:69:14: 'scale'
            {
            match("scale"); 
    ...
    public void mIbase() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // grammar/antlr_3/bc.g:70:14: ( 'ibase' )
            // grammar/antlr_3/bc.g:70:14: 'ibase'
            {
            match("ibase"); 
    ...
    public void mObase() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // grammar/antlr_3/bc.g:71:14: ( 'obase' )
            // grammar/antlr_3/bc.g:71:14: 'obase'
            {
            match("obase"); 
    ...
    public void mAuto() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // grammar/antlr_3/bc.g:72:14: ( 'auto' )
            // grammar/antlr_3/bc.g:72:14: 'auto'
            {
            match("auto"); 
