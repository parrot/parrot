// $ANTLR 3.0b3 grammar/antlr_3/bc.g 2006-08-19 23:23:27
...
public class BcParserLexer extends Lexer {
    ...
    public void mSTRING() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // grammar/antlr_3/bc.g:33:10: ( '\\\"' (~ '\\\"' )* '\\\"' )
            // grammar/antlr_3/bc.g:33:10: '\\\"' (~ '\\\"' )* '\\\"'
            {
            match('\"'); 
            // grammar/antlr_3/bc.g:33:15: (~ '\\\"' )*
            loop3:
            do {
                int alt3=2;
    ...
    public void mLETTER() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // grammar/antlr_3/bc.g:35:10: ( 'a' .. 'z' )
            // grammar/antlr_3/bc.g:35:10: 'a' .. 'z'
            {
            matchRange('a','z'); 
    ...
    public void mINTEGER() throws RecognitionException {
        try {
            ruleNestingLevel++;
            // grammar/antlr_3/bc.g:38:11: ( ( ('0'..'9'|'A'..'F'))+ )
            // grammar/antlr_3/bc.g:38:11: ( ('0'..'9'|'A'..'F'))+
            {
            // grammar/antlr_3/bc.g:38:11: ( ('0'..'9'|'A'..'F'))+
            int cnt4=0;
            ...
            do {
                ...
                switch (alt4) {
            	case 1 :
            	    // grammar/antlr_3/bc.g:38:12: ('0'..'9'|'A'..'F')
            	    {
    ...
    public void mNUMBER() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // grammar/antlr_3/bc.g:41:5: ( INTEGER ( '.' INTEGER )? | '.' INTEGER )
            int alt6=2;
            ...
            switch (alt6) {
                case 1 :
                    // grammar/antlr_3/bc.g:41:5: INTEGER ( '.' INTEGER )?
                    {
                    mINTEGER(); 
                    // grammar/antlr_3/bc.g:41:13: ( '.' INTEGER )?
                    int alt5=2;
                    ...
                    switch (alt5) {
                        case 1 :
                            // grammar/antlr_3/bc.g:41:14: '.' INTEGER
                            {
                            match('.'); 
                            mINTEGER(); 
                    ...
                    break;
                case 2 :
                    // grammar/antlr_3/bc.g:43:5: '.' INTEGER
                    {
                    match('.'); 
                    mINTEGER(); 
    ...
    public void mQuit() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // grammar/antlr_3/bc.g:56:14: ( 'quit' )
            // grammar/antlr_3/bc.g:56:14: 'quit'
            {
            match("quit"); 
    ...
    public void mDefine() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // grammar/antlr_3/bc.g:59:14: ( 'define' )
            // grammar/antlr_3/bc.g:59:14: 'define'
            {
            match("define"); 
    ...
    public void mAuto() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // grammar/antlr_3/bc.g:60:14: ( 'auto' )
            // grammar/antlr_3/bc.g:60:14: 'auto'
            {
            match("auto"); 
    ...
    public void mKEYWORDS() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // grammar/antlr_3/bc.g:66:5: ( 'break' | 'length' | 'return' | 'for' | 'while' | 'sqrt' | 'scale' | 'ibase' | 'obase' )
            int alt9=9;
            switch ( input.LA(1) ) {
            case 'b':
                alt9=1;
            ...
            case 's':
                ...
                if ( (LA9_6=='q') ) {
                    ...
                    NoViableAltException nvae =
                        new NoViableAltException("65:1: KEYWORDS : ( 'break' | 'length' | 'return' | 'for' | 'while' | 'sqrt' | 'scale' | 'ibase' | 'obase' );", 9, 6, input);
            ...
            default:
                NoViableAltException nvae =
                    new NoViableAltException("65:1: KEYWORDS : ( 'break' | 'length' | 'return' | 'for' | 'while' | 'sqrt' | 'scale' | 'ibase' | 'obase' );", 9, 0, input);
            ...
            switch (alt9) {
                case 1 :
                    // grammar/antlr_3/bc.g:66:5: 'break'
                    {
                    match("break"); 
                    ...
                    break;
                case 2 :
                    // grammar/antlr_3/bc.g:66:16: 'length'
                    {
                    match("length"); 
                    ...
                    break;
                case 3 :
                    // grammar/antlr_3/bc.g:67:5: 'return'
                    {
                    match("return"); 
                    ...
                    break;
                case 4 :
                    // grammar/antlr_3/bc.g:67:16: 'for'
                    {
                    match("for"); 
                    ...
                    break;
                case 5 :
                    // grammar/antlr_3/bc.g:67:27: 'while'
                    {
                    match("while"); 
                    ...
                    break;
                case 6 :
                    // grammar/antlr_3/bc.g:67:37: 'sqrt'
                    {
                    match("sqrt"); 
                    ...
                    break;
                case 7 :
                    // grammar/antlr_3/bc.g:68:5: 'scale'
                    {
                    match("scale"); 
                    ...
                    break;
                case 8 :
                    // grammar/antlr_3/bc.g:68:16: 'ibase'
                    {
                    match("ibase"); 
                    ...
                    break;
                case 9 :
                    // grammar/antlr_3/bc.g:68:27: 'obase'
                    {
                    match("obase"); 
    ...
    public void mML_COMMENT() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // grammar/antlr_3/bc.g:73:5: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // grammar/antlr_3/bc.g:73:5: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // grammar/antlr_3/bc.g:73:10: ( options {greedy=false; } : . )*
            loop10:
            do {
                int alt10=2;
    ...
    public void mTokens() throws RecognitionException {
        // grammar/antlr_3/bc.g:1:10: ( T28 | T29 | NEWLINE | STRING | LETTER | NUMBER | MINUS | PLUS | MUL_OP | SEMICOLON | ASSIGN_OP | REL_OP | INCR | DECR | Quit | Define | Auto | If | KEYWORDS | ML_COMMENT | WS )
        int alt12=21;
        switch ( input.LA(1) ) {
        case '(':
            alt12=1;
        ...
        default:
            NoViableAltException nvae =
                new NoViableAltException("1:1: Tokens : ( T28 | T29 | NEWLINE | STRING | LETTER | NUMBER | MINUS | PLUS | MUL_OP | SEMICOLON | ASSIGN_OP | REL_OP | INCR | DECR | Quit | Define | Auto | If | KEYWORDS | ML_COMMENT | WS );", 12, 0, input);
