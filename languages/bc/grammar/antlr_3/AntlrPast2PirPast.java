...
public class AntlrPast2PirPast extends TreeParser {
    ...
    // $ANTLR start expr
    // grammar/antlr_3/antlr_past2pir_past.g:162:1: expr returns [int reg] : expr_int_1 ;
    public int expr() throws RecognitionException {   
        ...
        try {
            ...
            following.pop();
                  ...
                  String pir
                    =   "               $P" + reg + " = new 'PAST::Val' \n"
                      + "               $P" + reg + ".set_node( '1', 0, " + input.toString(expr_int_12.start,expr_int_12.stop) + " ) \n"
                      + "               $P" + reg + ".valtype( 'num' ) \n";
    ...
    public static final BitSet FOLLOW_PROGRAM_in_gen_pir_past61 = new BitSet(new long[]{4L});
    public static final BitSet FOLLOW_expr_in_gen_pir_past63 = new BitSet(new long[]{8L});
    public static final BitSet FOLLOW_INT_in_expr_int_183 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_expr_int_1_in_expr110 = new BitSet(new long[]{2L});
