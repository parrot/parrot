...
B<sub> introduces a subroutine declaration (and definition). What follows
is an optional type, and identifier (the name of the subroutine), and a
list of formal arguments in parenthesis. The formal arguments are written
as a comma-separated list of type-name pairs. Finally, there must be a
