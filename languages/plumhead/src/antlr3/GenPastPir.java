...
public class GenPastPir extends TreeParser {
    ...
    public final void gen_pir_past() throws RecognitionException {
        try {
            // src/antlr3/GenPastPir.g:29:3: ( ^( PROGRAM ( node[\"past_stmts\"] )* ) )
    ...
    public final void node(String reg_mother) throws RecognitionException {
        ...
        try {
            // src/antlr3/GenPastPir.g:102:3: ( ^( ECHO node[\"past_echo\"] ) | ^( VAR_DUMP node[\"past_var_dump\"] ) | NOQUOTE_STRING | SINGLEQUOTE_STRING | DOUBLEQUOTE_STRING | NUMBER | INTEGER | ^(infix= ( PLUS | MINUS | MUL_OP | BITWISE_OP ) node[reg] node[reg] ) | ^(prefix= PREFIX node[reg] ) | ^( REL_OP node[reg] node[reg] ) | ^( IF node[\"past_if_op\"] node[\"past_if_op\"] ( node[\"past_if_op\"] )? ) | ^( STMTS ( node[reg_stmts] )* ) | ^( ASSIGN_OP node[reg_assign] node[reg_assign] ) | SCALAR | ^( ARRAY node[reg_array] ) )
            int alt4=15;
            switch ( input.LA(1) ) {
            case ECHO:
                {
            ...
            default:
                NoViableAltException nvae =
                    new NoViableAltException("101:1: node[String reg_mother] : ( ^( ECHO node[\"past_echo\"] ) | ^( VAR_DUMP node[\"past_var_dump\"] ) | NOQUOTE_STRING | SINGLEQUOTE_STRING | DOUBLEQUOTE_STRING | NUMBER | INTEGER | ^(infix= ( PLUS | MINUS | MUL_OP | BITWISE_OP ) node[reg] node[reg] ) | ^(prefix= PREFIX node[reg] ) | ^( REL_OP node[reg] node[reg] ) | ^( IF node[\"past_if_op\"] node[\"past_if_op\"] ( node[\"past_if_op\"] )? ) | ^( STMTS ( node[reg_stmts] )* ) | ^( ASSIGN_OP node[reg_assign] node[reg_assign] ) | SCALAR | ^( ARRAY node[reg_array] ) );", 4, 0, input);
            ...
            switch (alt4) {
                case 1 :
                    // src/antlr3/GenPastPir.g:102:5: ^( ECHO node[\"past_echo\"] )
                    {
                    ...
                    break;
                case 2 :
                    // src/antlr3/GenPastPir.g:119:5: ^( VAR_DUMP node[\"past_var_dump\"] )
                    {
                ...
                case 6 :
                    ...
                    match(input,NUMBER,FOLLOW_NUMBER_in_node187); 
                          ...
                          System.out.println( 
                            ...
                            + "  # start of NUMBER                                               \n"
                            + "  past_temp = new 'PAST::Val'                                     \n"
                            + "      past_temp.'attr'( 'value', '" + NUMBER4.getText() + "', 1 )      \n"
                ...
                case 7 :
                    ...
                    match(input,INTEGER,FOLLOW_INTEGER_in_node199); 
                          ...
                          System.out.println( 
                            ...
                            + "  # start of INTEGER                                              \n"
                            + "  past_temp = new 'PAST::Val'                                     \n"
                            + "      past_temp.'attr'( 'value', '" + INTEGER5.getText() + "', 1 )     \n"
                    ...
                    break;
                case 8 :
                    // src/antlr3/GenPastPir.g:217:5: ^(infix= ( PLUS | MINUS | MUL_OP | BITWISE_OP ) node[reg] node[reg] )
                    {
                    ...
                    break;
                case 9 :
                    // src/antlr3/GenPastPir.g:252:5: ^(prefix= PREFIX node[reg] )
                    {
                    ...
                    break;
                case 10 :
                    // src/antlr3/GenPastPir.g:276:5: ^( REL_OP node[reg] node[reg] )
                    {
                    ...
                    break;
                case 11 :
                    // src/antlr3/GenPastPir.g:300:5: ^( IF node[\"past_if_op\"] node[\"past_if_op\"] ( node[\"past_if_op\"] )? )
                    {
                    ...
                    break;
                case 12 :
                    // src/antlr3/GenPastPir.g:321:5: ^( STMTS ( node[reg_stmts] )* )
                    {
                    ...
                    break;
                case 13 :
                    // src/antlr3/GenPastPir.g:338:5: ^( ASSIGN_OP node[reg_assign] node[reg_assign] )
                    {
                ...
                case 14 :
                    ...
                    match(input,SCALAR,FOLLOW_SCALAR_in_node398); 
                          ...
                          System.out.println( 
                            ...
                            + "      past_temp.'init'( 'name' => '" + SCALAR7.getText() + "', 'scope' => 'package', 'viviself' => 'Undef', 'lvalue' => 1 )      \n"
                            + "  " + reg_mother + ".'push'( past_temp )                    \n"
                            + "  # leaving SCALAR                                                \n"
                          );
                ...
                case 15 :
                    ...
                    match(input, Token.UP, null); 
                          ...
                          System.out.println( 
                            ...
                            + "  past_name.'init'( 'name' => '" + ARRAY8.getText() + "', 'scope' => 'package', 'viviself' => 'Hash', 'lvalue' => 1 )      \n"
