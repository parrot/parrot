...
public class PlumheadParser extends Parser {
    ...
    // $ANTLR start code
    // src/antlr3/Plumhead.g:77:1: code : CODE_START statements ( CODE_END )? -> ^( STMTS statements ) ;
    public final code_return code() throws RecognitionException {
        ...
        try {
            // src/antlr3/Plumhead.g:78:3: ( CODE_START statements ( CODE_END )? -> ^( STMTS statements ) )
            ...
            {
                // src/antlr3/Plumhead.g:78:40: ^( STMTS statements )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
