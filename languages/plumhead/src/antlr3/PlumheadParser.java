...
public class PlumheadParser extends Parser {
    ...
    public program_return program() throws RecognitionException {
        ...
        try {
            ...
            {
            pushFollow(FOLLOW_sea_or_code_in_program837);
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_sea_in_sea_or_code862);
            	    sea2=sea();
            	    _fsp--;
            	...
            	case 2 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_code_in_sea_or_code866);
            	    code3=code();
            	    _fsp--;
    ...
    public sea_return sea() throws RecognitionException {
        ...
        try {
            ...
            match(input,SEA,FOLLOW_SEA_in_sea883); 
            list_SEA.add(SEA4);
    ...
    public code_return code() throws RecognitionException {
        ...
        try {
            ...
            match(input,CODE_START,FOLLOW_CODE_START_in_code907); 
            list_CODE_START.add(CODE_START5);

            pushFollow(FOLLOW_statements_in_code909);
            ...
            switch (alt2) {
                case 1 :
                    ...
                    match(input,CODE_END,FOLLOW_CODE_END_in_code911); 
    ...
    public relational_expression_return relational_expression() throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_expression_in_relational_expression930);
            ...
            switch (alt3) {
                case 1 :
                    ...
                    match(input,REL_OP,FOLLOW_REL_OP_in_relational_expression934); 
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_statement_in_statements955);
        ...
        try {
            ...
            switch (alt6) {
                case 1 :
                    ...
                    match(input,ECHO,FOLLOW_ECHO_in_statement971); 
                    ...
                    match(input,34,FOLLOW_34_in_statement975); 
                ...
                case 2 :
                    ...
                    match(input,VAR_DUMP,FOLLOW_VAR_DUMP_in_statement1035); 
                    list_VAR_DUMP.add(VAR_DUMP15);

                    PAREN_OPEN16=(Token)input.LT(1);
                    match(input,PAREN_OPEN,FOLLOW_PAREN_OPEN_in_statement1037); 
                    ...
                    match(input,PAREN_CLOSE,FOLLOW_PAREN_CLOSE_in_statement1042); 
                    list_PAREN_CLOSE.add(PAREN_CLOSE18);

                    char_literal19=(Token)input.LT(1);
                    match(input,34,FOLLOW_34_in_statement1044); 
                ...
                case 3 :
                    ...
                    match(input,IF,FOLLOW_IF_in_statement1076); 
                    list_IF.add(IF20);

                    PAREN_OPEN21=(Token)input.LT(1);
                    match(input,PAREN_OPEN,FOLLOW_PAREN_OPEN_in_statement1078); 
                    list_PAREN_OPEN.add(PAREN_OPEN21);

                    pushFollow(FOLLOW_relational_expression_in_statement1080);
                    ...
                    match(input,PAREN_CLOSE,FOLLOW_PAREN_CLOSE_in_statement1082); 
                    list_PAREN_CLOSE.add(PAREN_CLOSE23);

                    char_literal24=(Token)input.LT(1);
                    match(input,35,FOLLOW_35_in_statement1084); 
                    list_35.add(char_literal24);

                    pushFollow(FOLLOW_statements_in_statement1088);
                    s1=statements();
                    _fsp--;

                    list_statements.add(s1.getTree());
                    char_literal25=(Token)input.LT(1);
                    match(input,36,FOLLOW_36_in_statement1090); 
                    ...
                    switch (alt5) {
                        case 1 :
                            ...
                            match(input,ELSE,FOLLOW_ELSE_in_statement1098); 
                            list_ELSE.add(ELSE26);

                            char_literal27=(Token)input.LT(1);
                            match(input,35,FOLLOW_35_in_statement1100); 
                            list_35.add(char_literal27);

                            pushFollow(FOLLOW_statements_in_statement1104);
                            s2=statements();
                            _fsp--;

                            list_statements.add(s2.getTree());
                            char_literal28=(Token)input.LT(1);
                            match(input,36,FOLLOW_36_in_statement1106); 
                ...
                case 4 :
                    ...
                    match(input,CODE_END,FOLLOW_CODE_END_in_statement1269); 
                    list_CODE_END.add(CODE_END29);

                    SEA30=(Token)input.LT(1);
                    match(input,SEA,FOLLOW_SEA_in_statement1271); 
                    list_SEA.add(SEA30);

                    CODE_START31=(Token)input.LT(1);
                    match(input,CODE_START,FOLLOW_CODE_START_in_statement1273); 
                ...
                case 5 :
                    ...
                    match(input,VAR_NAME,FOLLOW_VAR_NAME_in_statement1330); 
                    list_VAR_NAME.add(VAR_NAME32);

                    ASSIGN_OP33=(Token)input.LT(1);
                    match(input,ASSIGN_OP,FOLLOW_ASSIGN_OP_in_statement1332); 
                    list_ASSIGN_OP.add(ASSIGN_OP33);

                    pushFollow(FOLLOW_expression_in_statement1336);
                    val=expression();
                    _fsp--;

                    list_expression.add(val.getTree());
                    char_literal34=(Token)input.LT(1);
                    match(input,34,FOLLOW_34_in_statement1338); 
                ...
                case 6 :
                    ...
                    match(input,VAR_NAME,FOLLOW_VAR_NAME_in_statement1385); 
                    list_VAR_NAME.add(VAR_NAME35);

                    char_literal36=(Token)input.LT(1);
                    match(input,37,FOLLOW_37_in_statement1387); 
                    list_37.add(char_literal36);

                    pushFollow(FOLLOW_expression_in_statement1391);
                    key=expression();
                    _fsp--;

                    list_expression.add(key.getTree());
                    char_literal37=(Token)input.LT(1);
                    match(input,38,FOLLOW_38_in_statement1393); 
                    list_38.add(char_literal37);

                    ASSIGN_OP38=(Token)input.LT(1);
                    match(input,ASSIGN_OP,FOLLOW_ASSIGN_OP_in_statement1395); 
                    ...
                    match(input,34,FOLLOW_34_in_statement1401); 
        ...
        try {
            ...
            switch (alt7) {
                case 1 :
                    ...
                    match(input,DOUBLEQUOTE_STRING,FOLLOW_DOUBLEQUOTE_STRING_in_expression1438); 
                ...
                case 2 :
                    ...
                    match(input,SINGLEQUOTE_STRING,FOLLOW_SINGLEQUOTE_STRING_in_expression1444); 
                ...
                case 3 :
                    ...
                    pushFollow(FOLLOW_bitwise_expression_in_expression1450);
                ...
                case 4 :
                    ...
                    match(input,VAR_NAME,FOLLOW_VAR_NAME_in_expression1456); 
                    list_VAR_NAME.add(VAR_NAME43);

                    char_literal44=(Token)input.LT(1);
                    match(input,37,FOLLOW_37_in_expression1458); 
                    ...
                    match(input,38,FOLLOW_38_in_expression1464); 
                ...
                case 5 :
                    ...
                    match(input,VAR_NAME,FOLLOW_VAR_NAME_in_expression1485); 
    ...
    public bitwise_expression_return bitwise_expression() throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_adding_expression_in_bitwise_expression1529);
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    match(input,BITWISE_OP,FOLLOW_BITWISE_OP_in_bitwise_expression1533); 
    ...
    public adding_expression_return adding_expression() throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_multiplying_expression_in_adding_expression1552);
            	...
            	case 1 :
            	    ...
            	    switch (alt9) {
            	        case 1 :
            	            ...
            	            match(input,PLUS,FOLLOW_PLUS_in_adding_expression1558); 
            	        ...
            	        case 2 :
            	            ...
            	            match(input,MINUS,FOLLOW_MINUS_in_adding_expression1563); 
            	    ...
            	    pushFollow(FOLLOW_multiplying_expression_in_adding_expression1568);
    ...
    public multiplying_expression_return multiplying_expression() throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_unary_expression_in_multiplying_expression1585);
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    match(input,MUL_OP,FOLLOW_MUL_OP_in_multiplying_expression1589); 
        ...
        try {
            ...
            switch (alt12) {
                case 1 :
                    ...
                    pushFollow(FOLLOW_postfix_expression_in_unary_expression1608);
                ...
                case 2 :
                    ...
                    match(input,MINUS,FOLLOW_MINUS_in_unary_expression1614); 
                    list_MINUS.add(MINUS58);

                    pushFollow(FOLLOW_postfix_expression_in_unary_expression1616);
        ...
        try {
            ...
            switch (alt13) {
                case 1 :
                    ...
                    match(input,NUMBER,FOLLOW_NUMBER_in_postfix_expression1640); 
                ...
                case 2 :
                    ...
                    match(input,INTEGER,FOLLOW_INTEGER_in_postfix_expression1646); 
                ...
                case 3 :
                    ...
                    match(input,PAREN_OPEN,FOLLOW_PAREN_OPEN_in_postfix_expression1652); 
                    list_PAREN_OPEN.add(PAREN_OPEN62);

                    pushFollow(FOLLOW_expression_in_postfix_expression1654);
                    expression63=expression();
                    _fsp--;

                    list_expression.add(expression63.getTree());
                    PAREN_CLOSE64=(Token)input.LT(1);
                    match(input,PAREN_CLOSE,FOLLOW_PAREN_CLOSE_in_postfix_expression1656); 
    ...
    public static final BitSet FOLLOW_sea_or_code_in_program837 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_sea_in_sea_or_code862 = new BitSet(new long[]{0x0000000000001802L});
    public static final BitSet FOLLOW_code_in_sea_or_code866 = new BitSet(new long[]{0x0000000000001802L});
    public static final BitSet FOLLOW_SEA_in_sea883 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_CODE_START_in_code907 = new BitSet(new long[]{0x0000000100462002L});
    public static final BitSet FOLLOW_statements_in_code909 = new BitSet(new long[]{0x0000000000002002L});
    public static final BitSet FOLLOW_CODE_END_in_code911 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_expression_in_relational_expression930 = new BitSet(new long[]{0x0000000080000002L});
    public static final BitSet FOLLOW_REL_OP_in_relational_expression934 = new BitSet(new long[]{0x0000000007498000L});
    public static final BitSet FOLLOW_expression_in_relational_expression937 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_statement_in_statements955 = new BitSet(new long[]{0x0000000100462002L});
    public static final BitSet FOLLOW_ECHO_in_statement971 = new BitSet(new long[]{0x0000000007498000L});
    public static final BitSet FOLLOW_expression_in_statement973 = new BitSet(new long[]{0x0000000400000000L});
    public static final BitSet FOLLOW_34_in_statement975 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_VAR_DUMP_in_statement1035 = new BitSet(new long[]{0x0000000000080000L});
    public static final BitSet FOLLOW_PAREN_OPEN_in_statement1037 = new BitSet(new long[]{0x0000000007498000L});
    public static final BitSet FOLLOW_expression_in_statement1040 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_PAREN_CLOSE_in_statement1042 = new BitSet(new long[]{0x0000000400000000L});
    public static final BitSet FOLLOW_34_in_statement1044 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_IF_in_statement1076 = new BitSet(new long[]{0x0000000000080000L});
    public static final BitSet FOLLOW_PAREN_OPEN_in_statement1078 = new BitSet(new long[]{0x0000000007498000L});
    public static final BitSet FOLLOW_relational_expression_in_statement1080 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_PAREN_CLOSE_in_statement1082 = new BitSet(new long[]{0x0000000800000000L});
    public static final BitSet FOLLOW_35_in_statement1084 = new BitSet(new long[]{0x0000001100462000L});
    public static final BitSet FOLLOW_statements_in_statement1088 = new BitSet(new long[]{0x0000001000000000L});
    public static final BitSet FOLLOW_36_in_statement1090 = new BitSet(new long[]{0x0000000200000002L});
    public static final BitSet FOLLOW_ELSE_in_statement1098 = new BitSet(new long[]{0x0000000800000000L});
    public static final BitSet FOLLOW_35_in_statement1100 = new BitSet(new long[]{0x0000001100462000L});
    public static final BitSet FOLLOW_statements_in_statement1104 = new BitSet(new long[]{0x0000001000000000L});
    public static final BitSet FOLLOW_36_in_statement1106 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_CODE_END_in_statement1269 = new BitSet(new long[]{0x0000000000000800L});
    public static final BitSet FOLLOW_SEA_in_statement1271 = new BitSet(new long[]{0x0000000000001000L});
    public static final BitSet FOLLOW_CODE_START_in_statement1273 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_VAR_NAME_in_statement1330 = new BitSet(new long[]{0x0000000040000000L});
    public static final BitSet FOLLOW_ASSIGN_OP_in_statement1332 = new BitSet(new long[]{0x0000000007498000L});
    public static final BitSet FOLLOW_expression_in_statement1336 = new BitSet(new long[]{0x0000000400000000L});
    public static final BitSet FOLLOW_34_in_statement1338 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_VAR_NAME_in_statement1385 = new BitSet(new long[]{0x0000002000000000L});
    public static final BitSet FOLLOW_37_in_statement1387 = new BitSet(new long[]{0x0000000007498000L});
    public static final BitSet FOLLOW_expression_in_statement1391 = new BitSet(new long[]{0x0000004000000000L});
    public static final BitSet FOLLOW_38_in_statement1393 = new BitSet(new long[]{0x0000000040000000L});
    public static final BitSet FOLLOW_ASSIGN_OP_in_statement1395 = new BitSet(new long[]{0x0000000007498000L});
    public static final BitSet FOLLOW_expression_in_statement1399 = new BitSet(new long[]{0x0000000400000000L});
    public static final BitSet FOLLOW_34_in_statement1401 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_DOUBLEQUOTE_STRING_in_expression1438 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_SINGLEQUOTE_STRING_in_expression1444 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_bitwise_expression_in_expression1450 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_VAR_NAME_in_expression1456 = new BitSet(new long[]{0x0000002000000000L});
    public static final BitSet FOLLOW_37_in_expression1458 = new BitSet(new long[]{0x0000000007498000L});
    public static final BitSet FOLLOW_expression_in_expression1462 = new BitSet(new long[]{0x0000004000000000L});
    public static final BitSet FOLLOW_38_in_expression1464 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_VAR_NAME_in_expression1485 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_adding_expression_in_bitwise_expression1529 = new BitSet(new long[]{0x0000000020000002L});
    public static final BitSet FOLLOW_BITWISE_OP_in_bitwise_expression1533 = new BitSet(new long[]{0x0000000007080000L});
    public static final BitSet FOLLOW_adding_expression_in_bitwise_expression1536 = new BitSet(new long[]{0x0000000020000002L});
    public static final BitSet FOLLOW_multiplying_expression_in_adding_expression1552 = new BitSet(new long[]{0x000000000C000002L});
    public static final BitSet FOLLOW_PLUS_in_adding_expression1558 = new BitSet(new long[]{0x0000000007080000L});
    public static final BitSet FOLLOW_MINUS_in_adding_expression1563 = new BitSet(new long[]{0x0000000007080000L});
    public static final BitSet FOLLOW_multiplying_expression_in_adding_expression1568 = new BitSet(new long[]{0x000000000C000002L});
    public static final BitSet FOLLOW_unary_expression_in_multiplying_expression1585 = new BitSet(new long[]{0x0000000010000002L});
    public static final BitSet FOLLOW_MUL_OP_in_multiplying_expression1589 = new BitSet(new long[]{0x0000000007080000L});
    public static final BitSet FOLLOW_unary_expression_in_multiplying_expression1592 = new BitSet(new long[]{0x0000000010000002L});
    public static final BitSet FOLLOW_postfix_expression_in_unary_expression1608 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_MINUS_in_unary_expression1614 = new BitSet(new long[]{0x0000000003080000L});
    public static final BitSet FOLLOW_postfix_expression_in_unary_expression1616 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_NUMBER_in_postfix_expression1640 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_INTEGER_in_postfix_expression1646 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_PAREN_OPEN_in_postfix_expression1652 = new BitSet(new long[]{0x0000000007498000L});
    public static final BitSet FOLLOW_expression_in_postfix_expression1654 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_PAREN_CLOSE_in_postfix_expression1656 = new BitSet(new long[]{0x0000000000000002L});
