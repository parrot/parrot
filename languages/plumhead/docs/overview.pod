...
An incomplete implementation of PHP on Parrot.
Plumhead is short for Plum-headed Parakeet.

=head1 Goals

Provide a side by side comparison for different implementation
...
=item phc       - XSLT munges output from phc, started

=item antlr3    - ANTLR3, converted from languages/bc, planned

=item partridge - Parrot compiler toolchain, planned
