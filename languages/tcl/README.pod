...
To run the test suite, type C<make test>. Note - partcl is currently under
heavy development. Some tests may fail.
...
Note that we are targetting Tcl's cvs-latest, which is 8.5 (a4).  This allows us
...
build your own tcl (please use at least 8.5a4). Partcl users don't need 
to worry about this, and even most partcl developers can simply code 
