...
versions: These are located in src/builtins, and all new development should go
there. There are many old, runtime-only versions that exist in lib/commands.
Minor patches to things in lib/commands are ok, though.
...
part) but they have a little bit of magic. The compiler takes care of arg
...
Handrolled inlined builtins take three args: a TclCompiler, an array PMC with
...
(This is as opposed to the interpreted style in runtime/builtins, which take
