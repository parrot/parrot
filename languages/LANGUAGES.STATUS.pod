...
0.4.7: Failed 7/18 test scripts. 27/69 subtests failed.
...
Passes over 24.9% of tcl's (lightly converted) test suite, using a
Test::More like harness. (Doesn't run quite enough of tcl yet to simply
use tcltest.tcl)

=item Last verified with parrot version

0.4.7 (There's a bug in 0.4.8's makefile: if you want to play with a recent
tcl, you'll want svn-latest.)
