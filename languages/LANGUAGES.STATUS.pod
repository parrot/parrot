...
generation of Python runtime files. A new implementation with Java
code generated with ANTLR 3 has been investigated as well.
...
'languages/bc' is no longer activly developed. Bernhard is moving
his ANTLR 3 experiments over to 'languages/plumhead'. When that is done,
'languages/bc' will be removed. A shiny new PGE/TGE based implementation
of bc can be found in 'languages/abc'.
...
A toy implementation of PHP. Playing with phc and XSLT.
The grand idea is to have side by side comparison of
phc, PGE and ANTLR3 parsing.
...
Passes over 12% of tcl's (lightly converted) test suite, using a
Test::More like harness. (Don't run enough of tcl yet to simply
use tcltest.tcl)

Part of languages smoke testing: running tests this way shows
failures: to get a better picture:
