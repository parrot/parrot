...
Kea Common Lisp is an implementation of ANSI Common Lisp for the
Parrot bytecode virtual machine (see http://www.parrotcode.org/) that is
...
L<http://rakudo.org/parrot/index.cgi?javascript>
