...
This document describes how to use the command line net2pbc program, which
converts a .NET EXE or DLL into a Parrot Bytecode file (or optionally dumps
the PIR generated in the process).


=head2 Usage

To translate example.dll to example.pbc:
