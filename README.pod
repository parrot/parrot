...
to run the Configure script. If you want your Parrot to be as fast as possible,
use --optimize. If you want to improve your chances in debugging programs and
stacktraces, omit --optimize.
...
npeed to use 'GNU make' instead (or something compatible with it).
