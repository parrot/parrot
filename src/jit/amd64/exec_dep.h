 ...
 *
 *  emit an elf executable on amd64, no win64/coff.
 */

#ifndef PARROT_AMD64_EXEC_DEP_H_GUARD
#define PARROT_AMD64_EXEC_DEP_H_GUARD
...
#endif /* PARROT_AMD64_EXEC_DEP_H_GUARD */
