...
=item C<ascii_get_graphemes_inplace>
...
=item C<Parrot_charset_ascii_init>
...
=item C<charset_cvt_ascii_to_binary>
...
=item C<charset_cvt_ascii_to_iso_8859_1>
