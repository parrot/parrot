...
PARROT_API
PMC *
Parrot_make_namespace_autobase(PARROT_INTERP, PMC *key)
{
    PMC *base_ns;
...
PARROT_API
void
Parrot_set_global(PARROT_INTERP, PMC *ns, STRING *globalname, PMC *val)
{
...
PARROT_API
void
Parrot_store_global_cur(PARROT_INTERP, STRING *globalname, PMC *val)
{
