# 1 "src/pmc/callcontext.c"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "src/pmc/callcontext.c"
# 14 "src/pmc/callcontext.c"
...
# 18 "src/pmc/callcontext.c" 2
# 1 "./include/pmc/pmc_callcontext.h" 1
# 19 "src/pmc/callcontext.c" 2
...
# 20 "src/pmc/callcontext.c" 2
# 1 "src/pmc/callcontext.str" 1
# 21 "src/pmc/callcontext.c" 2
...
# 22 "src/pmc/callcontext.c" 2
# 1 "./src/pmc/callcontext.pmc"
# 21 "./src/pmc/callcontext.pmc"
...
# 62 "./src/pmc/callcontext.pmc"
static FLOATVAL autobox_floatval(Parrot_Interp interp, const Pcc_cell *cell)
        __attribute__((__nonnull__(1)))
        __attribute__((__nonnull__(2)));

static INTVAL autobox_intval(Parrot_Interp interp, const Pcc_cell *cell)
        __attribute__((__nonnull__(1)))
        __attribute__((__nonnull__(2)));


static PMC * autobox_pmc(Parrot_Interp interp, Pcc_cell *cell, INTVAL type)
        __attribute__((__nonnull__(1)))
        __attribute__((__nonnull__(2)));


static STRING * autobox_string(Parrot_Interp interp, const Pcc_cell *cell)
        __attribute__((__nonnull__(1)))
        __attribute__((__nonnull__(2)));

static void ensure_positionals_storage(Parrot_Interp interp,
    PMC *self,
    INTVAL size)
        __attribute__((__nonnull__(1)))
        __attribute__((__nonnull__(2)));

static void ensure_positionals_storage_ap(Parrot_Interp interp,
    PMC *self,
    INTVAL size,
    INTVAL allocated_positionals)
        __attribute__((__nonnull__(1)))
...
static Pcc_cell* get_cell_at(Parrot_Interp interp, PMC *self, INTVAL key)
        __attribute__((__nonnull__(1)))
        __attribute__((__nonnull__(2)));


static Hash * get_hash(Parrot_Interp interp, PMC *SELF)
        __attribute__((__nonnull__(1)))
        __attribute__((__nonnull__(2)));


static PMC * get_named_names(Parrot_Interp interp, PMC *SELF)
        __attribute__((__nonnull__(1)))
        __attribute__((__nonnull__(2)));

static void mark_cell(Parrot_Interp interp, Pcc_cell *c)
        __attribute__((__nonnull__(1)))
        __attribute__((__nonnull__(2)));

static void mark_hash(Parrot_Interp interp, Hash *h)
        __attribute__((__nonnull__(1)))
        __attribute__((__nonnull__(2)));

static void mark_positionals(Parrot_Interp interp, PMC *self)
        __attribute__((__nonnull__(1)))
        __attribute__((__nonnull__(2)));
# 170 "./src/pmc/callcontext.pmc"
static void
ensure_positionals_storage(Parrot_Interp interp, PMC *self, INTVAL size)
{
   
    INTVAL allocated_positionals;

    do { if (!(((self)->flags) & PObj_is_object_FLAG)) { (allocated_positionals) = ((Parrot_CallContext_attributes *)(self)->data)->allocated_positionals; } else { PMC * const attr_value = (self)->vtable->get_attr_str(interp, self, Parrot_str_new_constant(interp, "allocated_positionals")); (allocated_positionals) = (((attr_value) == PMCNULL || (attr_value) == ((void *)0)) ? (INTVAL) 0: (attr_value)->vtable->get_integer(interp, attr_value)); } } while (0);
...
# 197 "./src/pmc/callcontext.pmc"
static void
ensure_positionals_storage_ap(Parrot_Interp interp,
                              PMC *self, INTVAL size, INTVAL allocated_positionals)
{
    ...
    do { if (!(((self)->flags) & PObj_is_object_FLAG)) { (array) = ((Parrot_CallContext_attributes *)(self)->data)->positionals; } else { Parrot_ex_throw_from_c_args(interp, ((void *)0), EXCEPTION_INVALID_OPERATION, "Attributes of type 'struct Pcc_cell *' cannot be " "subclassed from a high-level PMC."); } } while (0);

    if (array) {
        do { if (!(((self)->flags) & PObj_is_object_FLAG)) { (num_positionals) = ((Parrot_CallContext_attributes *)(self)->data)->num_positionals; } else { PMC * const attr_value = (self)->vtable->get_attr_str(interp, self, Parrot_str_new_constant(interp, "num_positionals")); (num_positionals) = (((attr_value) == PMCNULL || (attr_value) == ((void *)0)) ? (INTVAL) 0: (attr_value)->vtable->get_integer(interp, attr_value)); } } while (0);
    ...
    do { if ((((self)->flags) & PObj_is_object_FLAG)) { PMC * const attr_value = Parrot_pmc_new_init_int(interp, enum_class_Integer, size); (self)->vtable->set_attr_str(interp, self, Parrot_str_new_constant(interp, "allocated_positionals"), attr_value); } else ((Parrot_CallContext_attributes *)(self)->data)->allocated_positionals = (size); } while (0);
    do { if ((((self)->flags) & PObj_is_object_FLAG)) { Parrot_ex_throw_from_c_args(interp, ((void *)0), EXCEPTION_INVALID_OPERATION, "Attributes of type 'struct Pcc_cell *' cannot be " "subclassed from a high-level PMC."); } else ((Parrot_CallContext_attributes *)(self)->data)->positionals = (new_array); } while (0);
}
# 242 "./src/pmc/callcontext.pmc"

static Pcc_cell*
get_cell_at(Parrot_Interp interp, PMC *self, INTVAL key)
{
   
    Pcc_cell *cells;
    ensure_positionals_storage(interp, self, key + 1);
    do { if (!(((self)->flags) & PObj_is_object_FLAG)) { (cells) = ((Parrot_CallContext_attributes *)(self)->data)->positionals; } else { Parrot_ex_throw_from_c_args(interp, ((void *)0), EXCEPTION_INVALID_OPERATION, "Attributes of type 'struct Pcc_cell *' cannot be " "subclassed from a high-level PMC."); } } while (0);
    return &cells[key];
}
# 263 "./src/pmc/callcontext.pmc"
static INTVAL
autobox_intval(Parrot_Interp interp, const Pcc_cell *cell)
{
    ...
    switch ((cell)->type) {
      case 1:
        return (cell)->u.i;
      case 2:
        return (INTVAL)(cell)->u.n;
      case 3:
        return (cell)->u.s ? Parrot_str_to_int(interp, (cell)->u.s) : 0;
      case 4:
        return ((cell)->u.p)->vtable->get_integer(interp, (cell)->u.p);
      default:
        break;
    }
...
# 294 "./src/pmc/callcontext.pmc"
static FLOATVAL
autobox_floatval(Parrot_Interp interp, const Pcc_cell *cell)
{
   
    switch ((cell)->type) {
      case 1:
        return (FLOATVAL)(cell)->u.i;
      case 2:
        return (cell)->u.n;
      case 3:
        return (cell)->u.s ? Parrot_str_to_num(interp, (cell)->u.s) : 0.0;
      case 4:
        return ((cell)->u.p)->vtable->get_number(interp, (cell)->u.p);
      default:
        break;
    }
...
# 325 "./src/pmc/callcontext.pmc"

static STRING *
autobox_string(Parrot_Interp interp, const Pcc_cell *cell)
{
   
    switch ((cell)->type) {
      case 1:
        return Parrot_str_from_int(interp, (cell)->u.i);
      case 2:
        return Parrot_str_from_num(interp, (cell)->u.n);
      case 3:
        return (cell)->u.s;
      case 4:
        return ((cell)->u.p)->vtable->get_string(interp, (cell)->u.p);
      default:
        break;
    }
...
# 357 "./src/pmc/callcontext.pmc"

static PMC *
autobox_pmc(Parrot_Interp interp, Pcc_cell *cell, INTVAL type)
{
    ...
    switch (type) {
      case 1:
        result = Parrot_pmc_new(interp, Parrot_hll_get_ctx_HLL_type(interp, (enum_class_Integer)));
        (result)->vtable->set_integer_native(interp, result, (cell)->u.i);
        break;
      case 2:
        result = Parrot_pmc_new(interp, Parrot_hll_get_ctx_HLL_type(interp, (enum_class_Float)));
        (result)->vtable->set_number_native(interp, result, (cell)->u.n);
        break;
      case 3:
        result = Parrot_pmc_box_string(interp, (cell)->u.s);
        break;
      case 4:
        result = (cell)->u.p;
      default:
...
# 396 "./src/pmc/callcontext.pmc"

static Hash *
get_hash(Parrot_Interp interp, PMC *SELF)
{
   
    Hash *hash;

    do { if (!(((SELF)->flags) & PObj_is_object_FLAG)) { (hash) = ((Parrot_CallContext_attributes *)(SELF)->data)->hash; } else { Parrot_ex_throw_from_c_args(interp, ((void *)0), EXCEPTION_INVALID_OPERATION, "Attributes of type 'Hash   *' cannot be " "subclassed from a high-level PMC."); } } while (0);
    ...
    if (!hash) {
        ...
        do { if ((((SELF)->flags) & PObj_is_object_FLAG)) { Parrot_ex_throw_from_c_args(interp, ((void *)0), EXCEPTION_INVALID_OPERATION, "Attributes of type 'Hash   *' cannot be " "subclassed from a high-level PMC."); } else ((Parrot_CallContext_attributes *)(SELF)->data)->hash = (hash); } while (0);
    }

    return hash;
}
# 426 "./src/pmc/callcontext.pmc"
static void
mark_cell(Parrot_Interp interp, Pcc_cell *c)
{
   
    switch ((c)->type) {
        case 3:
            if ((c)->u.s)
                Parrot_gc_mark_STRING_alive_fun((interp), ((c)->u.s));
            break;
        case 4:
            if (!(((c)->u.p) == PMCNULL || ((c)->u.p) == ((void *)0)))
                do if (!(((c)->u.p) == PMCNULL || ((c)->u.p) == ((void *)0)) && (!((((c)->u.p)->flags) & PObj_is_shared_FLAG) || !(((interp))->flags & (PARROT_IS_THREAD)))) { Parrot_gc_mark_PMC_alive_fun((interp), ((c)->u.p)); } while (0);
            break;
        case 1:
        case 2:
        default:
...
# 457 "./src/pmc/callcontext.pmc"
static void
mark_positionals(Parrot_Interp interp, PMC *self)
{
   
    INTVAL size;

    do { if (!(((self)->flags) & PObj_is_object_FLAG)) { (size) = ((Parrot_CallContext_attributes *)(self)->data)->num_positionals; } else { PMC * const attr_value = (self)->vtable->get_attr_str(interp, self, Parrot_str_new_constant(interp, "num_positionals")); (size) = (((attr_value) == PMCNULL || (attr_value) == ((void *)0)) ? (INTVAL) 0: (attr_value)->vtable->get_integer(interp, attr_value)); } } while (0);
...
# 486 "./src/pmc/callcontext.pmc"
static void
mark_hash(Parrot_Interp interp, Hash *h)
{
   
    do { if ((h)->key_type == Hash_key_type_int || (h)->key_type == Hash_key_type_cstring || (h)->key_type == Hash_key_type_ptr) do { if (((h))->entries) { UINTVAL _loc; for (_loc = 0; _loc <= ((h))->mask; ++_loc) { HashBucket *_bucket = ((h))->index[_loc]; while (_bucket) { Parrot_gc_mark_STRING_alive_fun((interp), ((STRING *)_bucket->key)); mark_cell(interp, (Pcc_cell *)_bucket->value); _bucket = _bucket->next; } } } } while (0); else do { HashBucket *_bucket = ((h))->buckets; UINTVAL _found = 0; while (_found < ((h))->entries){ if (_bucket->key){ Parrot_gc_mark_STRING_alive_fun((interp), ((STRING *)_bucket->key)); mark_cell(interp, (Pcc_cell *)_bucket->value); _found++; } _bucket++; } } while (0); } while (0)

                                                       ;
}
# 505 "./src/pmc/callcontext.pmc"

static PMC *
get_named_names(Parrot_Interp interp, PMC *SELF)
{
    ...
    do { if (((((SELF))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (SELF)); } while (0);
    ...
    if (hash && hash->entries) {
        ...
        do { if ((hash)->key_type == Hash_key_type_int || (hash)->key_type == Hash_key_type_cstring || (hash)->key_type == Hash_key_type_ptr) do { if (((hash))->entries) { UINTVAL _loc; for (_loc = 0; _loc <= ((hash))->mask; ++_loc) { HashBucket *_bucket = ((hash))->index[_loc]; while (_bucket) { (result)->vtable->set_string_keyed_int(interp, result, j++, (STRING *)_bucket->key); _bucket = _bucket->next; } } } } while (0); else do { HashBucket *_bucket = ((hash))->buckets; UINTVAL _found = 0; while (_found < ((hash))->entries){ if (_bucket->key){ (result)->vtable->set_string_keyed_int(interp, result, j++, (STRING *)_bucket->key); _found++; } _bucket++; } } while (0); } while (0)
                                                                                      ;
        return result;
    }
...
# 1 "./include/pmc/pmc_sub.h" 1
# 18 "./include/pmc/pmc_sub.h"
__attribute__ ((visibility("default"))) VTABLE* Parrot_Sub_update_vtable(VTABLE*);
__attribute__ ((visibility("default"))) VTABLE* Parrot_Sub_ro_update_vtable(VTABLE*);
__attribute__ ((visibility("default"))) VTABLE* Parrot_Sub_get_vtable(Parrot_Interp interp);
__attribute__ ((visibility("default"))) VTABLE* Parrot_Sub_ro_get_vtable(Parrot_Interp interp);
__attribute__ ((visibility("default"))) PMC* Parrot_Sub_get_mro(Parrot_Interp interp, PMC* mro);
__attribute__ ((visibility("default"))) Hash* Parrot_Sub_get_isa(Parrot_Interp interp, Hash* isa);


typedef struct Parrot_Sub_attributes {
    PackFile_ByteCode * seg;
    size_t start_offs;
    size_t end_offs;
    INTVAL HLL_id;
    ...
    PMC * ctx;
    UINTVAL comp_flags;
    Parrot_sub_arginfo * arg_info;
    PMC * outer_ctx;
} Parrot_Sub_attributes;
# 533 "./src/pmc/callcontext.pmc" 2
# 556 "./src/pmc/callcontext.c"
static PMC * Parrot_CallContext_clone(Parrot_Interp interp, PMC *_self);
static void Parrot_CallContext_destroy(Parrot_Interp interp, PMC *_self);
static INTVAL Parrot_CallContext_elements(Parrot_Interp interp, PMC *_self);
static INTVAL Parrot_CallContext_exists_keyed(Parrot_Interp interp, PMC *_self, PMC *key);
static INTVAL Parrot_CallContext_exists_keyed_int(Parrot_Interp interp, PMC *_self, INTVAL key);
static INTVAL Parrot_CallContext_exists_keyed_str(Parrot_Interp interp, PMC *_self, STRING *key);
static PMC * Parrot_CallContext_get_attr_str(Parrot_Interp interp, PMC *_self, STRING *key);
static INTVAL Parrot_CallContext_get_integer_keyed(Parrot_Interp interp, PMC *_self, PMC *key);
static INTVAL Parrot_CallContext_get_integer_keyed_int(Parrot_Interp interp, PMC *_self, INTVAL key);
static INTVAL Parrot_CallContext_get_integer_keyed_str(Parrot_Interp interp, PMC *_self, STRING *key);
static FLOATVAL Parrot_CallContext_get_number_keyed(Parrot_Interp interp, PMC *_self, PMC *key);
static FLOATVAL Parrot_CallContext_get_number_keyed_int(Parrot_Interp interp, PMC *_self, INTVAL key);
static FLOATVAL Parrot_CallContext_get_number_keyed_str(Parrot_Interp interp, PMC *_self, STRING *key);
static PMC * Parrot_CallContext_get_pmc(Parrot_Interp interp, PMC *_self);
static PMC * Parrot_CallContext_get_pmc_keyed(Parrot_Interp interp, PMC *_self, PMC *key);
static PMC * Parrot_CallContext_get_pmc_keyed_int(Parrot_Interp interp, PMC *_self, INTVAL key);
static PMC * Parrot_CallContext_get_pmc_keyed_str(Parrot_Interp interp, PMC *_self, STRING *key);
static STRING * Parrot_CallContext_get_string(Parrot_Interp interp, PMC *_self);
static STRING * Parrot_CallContext_get_string_keyed(Parrot_Interp interp, PMC *_self, PMC *key);
static STRING * Parrot_CallContext_get_string_keyed_int(Parrot_Interp interp, PMC *_self, INTVAL key);
static STRING * Parrot_CallContext_get_string_keyed_str(Parrot_Interp interp, PMC *_self, STRING *key);
static void Parrot_CallContext_init(Parrot_Interp interp, PMC *_self);
static void Parrot_CallContext_mark(Parrot_Interp interp, PMC *_self);
static void Parrot_CallContext_morph(Parrot_Interp interp, PMC *_self, PMC *type_unused __attribute__((__unused__)));
static void Parrot_CallContext_push_float(Parrot_Interp interp, PMC *_self, FLOATVAL value);
static void Parrot_CallContext_push_integer(Parrot_Interp interp, PMC *_self, INTVAL value);
static void Parrot_CallContext_push_pmc(Parrot_Interp interp, PMC *_self, PMC *value);
static void Parrot_CallContext_push_string(Parrot_Interp interp, PMC *_self, STRING *value);
static void Parrot_CallContext_set_attr_str(Parrot_Interp interp, PMC *_self, STRING *key, PMC *value);
static void Parrot_CallContext_set_integer_keyed(Parrot_Interp interp, PMC *_self, PMC *key, INTVAL value);
static void Parrot_CallContext_set_integer_keyed_int(Parrot_Interp interp, PMC *_self, INTVAL key, INTVAL value);
static void Parrot_CallContext_set_integer_keyed_str(Parrot_Interp interp, PMC *_self, STRING *key, INTVAL value);
static void Parrot_CallContext_set_number_keyed(Parrot_Interp interp, PMC *_self, PMC *key, FLOATVAL value);
static void Parrot_CallContext_set_number_keyed_int(Parrot_Interp interp, PMC *_self, INTVAL key, FLOATVAL value);
static void Parrot_CallContext_set_number_keyed_str(Parrot_Interp interp, PMC *_self, STRING *key, FLOATVAL value);
static void Parrot_CallContext_set_pmc(Parrot_Interp interp, PMC *_self, PMC *value);
static void Parrot_CallContext_set_pmc_keyed(Parrot_Interp interp, PMC *_self, PMC *key, PMC *value);
static void Parrot_CallContext_set_pmc_keyed_int(Parrot_Interp interp, PMC *_self, INTVAL key, PMC *value);
static void Parrot_CallContext_set_pmc_keyed_str(Parrot_Interp interp, PMC *_self, STRING *key, PMC *value);
static void Parrot_CallContext_set_string_keyed(Parrot_Interp interp, PMC *_self, PMC *key, STRING *value);
static void Parrot_CallContext_set_string_keyed_int(Parrot_Interp interp, PMC *_self, INTVAL key, STRING *value);
static void Parrot_CallContext_set_string_keyed_str(Parrot_Interp interp, PMC *_self, STRING *key, STRING *value);
static void Parrot_CallContext_set_string_native(Parrot_Interp interp, PMC *_self, STRING *value);
static PMC * Parrot_CallContext_shift_pmc(Parrot_Interp interp, PMC *_self);
static STRING * Parrot_CallContext_shift_string(Parrot_Interp interp, PMC *_self);
static void Parrot_CallContext_unshift_pmc(Parrot_Interp interp, PMC *_self, PMC *value);
static void Parrot_CallContext_nci_backtrace(Parrot_Interp interp, PMC *_self);
void Parrot_CallContext_class_init(Parrot_Interp interp, int, int);
void Parrot_CallContext_ro_class_init(Parrot_Interp interp, int, int);
static PMC *
Parrot_CallContext_clone(Parrot_Interp interp, PMC *_self)
{
# 1575 "./src/pmc/callcontext.pmc"
    ...
    do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (num) = ((Parrot_CallContext_attributes *)(_self)->data)->num_positionals; } else { PMC * const attr_value = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "num_positionals")); (num) = (((attr_value) == PMCNULL || (attr_value) == ((void *)0)) ? (INTVAL) 0: (attr_value)->vtable->get_integer(interp, attr_value)); } } while (0);

    ensure_positionals_storage(interp, dest, num);
    do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (our_cells) = ((Parrot_CallContext_attributes *)(_self)->data)->positionals; } else { Parrot_ex_throw_from_c_args(interp, ((void *)0), EXCEPTION_INVALID_OPERATION, "Attributes of type 'struct Pcc_cell *' cannot be " "subclassed from a high-level PMC."); } } while (0);
    do { if (!(((dest)->flags) & PObj_is_object_FLAG)) { (dest_cells) = ((Parrot_CallContext_attributes *)(dest)->data)->positionals; } else { Parrot_ex_throw_from_c_args(interp, ((void *)0), EXCEPTION_INVALID_OPERATION, "Attributes of type 'struct Pcc_cell *' cannot be " "subclassed from a high-level PMC."); } } while (0);
    memcpy(dest_cells, our_cells, num * sizeof (Pcc_cell));
    do { if ((((dest)->flags) & PObj_is_object_FLAG)) { PMC * const attr_value = Parrot_pmc_new_init_int(interp, enum_class_Integer, num); (dest)->vtable->set_attr_str(interp, dest, Parrot_str_new_constant(interp, "num_positionals"), attr_value); } else ((Parrot_CallContext_attributes *)(dest)->data)->num_positionals = (num); } while (0);

    do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (type_tuple) = ((Parrot_CallContext_attributes *)(_self)->data)->type_tuple; } else { (type_tuple) = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "type_tuple")); } } while (0);
    do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (short_sig) = ((Parrot_CallContext_attributes *)(_self)->data)->short_sig; } else { PMC * const attr_value = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "short_sig")); (short_sig) = (((attr_value) == PMCNULL || (attr_value) == ((void *)0)) ? (STRING *)((void *)0) : (attr_value)->vtable->get_string(interp, attr_value)); } } while (0);
    do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (arg_flags) = ((Parrot_CallContext_attributes *)(_self)->data)->arg_flags; } else { (arg_flags) = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "arg_flags")); } } while (0);
    do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (return_flags) = ((Parrot_CallContext_attributes *)(_self)->data)->return_flags; } else { (return_flags) = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "return_flags")); } } while (0);

    do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (hash) = ((Parrot_CallContext_attributes *)(_self)->data)->hash; } else { Parrot_ex_throw_from_c_args(interp, ((void *)0), EXCEPTION_INVALID_OPERATION, "Attributes of type 'Hash   *' cannot be " "subclassed from a high-level PMC."); } } while (0);

    if (!((type_tuple) == PMCNULL || (type_tuple) == ((void *)0)))
        do { if ((((dest)->flags) & PObj_is_object_FLAG)) { (dest)->vtable->set_attr_str(interp, dest, Parrot_str_new_constant(interp, "type_tuple"), (type_tuple)->vtable->clone(interp, type_tuple)); } else ((Parrot_CallContext_attributes *)(dest)->data)->type_tuple = ((type_tuple)->vtable->clone(interp, type_tuple)); } while (0);

    if (short_sig)
        do { if ((((dest)->flags) & PObj_is_object_FLAG)) { PMC * const attr_value = Parrot_pmc_new(interp, enum_class_String); (attr_value)->vtable->set_string_native(interp, attr_value, short_sig); (dest)->vtable->set_attr_str(interp, dest, Parrot_str_new_constant(interp, "short_sig"), attr_value); } else ((Parrot_CallContext_attributes *)(dest)->data)->short_sig = (short_sig); } while (0);

    if (!((arg_flags) == PMCNULL || (arg_flags) == ((void *)0)))
        do { if ((((dest)->flags) & PObj_is_object_FLAG)) { (dest)->vtable->set_attr_str(interp, dest, Parrot_str_new_constant(interp, "arg_flags"), (arg_flags)->vtable->clone(interp, arg_flags)); } else ((Parrot_CallContext_attributes *)(dest)->data)->arg_flags = ((arg_flags)->vtable->clone(interp, arg_flags)); } while (0);

    if (!((return_flags) == PMCNULL || (return_flags) == ((void *)0)))
        do { if ((((dest)->flags) & PObj_is_object_FLAG)) { (dest)->vtable->set_attr_str(interp, dest, Parrot_str_new_constant(interp, "return_flags"), (return_flags)->vtable->clone(interp, return_flags)); } else ((Parrot_CallContext_attributes *)(dest)->data)->return_flags = ((return_flags)->vtable->clone(interp, return_flags)); } while (0);

    if (hash) {
        Hash *dest_hash = get_hash(interp, dest);
        Parrot_hash_clone(interp, hash, dest_hash);
        do { if ((dest_hash)->key_type == Hash_key_type_int || (dest_hash)->key_type == Hash_key_type_cstring || (dest_hash)->key_type == Hash_key_type_ptr) do { if (((dest_hash))->entries) { UINTVAL _loc; for (_loc = 0; _loc <= ((dest_hash))->mask; ++_loc) { HashBucket *_bucket = ((dest_hash))->index[_loc]; while (_bucket) { Pcc_cell *tmp; do { (tmp) = (Pcc_cell *)Parrot_gc_allocate_fixed_size_storage((interp), sizeof (Pcc_cell)); *(tmp) = *((Pcc_cell *)_bucket->value); } while (0); _bucket->value = tmp; _bucket = _bucket->next; } } } } while (0); else do { HashBucket *_bucket = ((dest_hash))->buckets; UINTVAL _found = 0; while (_found < ((dest_hash))->entries){ if (_bucket->key){ Pcc_cell *tmp; do { (tmp) = (Pcc_cell *)Parrot_gc_allocate_fixed_size_storage((interp), sizeof (Pcc_cell)); *(tmp) = *((Pcc_cell *)_bucket->value); } while (0); _bucket->value = tmp; _found++; } _bucket++; } } while (0); } while (0)
    ...
    return dest;
# 660 "./src/pmc/callcontext.c"
}
static void
Parrot_CallContext_destroy(Parrot_Interp interp, PMC *_self)
{
# 727 "./src/pmc/callcontext.pmc"
    ...
    do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (hash) = ((Parrot_CallContext_attributes *)(_self)->data)->hash; } else { Parrot_ex_throw_from_c_args(interp, ((void *)0), EXCEPTION_INVALID_OPERATION, "Attributes of type 'Hash   *' cannot be " "subclassed from a high-level PMC."); } } while (0);
    do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (allocated_positionals) = ((Parrot_CallContext_attributes *)(_self)->data)->allocated_positionals; } else { PMC * const attr_value = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "allocated_positionals")); (allocated_positionals) = (((attr_value) == PMCNULL || (attr_value) == ((void *)0)) ? (INTVAL) 0: (attr_value)->vtable->get_integer(interp, attr_value)); } } while (0);

    if (allocated_positionals) {
        Pcc_cell *c;

        do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (c) = ((Parrot_CallContext_attributes *)(_self)->data)->positionals; } else { Parrot_ex_throw_from_c_args(interp, ((void *)0), EXCEPTION_INVALID_OPERATION, "Attributes of type 'struct Pcc_cell *' cannot be " "subclassed from a high-level PMC."); } } while (0);
        if (allocated_positionals > 8)
    ...
    if (hash) {
        do { if ((hash)->key_type == Hash_key_type_int || (hash)->key_type == Hash_key_type_cstring || (hash)->key_type == Hash_key_type_ptr) do { if (((hash))->entries) { UINTVAL _loc; for (_loc = 0; _loc <= ((hash))->mask; ++_loc) { HashBucket *_bucket = ((hash))->index[_loc]; while (_bucket) { Parrot_gc_free_fixed_size_storage((interp), sizeof (Pcc_cell), ((Pcc_cell *)_bucket->value)); _bucket = _bucket->next; } } } } while (0); else do { HashBucket *_bucket = ((hash))->buckets; UINTVAL _found = 0; while (_found < ((hash))->entries){ if (_bucket->key){ Parrot_gc_free_fixed_size_storage((interp), sizeof (Pcc_cell), ((Pcc_cell *)_bucket->value)); _found++; } _bucket++; } } while (0); } while (0)
                                                           ;
    ...
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 695 "./src/pmc/callcontext.c"
}
static INTVAL
Parrot_CallContext_elements(Parrot_Interp interp, PMC *_self)
{
# 1042 "./src/pmc/callcontext.pmc"
    ...
    do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (num_positionals) = ((Parrot_CallContext_attributes *)(_self)->data)->num_positionals; } else { PMC * const attr_value = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "num_positionals")); (num_positionals) = (((attr_value) == PMCNULL || (attr_value) == ((void *)0)) ? (INTVAL) 0: (attr_value)->vtable->get_integer(interp, attr_value)); } } while (0);

    return num_positionals;
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 711 "./src/pmc/callcontext.c"
}
static INTVAL
Parrot_CallContext_exists_keyed(Parrot_Interp interp, PMC *_self, PMC *key)
{
# 1531 "./src/pmc/callcontext.pmc"
    ...
    return 0;
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 728 "./src/pmc/callcontext.c"
}
static INTVAL
Parrot_CallContext_exists_keyed_int(Parrot_Interp interp, PMC *_self, INTVAL key)
{
# 1555 "./src/pmc/callcontext.pmc"
    ...
    return 0;
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 744 "./src/pmc/callcontext.c"
}
static INTVAL
Parrot_CallContext_exists_keyed_str(Parrot_Interp interp, PMC *_self, STRING *key)
{
# 1543 "./src/pmc/callcontext.pmc"
    ...
    return 0;
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 761 "./src/pmc/callcontext.c"
}
static PMC *
Parrot_CallContext_get_attr_str(Parrot_Interp interp, PMC *_self, STRING *key)
{
# 996 "./src/pmc/callcontext.pmc"

    PMC *value = PMCNULL;
    INTVAL hll;

    if (((key)->encoding)->equal((interp), (key), ((interp)->const_cstring_table[373]))) {
        do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
        value = get_named_names(interp, _self);
    }
    else if (((key)->encoding)->equal((interp), (key), ((interp)->const_cstring_table[374])))
        do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (value) = ((Parrot_CallContext_attributes *)(_self)->data)->arg_flags; } else { (value) = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "arg_flags")); } } while (0);
    else if (((key)->encoding)->equal((interp), (key), ((interp)->const_cstring_table[375])))
        do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (value) = ((Parrot_CallContext_attributes *)(_self)->data)->return_flags; } else { (value) = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "return_flags")); } } while (0);
    else if (((key)->encoding)->equal((interp), (key), ((interp)->const_cstring_table[376])))
        do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (value) = ((Parrot_CallContext_attributes *)(_self)->data)->caller_ctx; } else { (value) = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "caller_ctx")); } } while (0);
    else if (((key)->encoding)->equal((interp), (key), ((interp)->const_cstring_table[377])))
        do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (value) = ((Parrot_CallContext_attributes *)(_self)->data)->lex_pad; } else { (value) = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "lex_pad")); } } while (0);
    else if (((key)->encoding)->equal((interp), (key), ((interp)->const_cstring_table[378])))
        do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (value) = ((Parrot_CallContext_attributes *)(_self)->data)->outer_ctx; } else { (value) = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "outer_ctx")); } } while (0);
    else if (((key)->encoding)->equal((interp), (key), ((interp)->const_cstring_table[379])))
        do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (value) = ((Parrot_CallContext_attributes *)(_self)->data)->current_sub; } else { (value) = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "current_sub")); } } while (0);
    else if (((key)->encoding)->equal((interp), (key), ((interp)->const_cstring_table[380])))
        do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (value) = ((Parrot_CallContext_attributes *)(_self)->data)->current_cont; } else { (value) = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "current_cont")); } } while (0);
    else if (((key)->encoding)->equal((interp), (key), ((interp)->const_cstring_table[381])))
        do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (value) = ((Parrot_CallContext_attributes *)(_self)->data)->current_namespace; } else { (value) = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "current_namespace")); } } while (0);
    else if (((key)->encoding)->equal((interp), (key), ((interp)->const_cstring_table[382])))
        do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (value) = ((Parrot_CallContext_attributes *)(_self)->data)->handlers; } else { (value) = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "handlers")); } } while (0);
    else if (((key)->encoding)->equal((interp), (key), ((interp)->const_cstring_table[383]))) {
        do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (hll) = ((Parrot_CallContext_attributes *)(_self)->data)->current_HLL; } else { PMC * const attr_value = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "current_HLL")); (hll) = (((attr_value) == PMCNULL || (attr_value) == ((void *)0)) ? (INTVAL) 0: (attr_value)->vtable->get_integer(interp, attr_value)); } } while (0);
        do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
        value = Parrot_pmc_new(interp, Parrot_hll_get_ctx_HLL_type(interp, enum_class_Integer));
        (value)->vtable->set_integer_native(interp, value, hll);
    }
    else if (((key)->encoding)->equal((interp), (key), ((interp)->const_cstring_table[384]))) {
        do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (hll) = ((Parrot_CallContext_attributes *)(_self)->data)->current_HLL; } else { PMC * const attr_value = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "current_HLL")); (hll) = (((attr_value) == PMCNULL || (attr_value) == ((void *)0)) ? (INTVAL) 0: (attr_value)->vtable->get_integer(interp, attr_value)); } } while (0);
        do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
        value = Parrot_pmc_new(interp, Parrot_hll_get_ctx_HLL_type(interp, enum_class_String));
        (value)->vtable->set_string_native(interp, value, Parrot_hll_get_HLL_name(interp, hll));
    }
    else
        Parrot_ex_throw_from_c_args(interp, ((void *)0),
            EXCEPTION_ATTRIB_NOT_FOUND, "No such attribute '%S'", key);
    if (value)
        return value;
    return PMCNULL;
# 811 "./src/pmc/callcontext.c"
}
static INTVAL
Parrot_CallContext_get_integer_keyed(Parrot_Interp interp, PMC *_self, PMC *key)
{
# 1464 "./src/pmc/callcontext.pmc"
    ...
    return 0;
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 834 "./src/pmc/callcontext.c"
}
static INTVAL
Parrot_CallContext_get_integer_keyed_int(Parrot_Interp interp, PMC *_self, INTVAL key)
{
# 1182 "./src/pmc/callcontext.pmc"

    Pcc_cell *cells;
    INTVAL num_pos;

    do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (num_pos) = ((Parrot_CallContext_attributes *)(_self)->data)->num_positionals; } else { PMC * const attr_value = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "num_positionals")); (num_pos) = (((attr_value) == PMCNULL || (attr_value) == ((void *)0)) ? (INTVAL) 0: (attr_value)->vtable->get_integer(interp, attr_value)); } } while (0);
    if (key >= num_pos || key < 0)
        return 0;

    do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (cells) = ((Parrot_CallContext_attributes *)(_self)->data)->positionals; } else { Parrot_ex_throw_from_c_args(interp, ((void *)0), EXCEPTION_INVALID_OPERATION, "Attributes of type 'struct Pcc_cell *' cannot be " "subclassed from a high-level PMC."); } } while (0);
    {
    ...
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 857 "./src/pmc/callcontext.c"
}
static INTVAL
Parrot_CallContext_get_integer_keyed_str(Parrot_Interp interp, PMC *_self, STRING *key)
{
# 1395 "./src/pmc/callcontext.pmc"
    ...
    return 0;
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 881 "./src/pmc/callcontext.c"
}
static FLOATVAL
Parrot_CallContext_get_number_keyed(Parrot_Interp interp, PMC *_self, PMC *key)
{
# 1482 "./src/pmc/callcontext.pmc"
    ...
    return 0.0;
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 901 "./src/pmc/callcontext.c"
}
static FLOATVAL
Parrot_CallContext_get_number_keyed_int(Parrot_Interp interp, PMC *_self, INTVAL key)
{
# 1200 "./src/pmc/callcontext.pmc"
    ...
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 918 "./src/pmc/callcontext.c"
}
static FLOATVAL
Parrot_CallContext_get_number_keyed_str(Parrot_Interp interp, PMC *_self, STRING *key)
{
# 1414 "./src/pmc/callcontext.pmc"
    ...
    return 0.0;
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 938 "./src/pmc/callcontext.c"
}
static PMC *
Parrot_CallContext_get_pmc(Parrot_Interp interp, PMC *_self)
{
# 849 "./src/pmc/callcontext.pmc"
    ...
    if (((type_tuple) == PMCNULL || (type_tuple) == ((void *)0))) {
        ...
        for (i = 0; i < num_positionals; ++i) {
            ...
            switch (c[i].type) {
                case 1: type = -enum_type_INTVAL; break;
                case 2: type = -enum_type_FLOATVAL; break;
                case 3: type = -enum_type_STRING; break;
                case 4:
                    type = ((c[i].u.p) == PMCNULL || (c[i].u.p) == ((void *)0))
                         ? (INTVAL)-enum_type_PMC
                         : (c[i].u.p)->vtable->type(interp, c[i].u.p);
                    break;
                default:
                    Parrot_ex_throw_from_c_args(interp, ((void *)0),
                        EXCEPTION_INVALID_OPERATION,
            ...
            (type_tuple)->vtable->set_integer_keyed_int(interp, type_tuple, i, type);
        }

        do { if ((((_self)->flags) & PObj_is_object_FLAG)) { (_self)->vtable->set_attr_str(interp, _self, Parrot_str_new_constant(interp, "type_tuple"), type_tuple); } else ((Parrot_CallContext_attributes *)(_self)->data)->type_tuple = (type_tuple); } while (0);
    }

    return type_tuple;
# 987 "./src/pmc/callcontext.c"
}
static PMC *
Parrot_CallContext_get_pmc_keyed(Parrot_Interp interp, PMC *_self, PMC *key)
{
# 1512 "./src/pmc/callcontext.pmc"
    ...
    return PMCNULL;
# 1010 "./src/pmc/callcontext.c"
}
static PMC *
Parrot_CallContext_get_pmc_keyed_int(Parrot_Interp interp, PMC *_self, INTVAL key)
{
# 1224 "./src/pmc/callcontext.pmc"
    ...
    type = (&cells[key])->type;
    if (type == 4)
        return (&cells[key])->u.p;
    return autobox_pmc(interp, &cells[key], type);
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 1030 "./src/pmc/callcontext.c"
}
static PMC *
Parrot_CallContext_get_pmc_keyed_str(Parrot_Interp interp, PMC *_self, STRING *key)
{
# 1445 "./src/pmc/callcontext.pmc"
    ...
    return PMCNULL;
# 1053 "./src/pmc/callcontext.c"
}
static STRING *
Parrot_CallContext_get_string(Parrot_Interp interp, PMC *_self)
{
# 781 "./src/pmc/callcontext.pmc"

    STRING *res;
    Pcc_cell *c;
    INTVAL num_positionals, i;

    do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (res) = ((Parrot_CallContext_attributes *)(_self)->data)->short_sig; } else { PMC * const attr_value = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "short_sig")); (res) = (((attr_value) == PMCNULL || (attr_value) == ((void *)0)) ? (STRING *)((void *)0) : (attr_value)->vtable->get_string(interp, attr_value)); } } while (0);

    if (res) {
# 1067 "./src/pmc/callcontext.c"
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
    return (STRING*)res;
# 789 "./src/pmc/callcontext.pmc"
    ...
    res = Parrot_str_new(interp, ((void *)0), num_positionals);

    for (i = 0; i < num_positionals; ++i) {
        switch (c[i].type) {
          case 1:
            res = Parrot_str_concat(interp, res, (interp)->const_cstring_table[52]);
            break;
          case 2:
            res = Parrot_str_concat(interp, res, (interp)->const_cstring_table[385]);
            break;
          case 3:
            res = Parrot_str_concat(interp, res, (interp)->const_cstring_table[51]);
            break;
          case 4:
            res = Parrot_str_concat(interp, res, (interp)->const_cstring_table[50]);
            break;
          default:
            ((void)0);
            break;
    ...
    do { if ((((_self)->flags) & PObj_is_object_FLAG)) { PMC * const attr_value = Parrot_pmc_new(interp, enum_class_String); (attr_value)->vtable->set_string_native(interp, attr_value, res); (_self)->vtable->set_attr_str(interp, _self, Parrot_str_new_constant(interp, "short_sig"), attr_value); } else ((Parrot_CallContext_attributes *)(_self)->data)->short_sig = (res); } while (0);
# 1103 "./src/pmc/callcontext.c"
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
    return (STRING*)res;
# 821 "./src/pmc/callcontext.pmc"
# 1108 "./src/pmc/callcontext.c"
}
static STRING *
Parrot_CallContext_get_string_keyed(Parrot_Interp interp, PMC *_self, PMC *key)
{
# 1497 "./src/pmc/callcontext.pmc"
    ...
    return STRINGNULL;
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 1128 "./src/pmc/callcontext.c"
}
static STRING *
Parrot_CallContext_get_string_keyed_int(Parrot_Interp interp, PMC *_self, INTVAL key)
{
# 1212 "./src/pmc/callcontext.pmc"
    ...
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 1145 "./src/pmc/callcontext.c"
}
static STRING *
Parrot_CallContext_get_string_keyed_str(Parrot_Interp interp, PMC *_self, STRING *key)
{
# 1430 "./src/pmc/callcontext.pmc"
    ...
    return STRINGNULL;
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 1165 "./src/pmc/callcontext.c"
}
static void
Parrot_CallContext_init(Parrot_Interp interp, PMC *_self)
{
# 591 "./src/pmc/callcontext.pmc"

    do { if ((((_self)->flags) & PObj_is_object_FLAG)) { (_self)->vtable->set_attr_str(interp, _self, Parrot_str_new_constant(interp, "type_tuple"), PMCNULL); } else ((Parrot_CallContext_attributes *)(_self)->data)->type_tuple = (PMCNULL); } while (0);

    do { if ((((_self)->flags) & PObj_is_object_FLAG)) { Parrot_ex_throw_from_c_args(interp, ((void *)0), EXCEPTION_INVALID_OPERATION, "Attributes of type 'struct Pcc_cell *' cannot be " "subclassed from a high-level PMC."); } else ((Parrot_CallContext_attributes *)(_self)->data)->positionals = (((void *)0)); } while (0);
    do { if ((((_self)->flags) & PObj_is_object_FLAG)) { PMC * const attr_value = Parrot_pmc_new_init_int(interp, enum_class_Integer, 0); (_self)->vtable->set_attr_str(interp, _self, Parrot_str_new_constant(interp, "num_positionals"), attr_value); } else ((Parrot_CallContext_attributes *)(_self)->data)->num_positionals = (0); } while (0);

    do { (((_self)->flags) |= PObj_custom_mark_FLAG); (((_self)->flags) |= PObj_custom_destroy_FLAG); } while (0);
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 1179 "./src/pmc/callcontext.c"
}
static void
Parrot_CallContext_mark(Parrot_Interp interp, PMC *_self)
{
# 609 "./src/pmc/callcontext.pmc"
    ...
    do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (short_sig) = ((Parrot_CallContext_attributes *)(_self)->data)->short_sig; } else { PMC * const attr_value = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "short_sig")); (short_sig) = (((attr_value) == PMCNULL || (attr_value) == ((void *)0)) ? (STRING *)((void *)0) : (attr_value)->vtable->get_string(interp, attr_value)); } } while (0);
    Parrot_gc_mark_STRING_alive_fun((interp), (short_sig));
    ...
    do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (tmp) = ((Parrot_CallContext_attributes *)(_self)->data)->arg_flags; } else { (tmp) = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "arg_flags")); } } while (0);
    do if (!((tmp) == PMCNULL || (tmp) == ((void *)0)) && (!(((tmp)->flags) & PObj_is_shared_FLAG) || !(((interp))->flags & (PARROT_IS_THREAD)))) { Parrot_gc_mark_PMC_alive_fun((interp), (tmp)); } while (0);

    do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (tmp) = ((Parrot_CallContext_attributes *)(_self)->data)->return_flags; } else { (tmp) = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "return_flags")); } } while (0);
    do if (!((tmp) == PMCNULL || (tmp) == ((void *)0)) && (!(((tmp)->flags) & PObj_is_shared_FLAG) || !(((interp))->flags & (PARROT_IS_THREAD)))) { Parrot_gc_mark_PMC_alive_fun((interp), (tmp)); } while (0);

    do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (tmp) = ((Parrot_CallContext_attributes *)(_self)->data)->type_tuple; } else { (tmp) = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "type_tuple")); } } while (0);
    do if (!((tmp) == PMCNULL || (tmp) == ((void *)0)) && (!(((tmp)->flags) & PObj_is_shared_FLAG) || !(((interp))->flags & (PARROT_IS_THREAD)))) { Parrot_gc_mark_PMC_alive_fun((interp), (tmp)); } while (0);

    do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (tmp) = ((Parrot_CallContext_attributes *)(_self)->data)->caller_ctx; } else { (tmp) = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "caller_ctx")); } } while (0);
    do if (!((tmp) == PMCNULL || (tmp) == ((void *)0)) && (!(((tmp)->flags) & PObj_is_shared_FLAG) || !(((interp))->flags & (PARROT_IS_THREAD)))) { Parrot_gc_mark_PMC_alive_fun((interp), (tmp)); } while (0);

    do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (tmp) = ((Parrot_CallContext_attributes *)(_self)->data)->lex_pad; } else { (tmp) = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "lex_pad")); } } while (0);
    do if (!((tmp) == PMCNULL || (tmp) == ((void *)0)) && (!(((tmp)->flags) & PObj_is_shared_FLAG) || !(((interp))->flags & (PARROT_IS_THREAD)))) { Parrot_gc_mark_PMC_alive_fun((interp), (tmp)); } while (0);

    do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (tmp) = ((Parrot_CallContext_attributes *)(_self)->data)->outer_ctx; } else { (tmp) = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "outer_ctx")); } } while (0);
    do if (!((tmp) == PMCNULL || (tmp) == ((void *)0)) && (!(((tmp)->flags) & PObj_is_shared_FLAG) || !(((interp))->flags & (PARROT_IS_THREAD)))) { Parrot_gc_mark_PMC_alive_fun((interp), (tmp)); } while (0);

    do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (tmp) = ((Parrot_CallContext_attributes *)(_self)->data)->current_sub; } else { (tmp) = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "current_sub")); } } while (0);
    do if (!((tmp) == PMCNULL || (tmp) == ((void *)0)) && (!(((tmp)->flags) & PObj_is_shared_FLAG) || !(((interp))->flags & (PARROT_IS_THREAD)))) { Parrot_gc_mark_PMC_alive_fun((interp), (tmp)); } while (0);

    do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (tmp) = ((Parrot_CallContext_attributes *)(_self)->data)->handlers; } else { (tmp) = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "handlers")); } } while (0);
    do if (!((tmp) == PMCNULL || (tmp) == ((void *)0)) && (!(((tmp)->flags) & PObj_is_shared_FLAG) || !(((interp))->flags & (PARROT_IS_THREAD)))) { Parrot_gc_mark_PMC_alive_fun((interp), (tmp)); } while (0);

    do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (tmp) = ((Parrot_CallContext_attributes *)(_self)->data)->current_cont; } else { (tmp) = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "current_cont")); } } while (0);
    do if (!((tmp) == PMCNULL || (tmp) == ((void *)0)) && (!(((tmp)->flags) & PObj_is_shared_FLAG) || !(((interp))->flags & (PARROT_IS_THREAD)))) { Parrot_gc_mark_PMC_alive_fun((interp), (tmp)); } while (0);

    do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (tmp) = ((Parrot_CallContext_attributes *)(_self)->data)->current_namespace; } else { (tmp) = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "current_namespace")); } } while (0);
    do if (!((tmp) == PMCNULL || (tmp) == ((void *)0)) && (!(((tmp)->flags) & PObj_is_shared_FLAG) || !(((interp))->flags & (PARROT_IS_THREAD)))) { Parrot_gc_mark_PMC_alive_fun((interp), (tmp)); } while (0);

    do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (tmp) = ((Parrot_CallContext_attributes *)(_self)->data)->current_sig; } else { (tmp) = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "current_sig")); } } while (0);
    do if (!((tmp) == PMCNULL || (tmp) == ((void *)0)) && (!(((tmp)->flags) & PObj_is_shared_FLAG) || !(((interp))->flags & (PARROT_IS_THREAD)))) { Parrot_gc_mark_PMC_alive_fun((interp), (tmp)); } while (0);



    do { if ((((_self)->flags) & PObj_is_object_FLAG)) { (_self)->vtable->set_attr_str(interp, _self, Parrot_str_new_constant(interp, "continuation"), PMCNULL); } else ((Parrot_CallContext_attributes *)(_self)->data)->continuation = (PMCNULL); } while (0);

    do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (n_regs_used) = ((Parrot_CallContext_attributes *)(_self)->data)->n_regs_used; } else { Parrot_ex_throw_from_c_args(interp, ((void *)0), EXCEPTION_INVALID_OPERATION, "Attributes of type 'UINTVAL' cannot be " "subclassed from a high-level PMC."); } } while (0);

    if (n_regs_used) {
        Regs_ps bp_ps;
        const UINTVAL regs_p = n_regs_used[3];
        const UINTVAL regs_s = n_regs_used[2];
        UINTVAL i;

        do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (bp_ps) = ((Parrot_CallContext_attributes *)(_self)->data)->bp_ps; } else { Parrot_ex_throw_from_c_args(interp, ((void *)0), EXCEPTION_INVALID_OPERATION, "Attributes of type 'Regs_ps' cannot be " "subclassed from a high-level PMC."); } } while (0);
        ...
        for (i = 0; i < regs_p; ++i) {
            ...
            if (p)
                do if (!((p) == PMCNULL || (p) == ((void *)0)) && (!(((p)->flags) & PObj_is_shared_FLAG) || !(((interp))->flags & (PARROT_IS_THREAD)))) { Parrot_gc_mark_PMC_alive_fun((interp), (p)); } while (0);
        }

        for (i = 0; i < regs_s; ++i) {
            STRING * const s = bp_ps.regs_s[i];
            if (s)
                Parrot_gc_mark_STRING_alive_fun((interp), (s));
        }
    }
# 1265 "./src/pmc/callcontext.c"
}
static void
Parrot_CallContext_morph(Parrot_Interp interp, PMC *_self, PMC *type_unused __attribute__((__unused__)))
{
# 702 "./src/pmc/callcontext.pmc"
    Hash *hash;

    if (!(_self)->data)
        return;

    do { if ((((_self)->flags) & PObj_is_object_FLAG)) { PMC * const attr_value = Parrot_pmc_new(interp, enum_class_String); (attr_value)->vtable->set_string_native(interp, attr_value, ((void *)0)); (_self)->vtable->set_attr_str(interp, _self, Parrot_str_new_constant(interp, "short_sig"), attr_value); } else ((Parrot_CallContext_attributes *)(_self)->data)->short_sig = (((void *)0)); } while (0);
    do { if ((((_self)->flags) & PObj_is_object_FLAG)) { (_self)->vtable->set_attr_str(interp, _self, Parrot_str_new_constant(interp, "arg_flags"), PMCNULL); } else ((Parrot_CallContext_attributes *)(_self)->data)->arg_flags = (PMCNULL); } while (0);
    do { if ((((_self)->flags) & PObj_is_object_FLAG)) { (_self)->vtable->set_attr_str(interp, _self, Parrot_str_new_constant(interp, "return_flags"), PMCNULL); } else ((Parrot_CallContext_attributes *)(_self)->data)->return_flags = (PMCNULL); } while (0);
    do { if ((((_self)->flags) & PObj_is_object_FLAG)) { (_self)->vtable->set_attr_str(interp, _self, Parrot_str_new_constant(interp, "type_tuple"), PMCNULL); } else ((Parrot_CallContext_attributes *)(_self)->data)->type_tuple = (PMCNULL); } while (0);
    ...
    if (hash) {
        do { if ((hash)->key_type == Hash_key_type_int || (hash)->key_type == Hash_key_type_cstring || (hash)->key_type == Hash_key_type_ptr) do { if (((hash))->entries) { UINTVAL _loc; for (_loc = 0; _loc <= ((hash))->mask; ++_loc) { HashBucket *_bucket = ((hash))->index[_loc]; while (_bucket) { Parrot_gc_free_fixed_size_storage((interp), sizeof (Pcc_cell), ((Pcc_cell *)_bucket->value)); _bucket = _bucket->next; } } } } while (0); else do { HashBucket *_bucket = ((hash))->buckets; UINTVAL _found = 0; while (_found < ((hash))->entries){ if (_bucket->key){ Parrot_gc_free_fixed_size_storage((interp), sizeof (Pcc_cell), ((Pcc_cell *)_bucket->value)); _found++; } _bucket++; } } while (0); } while (0)
                                                          ;
        Parrot_hash_destroy(interp, hash);
        do { if ((((_self)->flags) & PObj_is_object_FLAG)) { Parrot_ex_throw_from_c_args(interp, ((void *)0), EXCEPTION_INVALID_OPERATION, "Attributes of type 'Hash   *' cannot be " "subclassed from a high-level PMC."); } else ((Parrot_CallContext_attributes *)(_self)->data)->hash = (((void *)0)); } while (0);
    }
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 1293 "./src/pmc/callcontext.c"
}
static void
Parrot_CallContext_push_float(Parrot_Interp interp, PMC *_self, FLOATVAL value)
{
# 1069 "./src/pmc/callcontext.pmc"
    ...
    cells[num_pos].type = 2;
    do { if ((((_self)->flags) & PObj_is_object_FLAG)) { PMC * const attr_value = Parrot_pmc_new_init_int(interp, enum_class_Integer, num_pos + 1); (_self)->vtable->set_attr_str(interp, _self, Parrot_str_new_constant(interp, "num_positionals"), attr_value); } else ((Parrot_CallContext_attributes *)(_self)->data)->num_positionals = (num_pos + 1); } while (0);
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 1311 "./src/pmc/callcontext.c"
}
static void
Parrot_CallContext_push_integer(Parrot_Interp interp, PMC *_self, INTVAL value)
{
# 1053 "./src/pmc/callcontext.pmc"
    ...
    cells[num_pos].type = 1;
    do { if ((((_self)->flags) & PObj_is_object_FLAG)) { PMC * const attr_value = Parrot_pmc_new_init_int(interp, enum_class_Integer, num_pos + 1); (_self)->vtable->set_attr_str(interp, _self, Parrot_str_new_constant(interp, "num_positionals"), attr_value); } else ((Parrot_CallContext_attributes *)(_self)->data)->num_positionals = (num_pos + 1); } while (0);
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 1332 "./src/pmc/callcontext.c"
}
static void
Parrot_CallContext_push_pmc(Parrot_Interp interp, PMC *_self, PMC *value)
{
# 1095 "./src/pmc/callcontext.pmc"
    ...
    cells[num_pos].type = 4;
    do { if ((((_self)->flags) & PObj_is_object_FLAG)) { PMC * const attr_value = Parrot_pmc_new_init_int(interp, enum_class_Integer, num_pos + 1); (_self)->vtable->set_attr_str(interp, _self, Parrot_str_new_constant(interp, "num_positionals"), attr_value); } else ((Parrot_CallContext_attributes *)(_self)->data)->num_positionals = (num_pos + 1); } while (0);
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 1356 "./src/pmc/callcontext.c"
}
static void
Parrot_CallContext_push_string(Parrot_Interp interp, PMC *_self, STRING *value)
{
# 1082 "./src/pmc/callcontext.pmc"
    ...
    cells[num_pos].type = 3;
    do { if ((((_self)->flags) & PObj_is_object_FLAG)) { PMC * const attr_value = Parrot_pmc_new_init_int(interp, enum_class_Integer, num_pos + 1); (_self)->vtable->set_attr_str(interp, _self, Parrot_str_new_constant(interp, "num_positionals"), attr_value); } else ((Parrot_CallContext_attributes *)(_self)->data)->num_positionals = (num_pos + 1); } while (0);
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 1374 "./src/pmc/callcontext.c"
}
static void
Parrot_CallContext_set_attr_str(Parrot_Interp interp, PMC *_self, STRING *key, PMC *value)
{
# 923 "./src/pmc/callcontext.pmc"


    if (((key)->encoding)->equal((interp), (key), ((interp)->const_cstring_table[374]))) {
        do { if ((((_self)->flags) & PObj_is_object_FLAG)) { (_self)->vtable->set_attr_str(interp, _self, Parrot_str_new_constant(interp, "arg_flags"), value); } else ((Parrot_CallContext_attributes *)(_self)->data)->arg_flags = (value); } while (0);
    }
    else if (((key)->encoding)->equal((interp), (key), ((interp)->const_cstring_table[375]))) {
        do { if ((((_self)->flags) & PObj_is_object_FLAG)) { (_self)->vtable->set_attr_str(interp, _self, Parrot_str_new_constant(interp, "return_flags"), value); } else ((Parrot_CallContext_attributes *)(_self)->data)->return_flags = (value); } while (0);
    }
    else
        Parrot_ex_throw_from_c_args(interp, ((void *)0),
            EXCEPTION_ATTRIB_NOT_FOUND, "No such attribute '%S'", key);
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 1392 "./src/pmc/callcontext.c"
}
static void
Parrot_CallContext_set_integer_keyed(Parrot_Interp interp, PMC *_self, PMC *key, INTVAL value)
{
# 1339 "./src/pmc/callcontext.pmc"
    ...
    if (!cell) {
        cell = (Pcc_cell *)Parrot_gc_allocate_fixed_size_storage((interp), sizeof (Pcc_cell));
    ...
    cell->type = 1;
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 1411 "./src/pmc/callcontext.c"
}
static void
Parrot_CallContext_set_integer_keyed_int(Parrot_Interp interp, PMC *_self, INTVAL key, INTVAL value)
{
# 1239 "./src/pmc/callcontext.pmc"
    ...
    do { if (!(((_self)->flags) & PObj_is_object_FLAG)) { (pos) = ((Parrot_CallContext_attributes *)(_self)->data)->num_positionals; } else { PMC * const attr_value = (_self)->vtable->get_attr_str(interp, _self, Parrot_str_new_constant(interp, "num_positionals")); (pos) = (((attr_value) == PMCNULL || (attr_value) == ((void *)0)) ? (INTVAL) 0: (attr_value)->vtable->get_integer(interp, attr_value)); } } while (0);
    if (pos <= key)
        do { if ((((_self)->flags) & PObj_is_object_FLAG)) { PMC * const attr_value = Parrot_pmc_new_init_int(interp, enum_class_Integer, key + 1); (_self)->vtable->set_attr_str(interp, _self, Parrot_str_new_constant(interp, "num_positionals"), attr_value); } else ((Parrot_CallContext_attributes *)(_self)->data)->num_positionals = (key + 1); } while (0);
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 1428 "./src/pmc/callcontext.c"
}
static void
Parrot_CallContext_set_integer_keyed_str(Parrot_Interp interp, PMC *_self, STRING *key, INTVAL value)
{
# 1287 "./src/pmc/callcontext.pmc"
    ...
    cell->type = 1;
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 1446 "./src/pmc/callcontext.c"
}
static void
Parrot_CallContext_set_number_keyed(Parrot_Interp interp, PMC *_self, PMC *key, FLOATVAL value)
{
# 1353 "./src/pmc/callcontext.pmc"
    ...
    cell->type = 2;
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 1465 "./src/pmc/callcontext.c"
}
static void
Parrot_CallContext_set_number_keyed_int(Parrot_Interp interp, PMC *_self, INTVAL key, FLOATVAL value)
{
# 1251 "./src/pmc/callcontext.pmc"
    ...
    if (pos <= key)
        do { if ((((_self)->flags) & PObj_is_object_FLAG)) { PMC * const attr_value = Parrot_pmc_new_init_int(interp, enum_class_Integer, key + 1); (_self)->vtable->set_attr_str(interp, _self, Parrot_str_new_constant(interp, "num_positionals"), attr_value); } else ((Parrot_CallContext_attributes *)(_self)->data)->num_positionals = (key + 1); } while (0);
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 1482 "./src/pmc/callcontext.c"
}
static void
Parrot_CallContext_set_number_keyed_str(Parrot_Interp interp, PMC *_self, STRING *key, FLOATVAL value)
{
# 1300 "./src/pmc/callcontext.pmc"
    ...
    cell->type = 2;
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 1500 "./src/pmc/callcontext.c"
}
static void
Parrot_CallContext_set_pmc(Parrot_Interp interp, PMC *_self, PMC *value)
{
# 834 "./src/pmc/callcontext.pmc"

    do { if ((((_self)->flags) & PObj_is_object_FLAG)) { (_self)->vtable->set_attr_str(interp, _self, Parrot_str_new_constant(interp, "type_tuple"), value); } else ((Parrot_CallContext_attributes *)(_self)->data)->type_tuple = (value); } while (0);
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 1509 "./src/pmc/callcontext.c"
}
static void
Parrot_CallContext_set_pmc_keyed(Parrot_Interp interp, PMC *_self, PMC *key, PMC *value)
{
# 1381 "./src/pmc/callcontext.pmc"
    ...
    cell->type = 4;
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 1528 "./src/pmc/callcontext.c"
}
static void
Parrot_CallContext_set_pmc_keyed_int(Parrot_Interp interp, PMC *_self, INTVAL key, PMC *value)
{
# 1275 "./src/pmc/callcontext.pmc"
    ...
    if (pos <= key)
        do { if ((((_self)->flags) & PObj_is_object_FLAG)) { PMC * const attr_value = Parrot_pmc_new_init_int(interp, enum_class_Integer, key + 1); (_self)->vtable->set_attr_str(interp, _self, Parrot_str_new_constant(interp, "num_positionals"), attr_value); } else ((Parrot_CallContext_attributes *)(_self)->data)->num_positionals = (key + 1); } while (0);
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 1545 "./src/pmc/callcontext.c"
}
static void
Parrot_CallContext_set_pmc_keyed_str(Parrot_Interp interp, PMC *_self, STRING *key, PMC *value)
{
# 1326 "./src/pmc/callcontext.pmc"
    ...
    cell->type = 4;
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 1563 "./src/pmc/callcontext.c"
}
static void
Parrot_CallContext_set_string_keyed(Parrot_Interp interp, PMC *_self, PMC *key, STRING *value)
{
# 1367 "./src/pmc/callcontext.pmc"
    ...
    cell->type = 3;
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 1582 "./src/pmc/callcontext.c"
}
static void
Parrot_CallContext_set_string_keyed_int(Parrot_Interp interp, PMC *_self, INTVAL key, STRING *value)
{
# 1263 "./src/pmc/callcontext.pmc"
    ...
    if (pos <= key)
        do { if ((((_self)->flags) & PObj_is_object_FLAG)) { PMC * const attr_value = Parrot_pmc_new_init_int(interp, enum_class_Integer, key + 1); (_self)->vtable->set_attr_str(interp, _self, Parrot_str_new_constant(interp, "num_positionals"), attr_value); } else ((Parrot_CallContext_attributes *)(_self)->data)->num_positionals = (key + 1); } while (0);
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 1599 "./src/pmc/callcontext.c"
}
static void
Parrot_CallContext_set_string_keyed_str(Parrot_Interp interp, PMC *_self, STRING *key, STRING *value)
{
# 1313 "./src/pmc/callcontext.pmc"
    ...
    cell->type = 3;
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 1617 "./src/pmc/callcontext.c"
}
static void
Parrot_CallContext_set_string_native(Parrot_Interp interp, PMC *_self, STRING *value)
{
# 767 "./src/pmc/callcontext.pmc"

    do { if ((((_self)->flags) & PObj_is_object_FLAG)) { PMC * const attr_value = Parrot_pmc_new(interp, enum_class_String); (attr_value)->vtable->set_string_native(interp, attr_value, value); (_self)->vtable->set_attr_str(interp, _self, Parrot_str_new_constant(interp, "short_sig"), attr_value); } else ((Parrot_CallContext_attributes *)(_self)->data)->short_sig = (value); } while (0);
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 1626 "./src/pmc/callcontext.c"
}
static PMC *
Parrot_CallContext_shift_pmc(Parrot_Interp interp, PMC *_self)
{
# 1135 "./src/pmc/callcontext.pmc"
    ...
    do { if ((((_self)->flags) & PObj_is_object_FLAG)) { PMC * const attr_value = Parrot_pmc_new_init_int(interp, enum_class_Integer, size - 1); (_self)->vtable->set_attr_str(interp, _self, Parrot_str_new_constant(interp, "num_positionals"), attr_value); } else ((Parrot_CallContext_attributes *)(_self)->data)->num_positionals = (size - 1); } while (0);
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
    return retval;
# 1654 "./src/pmc/callcontext.c"
}
static STRING *
Parrot_CallContext_shift_string(Parrot_Interp interp, PMC *_self)
{
# 1159 "./src/pmc/callcontext.pmc"
    ...
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
    return retval;
# 1681 "./src/pmc/callcontext.c"
}
static void
Parrot_CallContext_unshift_pmc(Parrot_Interp interp, PMC *_self, PMC *value)
{
# 1119 "./src/pmc/callcontext.pmc"
    ...
    do { if ((((_self)->flags) & PObj_is_object_FLAG)) { PMC * const attr_value = Parrot_pmc_new_init_int(interp, enum_class_Integer, size + 1); (_self)->vtable->set_attr_str(interp, _self, Parrot_str_new_constant(interp, "num_positionals"), attr_value); } else ((Parrot_CallContext_attributes *)(_self)->data)->num_positionals = (size + 1); } while (0);
    do { if (((((_self))->flags) & PObj_GC_need_write_barrier_FLAG)) Parrot_gc_write_barrier((interp), (_self)); } while (0);
# 1702 "./src/pmc/callcontext.c"
}
static void
Parrot_CallContext_nci_backtrace(Parrot_Interp interp, PMC *_self)
{
...
INTVAL has_resume;
        ...
        Parrot_pcc_fill_params_from_c_args(interp, _call_object, "PiPoIp",
            &_self, &resume, &has_resume);
    {
# 1642 "./src/pmc/callcontext.pmc"

    PMC *result = Parrot_pmc_new(interp, enum_class_ResizablePMCArray);
    PMC *cur_ctx = _self;
    Parrot_Continuation_attributes * const cont = has_resume ? ((Parrot_Continuation_attributes *) (resume)->data) : ((void *)0);


    while (cur_ctx) {
        PMC * const frame = Parrot_pmc_new(interp, enum_class_Hash);
        PMC *annotations = ((void *)0);
        ...
        (frame)->vtable->set_pmc_keyed_str(interp, frame, (interp)->const_cstring_table[181], sub_pmc);


        if (!((sub_pmc) == PMCNULL || (sub_pmc) == ((void *)0))) {
            do { const INTVAL type = (sub_pmc)->vtable->base_type; if (type == enum_class_Sub || type == enum_class_Coroutine) { (sub) = ((Parrot_Sub_attributes *) ((sub_pmc))->data); } else { (sub) = (Parrot_Sub_attributes*)Parrot_get_sub_pmc_from_subclass((interp), (sub_pmc)); } } while (0);

            if (sub->seg->annotations) {
                PackFile_ByteCode * const seg = sub->seg;
                opcode_t * const pc = cont && cur_ctx == cont->to_ctx
                                         ? cont->address
                                         : (((Parrot_Context *)((cur_ctx))->data)->current_pc);
        ...
        (frame)->vtable->set_pmc_keyed_str(interp, frame, (interp)->const_cstring_table[170], annotations);


        (result)->vtable->push_pmc(interp, result, frame);
        cur_ctx = (((Parrot_Context *)((cur_ctx))->data)->caller_ctx);
    }
# 1763 "./src/pmc/callcontext.c"
    {
...
# 1687 "./src/pmc/callcontext.pmc"
# 1774 "./src/pmc/callcontext.c"
...
__attribute__ ((visibility("default")))
VTABLE *Parrot_CallContext_ro_update_vtable(VTABLE *vt) {
    vt->clone = Parrot_CallContext_clone;
    vt->destroy = Parrot_CallContext_destroy;
    vt->elements = Parrot_CallContext_elements;
    vt->exists_keyed = Parrot_CallContext_exists_keyed;
...
__attribute__((__warn_unused_result__))
VTABLE* Parrot_CallContext_get_vtable(Parrot_Interp interp) {
    VTABLE *vt;
...
__attribute__((__warn_unused_result__))
VTABLE* Parrot_CallContext_ro_get_vtable(Parrot_Interp interp) {
    VTABLE *vt;
...
__attribute__((__warn_unused_result__))
PMC* Parrot_CallContext_get_mro(Parrot_Interp interp, PMC* mro) {
    if (((mro) == PMCNULL || (mro) == ((void *)0))) {
        mro = Parrot_pmc_new(interp, enum_class_ResizableStringArray);
    }

    (mro)->vtable->unshift_string(interp, mro, (interp)->const_cstring_table[386]);
    return mro;
}
...
__attribute__((__warn_unused_result__))
Hash* Parrot_CallContext_get_isa(Parrot_Interp interp, Hash* isa) {
    if (isa == ((void *)0)) {
        isa = Parrot_hash_new(interp);
    }
    Parrot_hash_put(interp, isa, (void *)((interp)->const_cstring_table[386]), PMCNULL);
    return isa;
}

void
Parrot_CallContext_class_init(Parrot_Interp interp, int entry, int pass)
{
    ...
    if (pass == 0) {
        ...
        vt->whoami = (interp)->const_cstring_table[386];
        vt->provides_str = (interp)->const_cstring_table[365];
        vt->isa_hash = Parrot_CallContext_get_isa(interp, ((void *)0));
        {
