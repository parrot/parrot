...
static op_func_t core_op_func_table[1096] = {
  ...
  Parrot_sqrt_n_n,                                   /*    516 */
  Parrot_is_inf_or_nan_i_n,                          /*    517 */
  Parrot_is_inf_or_nan_i_nc,                         /*    518 */
  ...
  Parrot_new_p_s,                                    /*    594 */
  Parrot_new_p_sc,                                   /*    595 */
  Parrot_new_p_s_p,                                  /*    596 */
  Parrot_new_p_sc_p,                                 /*    597 */
  Parrot_new_p_s_pc,                                 /*    598 */
  Parrot_new_p_sc_pc,                                /*    599 */
  Parrot_new_p_p,                                    /*    600 */
  Parrot_new_p_pc,                                   /*    601 */
  Parrot_new_p_p_p,                                  /*    602 */
  Parrot_new_p_pc_p,                                 /*    603 */
  Parrot_new_p_p_pc,                                 /*    604 */
  Parrot_new_p_pc_pc,                                /*    605 */
  Parrot_root_new_p_p,                               /*    606 */
  Parrot_root_new_p_pc,                              /*    607 */
  Parrot_root_new_p_p_p,                             /*    608 */
  Parrot_root_new_p_pc_p,                            /*    609 */
  Parrot_root_new_p_p_pc,                            /*    610 */
  Parrot_root_new_p_pc_pc,                           /*    611 */
  Parrot_typeof_s_p,                                 /*    612 */
  Parrot_typeof_p_p,                                 /*    613 */
  Parrot_get_repr_s_p,                               /*    614 */
  Parrot_find_method_p_p_s,                          /*    615 */
  Parrot_find_method_p_p_sc,                         /*    616 */
  Parrot_defined_i_p,                                /*    617 */
  Parrot_defined_i_p_ki,                             /*    618 */
  Parrot_defined_i_p_kic,                            /*    619 */
  Parrot_defined_i_p_k,                              /*    620 */
  Parrot_defined_i_p_kc,                             /*    621 */
  Parrot_exists_i_p_ki,                              /*    622 */
  Parrot_exists_i_p_kic,                             /*    623 */
  Parrot_exists_i_p_k,                               /*    624 */
  Parrot_exists_i_p_kc,                              /*    625 */
  Parrot_delete_p_k,                                 /*    626 */
  Parrot_delete_p_kc,                                /*    627 */
  Parrot_delete_p_ki,                                /*    628 */
  Parrot_delete_p_kic,                               /*    629 */
  Parrot_elements_i_p,                               /*    630 */
  Parrot_push_p_i,                                   /*    631 */
  Parrot_push_p_ic,                                  /*    632 */
  Parrot_push_p_n,                                   /*    633 */
  Parrot_push_p_nc,                                  /*    634 */
  Parrot_push_p_s,                                   /*    635 */
  Parrot_push_p_sc,                                  /*    636 */
  Parrot_push_p_p,                                   /*    637 */
  Parrot_pop_i_p,                                    /*    638 */
  Parrot_pop_n_p,                                    /*    639 */
  Parrot_pop_s_p,                                    /*    640 */
  Parrot_pop_p_p,                                    /*    641 */
  Parrot_unshift_p_i,                                /*    642 */
  Parrot_unshift_p_ic,                               /*    643 */
  Parrot_unshift_p_n,                                /*    644 */
  Parrot_unshift_p_nc,                               /*    645 */
  Parrot_unshift_p_s,                                /*    646 */
  Parrot_unshift_p_sc,                               /*    647 */
  Parrot_unshift_p_p,                                /*    648 */
  Parrot_shift_i_p,                                  /*    649 */
  Parrot_shift_n_p,                                  /*    650 */
  Parrot_shift_s_p,                                  /*    651 */
  Parrot_shift_p_p,                                  /*    652 */
  Parrot_splice_p_p_i_i,                             /*    653 */
  Parrot_splice_p_p_ic_i,                            /*    654 */
  Parrot_splice_p_p_i_ic,                            /*    655 */
  Parrot_splice_p_p_ic_ic,                           /*    656 */
  Parrot_setprop_p_s_p,                              /*    657 */
  Parrot_setprop_p_sc_p,                             /*    658 */
  Parrot_getprop_p_s_p,                              /*    659 */
  Parrot_getprop_p_sc_p,                             /*    660 */
  Parrot_getprop_p_p_s,                              /*    661 */
  Parrot_getprop_p_p_sc,                             /*    662 */
  ...
  Parrot_substr_s_s_i,                               /*    817 */
  Parrot_substr_s_sc_i,                              /*    818 */
  Parrot_substr_s_s_ic,                              /*    819 */
  Parrot_substr_s_sc_ic,                             /*    820 */
  Parrot_substr_s_s_i_i,                             /*    821 */
  Parrot_substr_s_sc_i_i,                            /*    822 */
  Parrot_substr_s_s_ic_i,                            /*    823 */
  Parrot_substr_s_sc_ic_i,                           /*    824 */
  Parrot_substr_s_s_i_ic,                            /*    825 */
  Parrot_substr_s_sc_i_ic,                           /*    826 */
  Parrot_substr_s_s_ic_ic,                           /*    827 */
  Parrot_substr_s_sc_ic_ic,                          /*    828 */
  Parrot_substr_s_p_i_i,                             /*    829 */
  Parrot_substr_s_p_ic_i,                            /*    830 */
  Parrot_substr_s_p_i_ic,                            /*    831 */
  Parrot_substr_s_p_ic_ic,                           /*    832 */
  Parrot_replace_s_s_i_i_s,                          /*    833 */
  Parrot_replace_s_sc_i_i_s,                         /*    834 */
  Parrot_replace_s_s_ic_i_s,                         /*    835 */
  Parrot_replace_s_sc_ic_i_s,                        /*    836 */
  Parrot_replace_s_s_i_ic_s,                         /*    837 */
  Parrot_replace_s_sc_i_ic_s,                        /*    838 */
  Parrot_replace_s_s_ic_ic_s,                        /*    839 */
  Parrot_replace_s_sc_ic_ic_s,                       /*    840 */
  Parrot_replace_s_s_i_i_sc,                         /*    841 */
  Parrot_replace_s_sc_i_i_sc,                        /*    842 */
  Parrot_replace_s_s_ic_i_sc,                        /*    843 */
  Parrot_replace_s_sc_ic_i_sc,                       /*    844 */
  Parrot_replace_s_s_i_ic_sc,                        /*    845 */
  Parrot_replace_s_sc_i_ic_sc,                       /*    846 */
  Parrot_replace_s_s_ic_ic_sc,                       /*    847 */
  Parrot_replace_s_sc_ic_ic_sc,                      /*    848 */
  Parrot_index_i_s_s,                                /*    849 */
  Parrot_index_i_sc_s,                               /*    850 */
  Parrot_index_i_s_sc,                               /*    851 */
  Parrot_index_i_sc_sc,                              /*    852 */
  Parrot_index_i_s_s_i,                              /*    853 */
  Parrot_index_i_sc_s_i,                             /*    854 */
  Parrot_index_i_s_sc_i,                             /*    855 */
  Parrot_index_i_sc_sc_i,                            /*    856 */
  Parrot_index_i_s_s_ic,                             /*    857 */
  Parrot_index_i_sc_s_ic,                            /*    858 */
  Parrot_index_i_s_sc_ic,                            /*    859 */
  Parrot_index_i_sc_sc_ic,                           /*    860 */
  Parrot_rindex_i_s_s,                               /*    861 */
  Parrot_rindex_i_sc_s,                              /*    862 */
  Parrot_rindex_i_s_sc,                              /*    863 */
  Parrot_rindex_i_sc_sc,                             /*    864 */
  Parrot_rindex_i_s_s_i,                             /*    865 */
  Parrot_rindex_i_sc_s_i,                            /*    866 */
  Parrot_rindex_i_s_sc_i,                            /*    867 */
  Parrot_rindex_i_sc_sc_i,                           /*    868 */
  Parrot_rindex_i_s_s_ic,                            /*    869 */
  Parrot_rindex_i_sc_s_ic,                           /*    870 */
  Parrot_rindex_i_s_sc_ic,                           /*    871 */
  Parrot_rindex_i_sc_sc_ic,                          /*    872 */
  Parrot_sprintf_s_s_p,                              /*    873 */
  Parrot_sprintf_s_sc_p,                             /*    874 */
  Parrot_sprintf_p_p_p,                              /*    875 */
  Parrot_new_s,                                      /*    876 */
  Parrot_stringinfo_i_s_i,                           /*    877 */
  Parrot_stringinfo_i_sc_i,                          /*    878 */
  Parrot_stringinfo_i_s_ic,                          /*    879 */
  Parrot_stringinfo_i_sc_ic,                         /*    880 */
  Parrot_upcase_s_s,                                 /*    881 */
  Parrot_upcase_s_sc,                                /*    882 */
  Parrot_downcase_s_s,                               /*    883 */
  Parrot_downcase_s_sc,                              /*    884 */
  Parrot_titlecase_s_s,                              /*    885 */
  Parrot_titlecase_s_sc,                             /*    886 */
  Parrot_join_s_s_p,                                 /*    887 */
  Parrot_join_s_sc_p,                                /*    888 */
  Parrot_split_p_s_s,                                /*    889 */
  Parrot_split_p_sc_s,                               /*    890 */
  Parrot_split_p_s_sc,                               /*    891 */
  Parrot_split_p_sc_sc,                              /*    892 */
  Parrot_encoding_i_s,                               /*    893 */
  Parrot_encoding_i_sc,                              /*    894 */
  Parrot_encodingname_s_i,                           /*    895 */
  Parrot_encodingname_s_ic,                          /*    896 */
  Parrot_find_encoding_i_s,                          /*    897 */
  Parrot_find_encoding_i_sc,                         /*    898 */
  Parrot_trans_encoding_s_s_i,                       /*    899 */
  Parrot_trans_encoding_s_sc_i,                      /*    900 */
  Parrot_trans_encoding_s_s_ic,                      /*    901 */
  Parrot_trans_encoding_s_sc_ic,                     /*    902 */
  Parrot_is_cclass_i_i_s_i,                          /*    903 */
  Parrot_is_cclass_i_ic_s_i,                         /*    904 */
  Parrot_is_cclass_i_i_sc_i,                         /*    905 */
  Parrot_is_cclass_i_ic_sc_i,                        /*    906 */
  Parrot_is_cclass_i_i_s_ic,                         /*    907 */
  Parrot_is_cclass_i_ic_s_ic,                        /*    908 */
  Parrot_is_cclass_i_i_sc_ic,                        /*    909 */
  Parrot_is_cclass_i_ic_sc_ic,                       /*    910 */
  Parrot_find_cclass_i_i_s_i_i,                      /*    911 */
  Parrot_find_cclass_i_ic_s_i_i,                     /*    912 */
  Parrot_find_cclass_i_i_sc_i_i,                     /*    913 */
  Parrot_find_cclass_i_ic_sc_i_i,                    /*    914 */
  Parrot_find_cclass_i_i_s_ic_i,                     /*    915 */
  Parrot_find_cclass_i_ic_s_ic_i,                    /*    916 */
  Parrot_find_cclass_i_i_sc_ic_i,                    /*    917 */
  Parrot_find_cclass_i_ic_sc_ic_i,                   /*    918 */
  Parrot_find_cclass_i_i_s_i_ic,                     /*    919 */
  Parrot_find_cclass_i_ic_s_i_ic,                    /*    920 */
  Parrot_find_cclass_i_i_sc_i_ic,                    /*    921 */
  Parrot_find_cclass_i_ic_sc_i_ic,                   /*    922 */
  Parrot_find_cclass_i_i_s_ic_ic,                    /*    923 */
  Parrot_find_cclass_i_ic_s_ic_ic,                   /*    924 */
  Parrot_find_cclass_i_i_sc_ic_ic,                   /*    925 */
  Parrot_find_cclass_i_ic_sc_ic_ic,                  /*    926 */
  Parrot_find_not_cclass_i_i_s_i_i,                  /*    927 */
  Parrot_find_not_cclass_i_ic_s_i_i,                 /*    928 */
  Parrot_find_not_cclass_i_i_sc_i_i,                 /*    929 */
  Parrot_find_not_cclass_i_ic_sc_i_i,                /*    930 */
  Parrot_find_not_cclass_i_i_s_ic_i,                 /*    931 */
  Parrot_find_not_cclass_i_ic_s_ic_i,                /*    932 */
  Parrot_find_not_cclass_i_i_sc_ic_i,                /*    933 */
  Parrot_find_not_cclass_i_ic_sc_ic_i,               /*    934 */
  Parrot_find_not_cclass_i_i_s_i_ic,                 /*    935 */
  Parrot_find_not_cclass_i_ic_s_i_ic,                /*    936 */
  Parrot_find_not_cclass_i_i_sc_i_ic,                /*    937 */
  Parrot_find_not_cclass_i_ic_sc_i_ic,               /*    938 */
  Parrot_find_not_cclass_i_i_s_ic_ic,                /*    939 */
  Parrot_find_not_cclass_i_ic_s_ic_ic,               /*    940 */
  Parrot_find_not_cclass_i_i_sc_ic_ic,               /*    941 */
  Parrot_find_not_cclass_i_ic_sc_ic_ic,              /*    942 */
  Parrot_escape_s_s,                                 /*    943 */
  Parrot_compose_s_s,                                /*    944 */
  Parrot_compose_s_sc,                               /*    945 */
  Parrot_find_codepoint_i_s,                         /*    946 */
  Parrot_find_codepoint_i_sc,                        /*    947 */
  Parrot_spawnw_i_s,                                 /*    948 */
  Parrot_spawnw_i_sc,                                /*    949 */
  Parrot_spawnw_i_p,                                 /*    950 */
  Parrot_err_i,                                      /*    951 */
  Parrot_err_s,                                      /*    952 */
  Parrot_err_s_i,                                    /*    953 */
  Parrot_err_s_ic,                                   /*    954 */
  ...
  Parrot_sleep_n,                                    /*    959 */
  Parrot_sleep_nc,                                   /*    960 */
  Parrot_store_lex_s_p,                              /*    961 */
  Parrot_store_lex_sc_p,                             /*    962 */
  Parrot_store_lex_s_s,                              /*    963 */
  Parrot_store_lex_sc_s,                             /*    964 */
  Parrot_store_lex_s_sc,                             /*    965 */
  Parrot_store_lex_sc_sc,                            /*    966 */
  Parrot_store_lex_s_i,                              /*    967 */
  Parrot_store_lex_sc_i,                             /*    968 */
  Parrot_store_lex_s_ic,                             /*    969 */
  Parrot_store_lex_sc_ic,                            /*    970 */
  Parrot_store_lex_s_n,                              /*    971 */
  Parrot_store_lex_sc_n,                             /*    972 */
  Parrot_store_lex_s_nc,                             /*    973 */
  Parrot_store_lex_sc_nc,                            /*    974 */
  Parrot_store_dynamic_lex_s_p,                      /*    975 */
  Parrot_store_dynamic_lex_sc_p,                     /*    976 */
  Parrot_find_lex_p_s,                               /*    977 */
  Parrot_find_lex_p_sc,                              /*    978 */
  Parrot_find_lex_s_s,                               /*    979 */
  Parrot_find_lex_s_sc,                              /*    980 */
  Parrot_find_lex_i_s,                               /*    981 */
  Parrot_find_lex_i_sc,                              /*    982 */
  Parrot_find_lex_n_s,                               /*    983 */
  Parrot_find_lex_n_sc,                              /*    984 */
  Parrot_find_dynamic_lex_p_s,                       /*    985 */
  Parrot_find_dynamic_lex_p_sc,                      /*    986 */
  Parrot_find_caller_lex_p_s,                        /*    987 */
  Parrot_find_caller_lex_p_sc,                       /*    988 */
  Parrot_get_namespace_p,                            /*    989 */
  Parrot_get_namespace_p_p,                          /*    990 */
  Parrot_get_namespace_p_pc,                         /*    991 */
  Parrot_get_hll_namespace_p,                        /*    992 */
  Parrot_get_hll_namespace_p_p,                      /*    993 */
  Parrot_get_hll_namespace_p_pc,                     /*    994 */
  Parrot_get_root_namespace_p,                       /*    995 */
  Parrot_get_root_namespace_p_p,                     /*    996 */
  Parrot_get_root_namespace_p_pc,                    /*    997 */
  Parrot_get_global_p_s,                             /*    998 */
  Parrot_get_global_p_sc,                            /*    999 */
  Parrot_get_global_p_p_s,                           /*   1000 */
  Parrot_get_global_p_pc_s,                          /*   1001 */
  Parrot_get_global_p_p_sc,                          /*   1002 */
  Parrot_get_global_p_pc_sc,                         /*   1003 */
  Parrot_get_hll_global_p_s,                         /*   1004 */
  Parrot_get_hll_global_p_sc,                        /*   1005 */
  Parrot_get_hll_global_p_p_s,                       /*   1006 */
  Parrot_get_hll_global_p_pc_s,                      /*   1007 */
  Parrot_get_hll_global_p_p_sc,                      /*   1008 */
  Parrot_get_hll_global_p_pc_sc,                     /*   1009 */
  Parrot_get_root_global_p_s,                        /*   1010 */
  Parrot_get_root_global_p_sc,                       /*   1011 */
  Parrot_get_root_global_p_p_s,                      /*   1012 */
  Parrot_get_root_global_p_pc_s,                     /*   1013 */
  Parrot_get_root_global_p_p_sc,                     /*   1014 */
  Parrot_get_root_global_p_pc_sc,                    /*   1015 */
  Parrot_set_global_s_p,                             /*   1016 */
  Parrot_set_global_sc_p,                            /*   1017 */
  Parrot_set_global_p_s_p,                           /*   1018 */
  Parrot_set_global_pc_s_p,                          /*   1019 */
  Parrot_set_global_p_sc_p,                          /*   1020 */
  Parrot_set_global_pc_sc_p,                         /*   1021 */
  Parrot_set_hll_global_s_p,                         /*   1022 */
  Parrot_set_hll_global_sc_p,                        /*   1023 */
  Parrot_set_hll_global_p_s_p,                       /*   1024 */
  Parrot_set_hll_global_pc_s_p,                      /*   1025 */
  Parrot_set_hll_global_p_sc_p,                      /*   1026 */
  Parrot_set_hll_global_pc_sc_p,                     /*   1027 */
  Parrot_set_root_global_s_p,                        /*   1028 */
  Parrot_set_root_global_sc_p,                       /*   1029 */
  Parrot_set_root_global_p_s_p,                      /*   1030 */
  Parrot_set_root_global_pc_s_p,                     /*   1031 */
  Parrot_set_root_global_p_sc_p,                     /*   1032 */
  Parrot_set_root_global_pc_sc_p,                    /*   1033 */
  Parrot_find_name_p_s,                              /*   1034 */
  Parrot_find_name_p_sc,                             /*   1035 */
  Parrot_find_sub_not_null_p_s,                      /*   1036 */
  Parrot_find_sub_not_null_p_sc,                     /*   1037 */
  Parrot_trap,                                       /*   1038 */
  Parrot_set_label_p_ic,                             /*   1039 */
  Parrot_get_label_i_p,                              /*   1040 */
  Parrot_get_id_i_p,                                 /*   1041 */
  Parrot_get_id_i_pc,                                /*   1042 */
  Parrot_fetch_p_p_p_p,                              /*   1043 */
  Parrot_fetch_p_pc_p_p,                             /*   1044 */
  Parrot_fetch_p_p_pc_p,                             /*   1045 */
  Parrot_fetch_p_pc_pc_p,                            /*   1046 */
  Parrot_fetch_p_p_p_pc,                             /*   1047 */
  Parrot_fetch_p_pc_p_pc,                            /*   1048 */
  Parrot_fetch_p_p_pc_pc,                            /*   1049 */
  Parrot_fetch_p_pc_pc_pc,                           /*   1050 */
  Parrot_fetch_p_p_i_p,                              /*   1051 */
  Parrot_fetch_p_pc_i_p,                             /*   1052 */
  Parrot_fetch_p_p_ic_p,                             /*   1053 */
  Parrot_fetch_p_pc_ic_p,                            /*   1054 */
  Parrot_fetch_p_p_i_pc,                             /*   1055 */
  Parrot_fetch_p_pc_i_pc,                            /*   1056 */
  Parrot_fetch_p_p_ic_pc,                            /*   1057 */
  Parrot_fetch_p_pc_ic_pc,                           /*   1058 */
  Parrot_fetch_p_p_s_p,                              /*   1059 */
  Parrot_fetch_p_pc_s_p,                             /*   1060 */
  Parrot_fetch_p_p_sc_p,                             /*   1061 */
  Parrot_fetch_p_pc_sc_p,                            /*   1062 */
  Parrot_fetch_p_p_s_pc,                             /*   1063 */
  Parrot_fetch_p_pc_s_pc,                            /*   1064 */
  Parrot_fetch_p_p_sc_pc,                            /*   1065 */
  Parrot_fetch_p_pc_sc_pc,                           /*   1066 */
  ...
  Parrot_get_context_p,                              /*   1079 */
  Parrot_new_call_context_p,                         /*   1080 */
  Parrot_invokecc_p_p,                               /*   1081 */
  Parrot_flatten_array_into_p_p_i,                   /*   1082 */
  Parrot_flatten_array_into_p_p_ic,                  /*   1083 */
  Parrot_flatten_hash_into_p_p_i,                    /*   1084 */
  Parrot_flatten_hash_into_p_p_ic,                   /*   1085 */
  Parrot_slurp_array_from_p_p_i,                     /*   1086 */
  Parrot_slurp_array_from_p_p_ic,                    /*   1087 */
  Parrot_receive_p,                                  /*   1088 */
  Parrot_wait_p,                                     /*   1089 */
  Parrot_wait_pc,                                    /*   1090 */
  Parrot_pass,                                       /*   1091 */
  Parrot_disable_preemption,                         /*   1092 */
  Parrot_enable_preemption,                          /*   1093 */
  Parrot_terminate,                                  /*   1094 */
