...
INTVAL core_numops = 1334;

/*
** Op Function Table:
*/

static op_func_t core_op_func_table[1334] = {
  Parrot_end,                                        /*      0 */
  Parrot_noop,                                       /*      1 */
  ...
  Parrot_get_knowhow_p,                              /*    602 */
  Parrot_get_knowhow_attribute_p,                    /*    603 */
  Parrot_get_how_p_p,                                /*    604 */
  Parrot_get_how_p_pc,                               /*    605 */
  Parrot_get_what_p_p,                               /*    606 */
  Parrot_get_what_p_pc,                              /*    607 */
  Parrot_what_or_null_p_p,                           /*    608 */
  Parrot_what_or_null_p_pc,                          /*    609 */
  Parrot_get_who_p_p,                                /*    610 */
  Parrot_get_who_p_pc,                               /*    611 */
  Parrot_set_who_p_p,                                /*    612 */
  Parrot_set_who_pc_p,                               /*    613 */
  Parrot_set_who_p_pc,                               /*    614 */
  Parrot_set_who_pc_pc,                              /*    615 */
  Parrot_repr_type_object_for_p_p_s,                 /*    616 */
  Parrot_repr_type_object_for_p_pc_s,                /*    617 */
  Parrot_repr_type_object_for_p_p_sc,                /*    618 */
  Parrot_repr_type_object_for_p_pc_sc,               /*    619 */
  Parrot_repr_instance_of_p_p,                       /*    620 */
  Parrot_repr_instance_of_p_pc,                      /*    621 */
  Parrot_repr_clone_p_p,                             /*    622 */
  Parrot_repr_clone_p_pc,                            /*    623 */
  Parrot_repr_defined_i_p,                           /*    624 */
  Parrot_repr_defined_i_pc,                          /*    625 */
  Parrot_repr_get_attr_int_i_p_p_s,                  /*    626 */
  Parrot_repr_get_attr_int_i_pc_p_s,                 /*    627 */
  Parrot_repr_get_attr_int_i_p_pc_s,                 /*    628 */
  Parrot_repr_get_attr_int_i_pc_pc_s,                /*    629 */
  Parrot_repr_get_attr_int_i_p_p_sc,                 /*    630 */
  Parrot_repr_get_attr_int_i_pc_p_sc,                /*    631 */
  Parrot_repr_get_attr_int_i_p_pc_sc,                /*    632 */
  Parrot_repr_get_attr_int_i_pc_pc_sc,               /*    633 */
  Parrot_repr_get_attr_num_n_p_p_s,                  /*    634 */
  Parrot_repr_get_attr_num_n_pc_p_s,                 /*    635 */
  Parrot_repr_get_attr_num_n_p_pc_s,                 /*    636 */
  Parrot_repr_get_attr_num_n_pc_pc_s,                /*    637 */
  Parrot_repr_get_attr_num_n_p_p_sc,                 /*    638 */
  Parrot_repr_get_attr_num_n_pc_p_sc,                /*    639 */
  Parrot_repr_get_attr_num_n_p_pc_sc,                /*    640 */
  Parrot_repr_get_attr_num_n_pc_pc_sc,               /*    641 */
  Parrot_repr_get_attr_str_s_p_p_s,                  /*    642 */
  Parrot_repr_get_attr_str_s_pc_p_s,                 /*    643 */
  Parrot_repr_get_attr_str_s_p_pc_s,                 /*    644 */
  Parrot_repr_get_attr_str_s_pc_pc_s,                /*    645 */
  Parrot_repr_get_attr_str_s_p_p_sc,                 /*    646 */
  Parrot_repr_get_attr_str_s_pc_p_sc,                /*    647 */
  Parrot_repr_get_attr_str_s_p_pc_sc,                /*    648 */
  Parrot_repr_get_attr_str_s_pc_pc_sc,               /*    649 */
  Parrot_repr_bind_attr_int_p_p_s_i,                 /*    650 */
  Parrot_repr_bind_attr_int_pc_p_s_i,                /*    651 */
  Parrot_repr_bind_attr_int_p_pc_s_i,                /*    652 */
  Parrot_repr_bind_attr_int_pc_pc_s_i,               /*    653 */
  Parrot_repr_bind_attr_int_p_p_sc_i,                /*    654 */
  Parrot_repr_bind_attr_int_pc_p_sc_i,               /*    655 */
  Parrot_repr_bind_attr_int_p_pc_sc_i,               /*    656 */
  Parrot_repr_bind_attr_int_pc_pc_sc_i,              /*    657 */
  Parrot_repr_bind_attr_int_p_p_s_ic,                /*    658 */
  Parrot_repr_bind_attr_int_pc_p_s_ic,               /*    659 */
  Parrot_repr_bind_attr_int_p_pc_s_ic,               /*    660 */
  Parrot_repr_bind_attr_int_pc_pc_s_ic,              /*    661 */
  Parrot_repr_bind_attr_int_p_p_sc_ic,               /*    662 */
  Parrot_repr_bind_attr_int_pc_p_sc_ic,              /*    663 */
  Parrot_repr_bind_attr_int_p_pc_sc_ic,              /*    664 */
  Parrot_repr_bind_attr_int_pc_pc_sc_ic,             /*    665 */
  Parrot_repr_bind_attr_num_p_p_s_n,                 /*    666 */
  Parrot_repr_bind_attr_num_pc_p_s_n,                /*    667 */
  Parrot_repr_bind_attr_num_p_pc_s_n,                /*    668 */
  Parrot_repr_bind_attr_num_pc_pc_s_n,               /*    669 */
  Parrot_repr_bind_attr_num_p_p_sc_n,                /*    670 */
  Parrot_repr_bind_attr_num_pc_p_sc_n,               /*    671 */
  Parrot_repr_bind_attr_num_p_pc_sc_n,               /*    672 */
  Parrot_repr_bind_attr_num_pc_pc_sc_n,              /*    673 */
  Parrot_repr_bind_attr_num_p_p_s_nc,                /*    674 */
  Parrot_repr_bind_attr_num_pc_p_s_nc,               /*    675 */
  Parrot_repr_bind_attr_num_p_pc_s_nc,               /*    676 */
  Parrot_repr_bind_attr_num_pc_pc_s_nc,              /*    677 */
  Parrot_repr_bind_attr_num_p_p_sc_nc,               /*    678 */
  Parrot_repr_bind_attr_num_pc_p_sc_nc,              /*    679 */
  Parrot_repr_bind_attr_num_p_pc_sc_nc,              /*    680 */
  Parrot_repr_bind_attr_num_pc_pc_sc_nc,             /*    681 */
  Parrot_repr_bind_attr_str_p_p_s_s,                 /*    682 */
  Parrot_repr_bind_attr_str_pc_p_s_s,                /*    683 */
  Parrot_repr_bind_attr_str_p_pc_s_s,                /*    684 */
  Parrot_repr_bind_attr_str_pc_pc_s_s,               /*    685 */
  Parrot_repr_bind_attr_str_p_p_sc_s,                /*    686 */
  Parrot_repr_bind_attr_str_pc_p_sc_s,               /*    687 */
  Parrot_repr_bind_attr_str_p_pc_sc_s,               /*    688 */
  Parrot_repr_bind_attr_str_pc_pc_sc_s,              /*    689 */
  Parrot_repr_bind_attr_str_p_p_s_sc,                /*    690 */
  Parrot_repr_bind_attr_str_pc_p_s_sc,               /*    691 */
  Parrot_repr_bind_attr_str_p_pc_s_sc,               /*    692 */
  Parrot_repr_bind_attr_str_pc_pc_s_sc,              /*    693 */
  Parrot_repr_bind_attr_str_p_p_sc_sc,               /*    694 */
  Parrot_repr_bind_attr_str_pc_p_sc_sc,              /*    695 */
  Parrot_repr_bind_attr_str_p_pc_sc_sc,              /*    696 */
  Parrot_repr_bind_attr_str_pc_pc_sc_sc,             /*    697 */
  Parrot_repr_is_attr_initialized_i_p_p_s,           /*    698 */
  Parrot_repr_is_attr_initialized_i_pc_p_s,          /*    699 */
  Parrot_repr_is_attr_initialized_i_p_pc_s,          /*    700 */
  Parrot_repr_is_attr_initialized_i_pc_pc_s,         /*    701 */
  Parrot_repr_is_attr_initialized_i_p_p_sc,          /*    702 */
  Parrot_repr_is_attr_initialized_i_pc_p_sc,         /*    703 */
  Parrot_repr_is_attr_initialized_i_p_pc_sc,         /*    704 */
  Parrot_repr_is_attr_initialized_i_pc_pc_sc,        /*    705 */
  Parrot_repr_change_type_p_p,                       /*    706 */
  Parrot_repr_change_type_pc_p,                      /*    707 */
  Parrot_repr_change_type_p_pc,                      /*    708 */
  Parrot_repr_change_type_pc_pc,                     /*    709 */
  Parrot_type_check_i_p_p,                           /*    710 */
  Parrot_type_check_i_pc_p,                          /*    711 */
  Parrot_type_check_i_p_pc,                          /*    712 */
  Parrot_type_check_i_pc_pc,                         /*    713 */
  Parrot_publish_type_check_cache_p_p,               /*    714 */
  Parrot_publish_type_check_cache_pc_p,              /*    715 */
  Parrot_publish_type_check_cache_p_pc,              /*    716 */
  Parrot_publish_type_check_cache_pc_pc,             /*    717 */
  Parrot_publish_method_cache_p_p,                   /*    718 */
  Parrot_publish_method_cache_pc_p,                  /*    719 */
  Parrot_publish_method_cache_p_pc,                  /*    720 */
  Parrot_publish_method_cache_pc_pc,                 /*    721 */
  Parrot_repr_unbox_str_s_p,                         /*    722 */
  Parrot_repr_unbox_str_s_pc,                        /*    723 */
  Parrot_repr_unbox_int_i_p,                         /*    724 */
  Parrot_repr_unbox_int_i_pc,                        /*    725 */
  Parrot_repr_unbox_num_n_p,                         /*    726 */
  Parrot_repr_unbox_num_n_pc,                        /*    727 */
  Parrot_repr_box_str_p_s_p,                         /*    728 */
  Parrot_repr_box_str_p_sc_p,                        /*    729 */
  Parrot_repr_box_str_p_s_pc,                        /*    730 */
  Parrot_repr_box_str_p_sc_pc,                       /*    731 */
  Parrot_repr_box_int_p_i_p,                         /*    732 */
  Parrot_repr_box_int_p_ic_p,                        /*    733 */
  Parrot_repr_box_int_p_i_pc,                        /*    734 */
  Parrot_repr_box_int_p_ic_pc,                       /*    735 */
  Parrot_repr_box_num_p_n_p,                         /*    736 */
  Parrot_repr_box_num_p_nc_p,                        /*    737 */
  Parrot_repr_box_num_p_n_pc,                        /*    738 */
  Parrot_repr_box_num_p_nc_pc,                       /*    739 */
  Parrot_stable_set_type_check_mode_p_i,             /*    740 */
  Parrot_stable_set_type_check_mode_pc_i,            /*    741 */
  Parrot_stable_set_type_check_mode_p_ic,            /*    742 */
  Parrot_stable_set_type_check_mode_pc_ic,           /*    743 */
  Parrot_stable_publish_vtable_mapping_p_p,          /*    744 */
  Parrot_stable_publish_vtable_mapping_pc_p,         /*    745 */
  Parrot_stable_publish_vtable_mapping_p_pc,         /*    746 */
  Parrot_stable_publish_vtable_mapping_pc_pc,        /*    747 */
  Parrot_stable_publish_vtable_handler_mapping_p_p,  /*    748 */
  Parrot_stable_publish_vtable_handler_mapping_pc_p, /*    749 */
  Parrot_stable_publish_vtable_handler_mapping_p_pc, /*    750 */
  Parrot_stable_publish_vtable_handler_mapping_pc_pc, /*    751 */
  Parrot_get_sc_object_p_s_i,                        /*    752 */
  Parrot_get_sc_object_p_sc_i,                       /*    753 */
  Parrot_get_sc_object_p_s_ic,                       /*    754 */
  Parrot_get_sc_object_p_sc_ic,                      /*    755 */
  Parrot_get_sc_p_s,                                 /*    756 */
  Parrot_get_sc_p_sc,                                /*    757 */
  Parrot_create_sc_p_s,                              /*    758 */
  Parrot_create_sc_p_sc,                             /*    759 */
  Parrot_set_sc_object_s_i_p,                        /*    760 */
  Parrot_set_sc_object_sc_i_p,                       /*    761 */
  Parrot_set_sc_object_s_ic_p,                       /*    762 */
  Parrot_set_sc_object_sc_ic_p,                      /*    763 */
  Parrot_set_sc_object_s_i_pc,                       /*    764 */
  Parrot_set_sc_object_sc_i_pc,                      /*    765 */
  Parrot_set_sc_object_s_ic_pc,                      /*    766 */
  Parrot_set_sc_object_sc_ic_pc,                     /*    767 */
  Parrot_set_sc_for_object_p_p,                      /*    768 */
  Parrot_set_sc_for_object_pc_p,                     /*    769 */
  Parrot_set_sc_for_object_p_pc,                     /*    770 */
  Parrot_set_sc_for_object_pc_pc,                    /*    771 */
  Parrot_get_sc_for_object_p_p,                      /*    772 */
  Parrot_get_sc_for_object_p_pc,                     /*    773 */
  Parrot_get_package_through_who_p_p_s,              /*    774 */
  Parrot_get_package_through_who_p_pc_s,             /*    775 */
  Parrot_get_package_through_who_p_p_sc,             /*    776 */
  Parrot_get_package_through_who_p_pc_sc,            /*    777 */
  Parrot_is_invokable_i_p,                           /*    778 */
  Parrot_is_invokable_i_pc,                          /*    779 */
  Parrot_repr_get_primitive_type_spec_i_p,           /*    780 */
  ...
  Parrot_set_container_spec_pc_pc_s_p,               /*    789 */
  Parrot_set_container_spec_p_p_sc_p,                /*    790 */
  Parrot_set_container_spec_pc_p_sc_p,               /*    791 */
  Parrot_set_container_spec_p_pc_sc_p,               /*    792 */
  Parrot_set_container_spec_pc_pc_sc_p,              /*    793 */
  Parrot_set_container_spec_p_p_s_pc,                /*    794 */
  Parrot_set_container_spec_pc_p_s_pc,               /*    795 */
  Parrot_set_container_spec_p_pc_s_pc,               /*    796 */
  Parrot_set_container_spec_pc_pc_s_pc,              /*    797 */
  Parrot_set_container_spec_p_p_sc_pc,               /*    798 */
  Parrot_set_container_spec_pc_p_sc_pc,              /*    799 */
  Parrot_set_container_spec_p_pc_sc_pc,              /*    800 */
  Parrot_set_container_spec_pc_pc_sc_pc,             /*    801 */
  Parrot_set_invocation_spec_p_p_s_p,                /*    802 */
  Parrot_set_invocation_spec_p_p_sc_p,               /*    803 */
  Parrot_set_boolification_spec_p_i_p,               /*    804 */
  Parrot_set_boolification_spec_p_ic_p,              /*    805 */
  Parrot_new_p_s,                                    /*    806 */
  Parrot_new_p_sc,                                   /*    807 */
  Parrot_new_p_s_p,                                  /*    808 */
  Parrot_new_p_sc_p,                                 /*    809 */
  Parrot_new_p_s_pc,                                 /*    810 */
  Parrot_new_p_sc_pc,                                /*    811 */
  Parrot_new_p_p,                                    /*    812 */
  Parrot_new_p_pc,                                   /*    813 */
  Parrot_new_p_p_p,                                  /*    814 */
  Parrot_new_p_pc_p,                                 /*    815 */
  Parrot_new_p_p_pc,                                 /*    816 */
  Parrot_new_p_pc_pc,                                /*    817 */
  Parrot_root_new_p_p,                               /*    818 */
  Parrot_root_new_p_pc,                              /*    819 */
  Parrot_root_new_p_p_p,                             /*    820 */
  Parrot_root_new_p_pc_p,                            /*    821 */
  Parrot_root_new_p_p_pc,                            /*    822 */
  Parrot_root_new_p_pc_pc,                           /*    823 */
  Parrot_typeof_s_p,                                 /*    824 */
  Parrot_typeof_p_p,                                 /*    825 */
  Parrot_get_repr_s_p,                               /*    826 */
  Parrot_find_method_p_p_s,                          /*    827 */
  Parrot_find_method_p_p_sc,                         /*    828 */
  Parrot_defined_i_p,                                /*    829 */
  Parrot_defined_i_p_ki,                             /*    830 */
  Parrot_defined_i_p_kic,                            /*    831 */
  Parrot_defined_i_p_k,                              /*    832 */
  Parrot_defined_i_p_kc,                             /*    833 */
  Parrot_exists_i_p_ki,                              /*    834 */
  Parrot_exists_i_p_kic,                             /*    835 */
  Parrot_exists_i_p_k,                               /*    836 */
  Parrot_exists_i_p_kc,                              /*    837 */
  Parrot_delete_p_k,                                 /*    838 */
  Parrot_delete_p_kc,                                /*    839 */
  Parrot_delete_p_ki,                                /*    840 */
  Parrot_delete_p_kic,                               /*    841 */
  Parrot_elements_i_p,                               /*    842 */
  Parrot_push_p_i,                                   /*    843 */
  Parrot_push_p_ic,                                  /*    844 */
  Parrot_push_p_n,                                   /*    845 */
  Parrot_push_p_nc,                                  /*    846 */
  Parrot_push_p_s,                                   /*    847 */
  Parrot_push_p_sc,                                  /*    848 */
  Parrot_push_p_p,                                   /*    849 */
  Parrot_pop_i_p,                                    /*    850 */
  Parrot_pop_n_p,                                    /*    851 */
  Parrot_pop_s_p,                                    /*    852 */
  Parrot_pop_p_p,                                    /*    853 */
  Parrot_unshift_p_i,                                /*    854 */
  Parrot_unshift_p_ic,                               /*    855 */
  Parrot_unshift_p_n,                                /*    856 */
  Parrot_unshift_p_nc,                               /*    857 */
  Parrot_unshift_p_s,                                /*    858 */
  Parrot_unshift_p_sc,                               /*    859 */
  Parrot_unshift_p_p,                                /*    860 */
  Parrot_shift_i_p,                                  /*    861 */
  Parrot_shift_n_p,                                  /*    862 */
  Parrot_shift_s_p,                                  /*    863 */
  Parrot_shift_p_p,                                  /*    864 */
  Parrot_splice_p_p_i_i,                             /*    865 */
  Parrot_splice_p_p_ic_i,                            /*    866 */
  Parrot_splice_p_p_i_ic,                            /*    867 */
  Parrot_splice_p_p_ic_ic,                           /*    868 */
  Parrot_setprop_p_s_p,                              /*    869 */
  Parrot_setprop_p_sc_p,                             /*    870 */
  Parrot_getprop_p_s_p,                              /*    871 */
  Parrot_getprop_p_sc_p,                             /*    872 */
  Parrot_getprop_p_p_s,                              /*    873 */
  Parrot_getprop_p_p_sc,                             /*    874 */
  Parrot_delprop_p_s,                                /*    875 */
  Parrot_delprop_p_sc,                               /*    876 */
  Parrot_prophash_p_p,                               /*    877 */
  Parrot_freeze_s_p,                                 /*    878 */
  Parrot_thaw_p_s,                                   /*    879 */
  Parrot_thaw_p_sc,                                  /*    880 */
  Parrot_add_multi_s_s_p,                            /*    881 */
  Parrot_add_multi_sc_s_p,                           /*    882 */
  Parrot_add_multi_s_sc_p,                           /*    883 */
  Parrot_add_multi_sc_sc_p,                          /*    884 */
  Parrot_find_multi_p_s_s,                           /*    885 */
  Parrot_find_multi_p_sc_s,                          /*    886 */
  Parrot_find_multi_p_s_sc,                          /*    887 */
  Parrot_find_multi_p_sc_sc,                         /*    888 */
  Parrot_register_p,                                 /*    889 */
  Parrot_unregister_p,                               /*    890 */
  Parrot_box_p_i,                                    /*    891 */
  Parrot_box_p_ic,                                   /*    892 */
  Parrot_box_p_n,                                    /*    893 */
  Parrot_box_p_nc,                                   /*    894 */
  ...
  Parrot_box_p_sc,                                   /*    896 */
  Parrot_iter_p_p,                                   /*    897 */
  Parrot_morph_p_p,                                  /*    898 */
  Parrot_morph_p_pc,                                 /*    899 */
  Parrot_clone_s_s,                                  /*    900 */
  Parrot_clone_s_sc,                                 /*    901 */
  Parrot_set_i_i,                                    /*    902 */
  Parrot_set_i_ic,                                   /*    903 */
  Parrot_set_i_n,                                    /*    904 */
  Parrot_set_i_nc,                                   /*    905 */
  ...
  Parrot_set_p_sc,                                   /*    929 */
  Parrot_set_i_p,                                    /*    930 */
  Parrot_assign_p_p,                                 /*    931 */
  Parrot_assign_p_i,                                 /*    932 */
  Parrot_assign_p_ic,                                /*    933 */
  Parrot_assign_p_n,                                 /*    934 */
  Parrot_assign_p_nc,                                /*    935 */
  Parrot_assign_p_s,                                 /*    936 */
  Parrot_assign_p_sc,                                /*    937 */
  Parrot_assign_s_s,                                 /*    938 */
  Parrot_assign_s_sc,                                /*    939 */
  Parrot_setref_p_p,                                 /*    940 */
  Parrot_deref_p_p,                                  /*    941 */
  Parrot_set_p_ki_i,                                 /*    942 */
  Parrot_set_p_kic_i,                                /*    943 */
  Parrot_set_p_ki_ic,                                /*    944 */
  Parrot_set_p_kic_ic,                               /*    945 */
  Parrot_set_p_ki_n,                                 /*    946 */
  Parrot_set_p_kic_n,                                /*    947 */
  Parrot_set_p_ki_nc,                                /*    948 */
  Parrot_set_p_kic_nc,                               /*    949 */
  Parrot_set_p_ki_s,                                 /*    950 */
  Parrot_set_p_kic_s,                                /*    951 */
  Parrot_set_p_ki_sc,                                /*    952 */
  Parrot_set_p_kic_sc,                               /*    953 */
  Parrot_set_p_ki_p,                                 /*    954 */
  Parrot_set_p_kic_p,                                /*    955 */
  Parrot_set_i_p_ki,                                 /*    956 */
  Parrot_set_i_p_kic,                                /*    957 */
  Parrot_set_n_p_ki,                                 /*    958 */
  Parrot_set_n_p_kic,                                /*    959 */
  Parrot_set_s_p_ki,                                 /*    960 */
  Parrot_set_s_p_kic,                                /*    961 */
  Parrot_set_p_p_ki,                                 /*    962 */
  Parrot_set_p_p_kic,                                /*    963 */
  Parrot_set_p_k_i,                                  /*    964 */
  Parrot_set_p_kc_i,                                 /*    965 */
  Parrot_set_p_k_ic,                                 /*    966 */
  Parrot_set_p_kc_ic,                                /*    967 */
  Parrot_set_p_k_n,                                  /*    968 */
  Parrot_set_p_kc_n,                                 /*    969 */
  Parrot_set_p_k_nc,                                 /*    970 */
  Parrot_set_p_kc_nc,                                /*    971 */
  Parrot_set_p_k_s,                                  /*    972 */
  Parrot_set_p_kc_s,                                 /*    973 */
  Parrot_set_p_k_sc,                                 /*    974 */
  Parrot_set_p_kc_sc,                                /*    975 */
  Parrot_set_p_k_p,                                  /*    976 */
  Parrot_set_p_kc_p,                                 /*    977 */
  Parrot_set_i_p_k,                                  /*    978 */
  Parrot_set_i_p_kc,                                 /*    979 */
  Parrot_set_n_p_k,                                  /*    980 */
  Parrot_set_n_p_kc,                                 /*    981 */
  Parrot_set_s_p_k,                                  /*    982 */
  Parrot_set_s_p_kc,                                 /*    983 */
  Parrot_set_p_p_k,                                  /*    984 */
  Parrot_set_p_p_kc,                                 /*    985 */
  Parrot_clone_p_p,                                  /*    986 */
  Parrot_clone_p_p_p,                                /*    987 */
  Parrot_clone_p_p_pc,                               /*    988 */
  Parrot_copy_p_p,                                   /*    989 */
  Parrot_null_s,                                     /*    990 */
  Parrot_null_i,                                     /*    991 */
  Parrot_null_p,                                     /*    992 */
  ...
  Parrot_ord_i_s,                                    /*    994 */
  Parrot_ord_i_sc,                                   /*    995 */
  Parrot_ord_i_s_i,                                  /*    996 */
  Parrot_ord_i_sc_i,                                 /*    997 */
  Parrot_ord_i_s_ic,                                 /*    998 */
  Parrot_ord_i_sc_ic,                                /*    999 */
  Parrot_chr_s_i,                                    /*   1000 */
  Parrot_chr_s_ic,                                   /*   1001 */
  Parrot_chopn_s_s_i,                                /*   1002 */
  Parrot_chopn_s_sc_i,                               /*   1003 */
  Parrot_chopn_s_s_ic,                               /*   1004 */
  Parrot_chopn_s_sc_ic,                              /*   1005 */
  ...
  Parrot_substr_s_p_i_i,                             /*   1043 */
  Parrot_substr_s_p_ic_i,                            /*   1044 */
  Parrot_substr_s_p_i_ic,                            /*   1045 */
  Parrot_substr_s_p_ic_ic,                           /*   1046 */
  Parrot_replace_s_s_i_i_s,                          /*   1047 */
  Parrot_replace_s_sc_i_i_s,                         /*   1048 */
  Parrot_replace_s_s_ic_i_s,                         /*   1049 */
  Parrot_replace_s_sc_ic_i_s,                        /*   1050 */
  Parrot_replace_s_s_i_ic_s,                         /*   1051 */
  Parrot_replace_s_sc_i_ic_s,                        /*   1052 */
  Parrot_replace_s_s_ic_ic_s,                        /*   1053 */
  Parrot_replace_s_sc_ic_ic_s,                       /*   1054 */
  Parrot_replace_s_s_i_i_sc,                         /*   1055 */
  Parrot_replace_s_sc_i_i_sc,                        /*   1056 */
  Parrot_replace_s_s_ic_i_sc,                        /*   1057 */
  Parrot_replace_s_sc_ic_i_sc,                       /*   1058 */
  Parrot_replace_s_s_i_ic_sc,                        /*   1059 */
  Parrot_replace_s_sc_i_ic_sc,                       /*   1060 */
  Parrot_replace_s_s_ic_ic_sc,                       /*   1061 */
  Parrot_replace_s_sc_ic_ic_sc,                      /*   1062 */
  ...
  Parrot_rindex_i_s_s,                               /*   1075 */
  Parrot_rindex_i_sc_s,                              /*   1076 */
  Parrot_rindex_i_s_sc,                              /*   1077 */
  Parrot_rindex_i_sc_sc,                             /*   1078 */
  Parrot_rindex_i_s_s_i,                             /*   1079 */
  Parrot_rindex_i_sc_s_i,                            /*   1080 */
  Parrot_rindex_i_s_sc_i,                            /*   1081 */
  Parrot_rindex_i_sc_sc_i,                           /*   1082 */
  Parrot_rindex_i_s_s_ic,                            /*   1083 */
  Parrot_rindex_i_sc_s_ic,                           /*   1084 */
  Parrot_rindex_i_s_sc_ic,                           /*   1085 */
  Parrot_rindex_i_sc_sc_ic,                          /*   1086 */
  Parrot_sprintf_s_s_p,                              /*   1087 */
  Parrot_sprintf_s_sc_p,                             /*   1088 */
  Parrot_sprintf_p_p_p,                              /*   1089 */
  Parrot_new_s,                                      /*   1090 */
  Parrot_stringinfo_i_s_i,                           /*   1091 */
  Parrot_stringinfo_i_sc_i,                          /*   1092 */
  Parrot_stringinfo_i_s_ic,                          /*   1093 */
  Parrot_stringinfo_i_sc_ic,                         /*   1094 */
  Parrot_upcase_s_s,                                 /*   1095 */
  Parrot_upcase_s_sc,                                /*   1096 */
  Parrot_downcase_s_s,                               /*   1097 */
  Parrot_downcase_s_sc,                              /*   1098 */
  Parrot_titlecase_s_s,                              /*   1099 */
  Parrot_titlecase_s_sc,                             /*   1100 */
  Parrot_join_s_s_p,                                 /*   1101 */
  Parrot_join_s_sc_p,                                /*   1102 */
  Parrot_split_p_s_s,                                /*   1103 */
  Parrot_split_p_sc_s,                               /*   1104 */
  Parrot_split_p_s_sc,                               /*   1105 */
  Parrot_split_p_sc_sc,                              /*   1106 */
  ...
  Parrot_trans_encoding_s_s_i,                       /*   1113 */
  Parrot_trans_encoding_s_sc_i,                      /*   1114 */
  Parrot_trans_encoding_s_s_ic,                      /*   1115 */
  Parrot_trans_encoding_s_sc_ic,                     /*   1116 */
  Parrot_is_cclass_i_i_s_i,                          /*   1117 */
  Parrot_is_cclass_i_ic_s_i,                         /*   1118 */
  Parrot_is_cclass_i_i_sc_i,                         /*   1119 */
  Parrot_is_cclass_i_ic_sc_i,                        /*   1120 */
  Parrot_is_cclass_i_i_s_ic,                         /*   1121 */
  Parrot_is_cclass_i_ic_s_ic,                        /*   1122 */
  Parrot_is_cclass_i_i_sc_ic,                        /*   1123 */
  Parrot_is_cclass_i_ic_sc_ic,                       /*   1124 */
  Parrot_find_cclass_i_i_s_i_i,                      /*   1125 */
  Parrot_find_cclass_i_ic_s_i_i,                     /*   1126 */
  Parrot_find_cclass_i_i_sc_i_i,                     /*   1127 */
  Parrot_find_cclass_i_ic_sc_i_i,                    /*   1128 */
  Parrot_find_cclass_i_i_s_ic_i,                     /*   1129 */
  Parrot_find_cclass_i_ic_s_ic_i,                    /*   1130 */
  Parrot_find_cclass_i_i_sc_ic_i,                    /*   1131 */
  Parrot_find_cclass_i_ic_sc_ic_i,                   /*   1132 */
  Parrot_find_cclass_i_i_s_i_ic,                     /*   1133 */
  Parrot_find_cclass_i_ic_s_i_ic,                    /*   1134 */
  Parrot_find_cclass_i_i_sc_i_ic,                    /*   1135 */
  Parrot_find_cclass_i_ic_sc_i_ic,                   /*   1136 */
  Parrot_find_cclass_i_i_s_ic_ic,                    /*   1137 */
  Parrot_find_cclass_i_ic_s_ic_ic,                   /*   1138 */
  Parrot_find_cclass_i_i_sc_ic_ic,                   /*   1139 */
  Parrot_find_cclass_i_ic_sc_ic_ic,                  /*   1140 */
  Parrot_find_not_cclass_i_i_s_i_i,                  /*   1141 */
  Parrot_find_not_cclass_i_ic_s_i_i,                 /*   1142 */
  Parrot_find_not_cclass_i_i_sc_i_i,                 /*   1143 */
  Parrot_find_not_cclass_i_ic_sc_i_i,                /*   1144 */
  Parrot_find_not_cclass_i_i_s_ic_i,                 /*   1145 */
  Parrot_find_not_cclass_i_ic_s_ic_i,                /*   1146 */
  Parrot_find_not_cclass_i_i_sc_ic_i,                /*   1147 */
  Parrot_find_not_cclass_i_ic_sc_ic_i,               /*   1148 */
  Parrot_find_not_cclass_i_i_s_i_ic,                 /*   1149 */
  Parrot_find_not_cclass_i_ic_s_i_ic,                /*   1150 */
  Parrot_find_not_cclass_i_i_sc_i_ic,                /*   1151 */
  Parrot_find_not_cclass_i_ic_sc_i_ic,               /*   1152 */
  Parrot_find_not_cclass_i_i_s_ic_ic,                /*   1153 */
  Parrot_find_not_cclass_i_ic_s_ic_ic,               /*   1154 */
  Parrot_find_not_cclass_i_i_sc_ic_ic,               /*   1155 */
  Parrot_find_not_cclass_i_ic_sc_ic_ic,              /*   1156 */
  Parrot_escape_s_s,                                 /*   1157 */
  Parrot_compose_s_s,                                /*   1158 */
  Parrot_compose_s_sc,                               /*   1159 */
  Parrot_find_codepoint_i_s,                         /*   1160 */
  Parrot_find_codepoint_i_sc,                        /*   1161 */
  ...
  Parrot_time_n,                                     /*   1170 */
  Parrot_sleep_i,                                    /*   1171 */
  Parrot_sleep_ic,                                   /*   1172 */
  Parrot_sleep_n,                                    /*   1173 */
  Parrot_sleep_nc,                                   /*   1174 */
  Parrot_store_lex_s_p,                              /*   1175 */
  Parrot_store_lex_sc_p,                             /*   1176 */
  Parrot_store_lex_s_s,                              /*   1177 */
  Parrot_store_lex_sc_s,                             /*   1178 */
  Parrot_store_lex_s_sc,                             /*   1179 */
  Parrot_store_lex_sc_sc,                            /*   1180 */
  Parrot_store_lex_s_i,                              /*   1181 */
  Parrot_store_lex_sc_i,                             /*   1182 */
  Parrot_store_lex_s_ic,                             /*   1183 */
  Parrot_store_lex_sc_ic,                            /*   1184 */
  Parrot_store_lex_s_n,                              /*   1185 */
  Parrot_store_lex_sc_n,                             /*   1186 */
  Parrot_store_lex_s_nc,                             /*   1187 */
  Parrot_store_lex_sc_nc,                            /*   1188 */
  Parrot_store_dynamic_lex_s_p,                      /*   1189 */
  Parrot_store_dynamic_lex_sc_p,                     /*   1190 */
  Parrot_find_lex_p_s,                               /*   1191 */
  Parrot_find_lex_p_sc,                              /*   1192 */
  Parrot_find_lex_s_s,                               /*   1193 */
  Parrot_find_lex_s_sc,                              /*   1194 */
  Parrot_find_lex_i_s,                               /*   1195 */
  Parrot_find_lex_i_sc,                              /*   1196 */
  Parrot_find_lex_n_s,                               /*   1197 */
  Parrot_find_lex_n_sc,                              /*   1198 */
  Parrot_find_dynamic_lex_p_s,                       /*   1199 */
  Parrot_find_dynamic_lex_p_sc,                      /*   1200 */
  Parrot_find_caller_lex_p_s,                        /*   1201 */
  Parrot_find_caller_lex_p_sc,                       /*   1202 */
  Parrot_get_namespace_p,                            /*   1203 */
  Parrot_get_namespace_p_p,                          /*   1204 */
  Parrot_get_namespace_p_pc,                         /*   1205 */
  Parrot_get_hll_namespace_p,                        /*   1206 */
  Parrot_get_hll_namespace_p_p,                      /*   1207 */
  Parrot_get_hll_namespace_p_pc,                     /*   1208 */
  Parrot_get_root_namespace_p,                       /*   1209 */
  Parrot_get_root_namespace_p_p,                     /*   1210 */
  Parrot_get_root_namespace_p_pc,                    /*   1211 */
  Parrot_get_global_p_s,                             /*   1212 */
  Parrot_get_global_p_sc,                            /*   1213 */
  Parrot_get_global_p_p_s,                           /*   1214 */
  Parrot_get_global_p_pc_s,                          /*   1215 */
  Parrot_get_global_p_p_sc,                          /*   1216 */
  Parrot_get_global_p_pc_sc,                         /*   1217 */
  Parrot_get_hll_global_p_s,                         /*   1218 */
  Parrot_get_hll_global_p_sc,                        /*   1219 */
  Parrot_get_hll_global_p_p_s,                       /*   1220 */
  Parrot_get_hll_global_p_pc_s,                      /*   1221 */
  Parrot_get_hll_global_p_p_sc,                      /*   1222 */
  Parrot_get_hll_global_p_pc_sc,                     /*   1223 */
  Parrot_get_root_global_p_s,                        /*   1224 */
  Parrot_get_root_global_p_sc,                       /*   1225 */
  Parrot_get_root_global_p_p_s,                      /*   1226 */
  Parrot_get_root_global_p_pc_s,                     /*   1227 */
  Parrot_get_root_global_p_p_sc,                     /*   1228 */
  Parrot_get_root_global_p_pc_sc,                    /*   1229 */
  Parrot_set_global_s_p,                             /*   1230 */
  Parrot_set_global_sc_p,                            /*   1231 */
  Parrot_set_global_p_s_p,                           /*   1232 */
  Parrot_set_global_pc_s_p,                          /*   1233 */
  Parrot_set_global_p_sc_p,                          /*   1234 */
  Parrot_set_global_pc_sc_p,                         /*   1235 */
  Parrot_set_hll_global_s_p,                         /*   1236 */
  Parrot_set_hll_global_sc_p,                        /*   1237 */
  Parrot_set_hll_global_p_s_p,                       /*   1238 */
  Parrot_set_hll_global_pc_s_p,                      /*   1239 */
  Parrot_set_hll_global_p_sc_p,                      /*   1240 */
  Parrot_set_hll_global_pc_sc_p,                     /*   1241 */
  Parrot_set_root_global_s_p,                        /*   1242 */
  Parrot_set_root_global_sc_p,                       /*   1243 */
  Parrot_set_root_global_p_s_p,                      /*   1244 */
  Parrot_set_root_global_pc_s_p,                     /*   1245 */
  Parrot_set_root_global_p_sc_p,                     /*   1246 */
  Parrot_set_root_global_pc_sc_p,                    /*   1247 */
  Parrot_find_name_p_s,                              /*   1248 */
  Parrot_find_name_p_sc,                             /*   1249 */
  Parrot_find_sub_not_null_p_s,                      /*   1250 */
  Parrot_find_sub_not_null_p_sc,                     /*   1251 */
  Parrot_trap,                                       /*   1252 */
  Parrot_set_label_p_ic,                             /*   1253 */
  Parrot_get_label_i_p,                              /*   1254 */
  Parrot_get_id_i_p,                                 /*   1255 */
  Parrot_get_id_i_pc,                                /*   1256 */
  Parrot_fetch_p_p_p_p,                              /*   1257 */
  Parrot_fetch_p_pc_p_p,                             /*   1258 */
  Parrot_fetch_p_p_pc_p,                             /*   1259 */
  Parrot_fetch_p_pc_pc_p,                            /*   1260 */
  Parrot_fetch_p_p_p_pc,                             /*   1261 */
  Parrot_fetch_p_pc_p_pc,                            /*   1262 */
  Parrot_fetch_p_p_pc_pc,                            /*   1263 */
  Parrot_fetch_p_pc_pc_pc,                           /*   1264 */
  Parrot_fetch_p_p_i_p,                              /*   1265 */
  Parrot_fetch_p_pc_i_p,                             /*   1266 */
  Parrot_fetch_p_p_ic_p,                             /*   1267 */
  Parrot_fetch_p_pc_ic_p,                            /*   1268 */
  Parrot_fetch_p_p_i_pc,                             /*   1269 */
  Parrot_fetch_p_pc_i_pc,                            /*   1270 */
  Parrot_fetch_p_p_ic_pc,                            /*   1271 */
  Parrot_fetch_p_pc_ic_pc,                           /*   1272 */
  Parrot_fetch_p_p_s_p,                              /*   1273 */
  Parrot_fetch_p_pc_s_p,                             /*   1274 */
  Parrot_fetch_p_p_sc_p,                             /*   1275 */
  Parrot_fetch_p_pc_sc_p,                            /*   1276 */
  Parrot_fetch_p_p_s_pc,                             /*   1277 */
  Parrot_fetch_p_pc_s_pc,                            /*   1278 */
  Parrot_fetch_p_p_sc_pc,                            /*   1279 */
  Parrot_fetch_p_pc_sc_pc,                           /*   1280 */
  Parrot_vivify_p_p_p_p,                             /*   1281 */
  Parrot_vivify_p_pc_p_p,                            /*   1282 */
  Parrot_vivify_p_p_pc_p,                            /*   1283 */
  Parrot_vivify_p_pc_pc_p,                           /*   1284 */
  Parrot_vivify_p_p_p_pc,                            /*   1285 */
  Parrot_vivify_p_pc_p_pc,                           /*   1286 */
  Parrot_vivify_p_p_pc_pc,                           /*   1287 */
  Parrot_vivify_p_pc_pc_pc,                          /*   1288 */
  Parrot_vivify_p_p_i_p,                             /*   1289 */
  Parrot_vivify_p_pc_i_p,                            /*   1290 */
  Parrot_vivify_p_p_ic_p,                            /*   1291 */
  Parrot_vivify_p_pc_ic_p,                           /*   1292 */
  Parrot_vivify_p_p_i_pc,                            /*   1293 */
  Parrot_vivify_p_pc_i_pc,                           /*   1294 */
  Parrot_vivify_p_p_ic_pc,                           /*   1295 */
  Parrot_vivify_p_pc_ic_pc,                          /*   1296 */
  Parrot_vivify_p_p_s_p,                             /*   1297 */
  Parrot_vivify_p_pc_s_p,                            /*   1298 */
  Parrot_vivify_p_p_sc_p,                            /*   1299 */
  Parrot_vivify_p_pc_sc_p,                           /*   1300 */
  Parrot_vivify_p_p_s_pc,                            /*   1301 */
  Parrot_vivify_p_pc_s_pc,                           /*   1302 */
  Parrot_vivify_p_p_sc_pc,                           /*   1303 */
  Parrot_vivify_p_pc_sc_pc,                          /*   1304 */
  Parrot_new_p_s_i,                                  /*   1305 */
  Parrot_new_p_sc_i,                                 /*   1306 */
  Parrot_new_p_s_ic,                                 /*   1307 */
  Parrot_new_p_sc_ic,                                /*   1308 */
  Parrot_new_p_p_i,                                  /*   1309 */
  Parrot_new_p_pc_i,                                 /*   1310 */
  Parrot_new_p_p_ic,                                 /*   1311 */
  Parrot_new_p_pc_ic,                                /*   1312 */
  Parrot_root_new_p_p_i,                             /*   1313 */
  Parrot_root_new_p_pc_i,                            /*   1314 */
  Parrot_root_new_p_p_ic,                            /*   1315 */
  Parrot_root_new_p_pc_ic,                           /*   1316 */
  Parrot_get_context_p,                              /*   1317 */
  Parrot_new_call_context_p,                         /*   1318 */
  Parrot_invokecc_p_p,                               /*   1319 */
  Parrot_flatten_array_into_p_p_i,                   /*   1320 */
  Parrot_flatten_array_into_p_p_ic,                  /*   1321 */
  Parrot_flatten_hash_into_p_p_i,                    /*   1322 */
  Parrot_flatten_hash_into_p_p_ic,                   /*   1323 */
  Parrot_slurp_array_from_p_p_i,                     /*   1324 */
  Parrot_slurp_array_from_p_p_ic,                    /*   1325 */
  Parrot_receive_p,                                  /*   1326 */
  Parrot_wait_p,                                     /*   1327 */
  Parrot_wait_pc,                                    /*   1328 */
  Parrot_pass,                                       /*   1329 */
  Parrot_disable_preemption,                         /*   1330 */
  Parrot_enable_preemption,                          /*   1331 */
  Parrot_terminate,                                  /*   1332 */
...
static op_info_t core_op_info_table[1334] = {
  { /* 0 */
    "end",
    "end",
    "Parrot_end",
  ...
  { /* 753 */
    "get_sc_object",
    "get_sc_object_p_sc_i",
    "Parrot_get_sc_object_p_sc_i",
    0,
    4,
  ...
  { /* 754 */
    "get_sc_object",
    "get_sc_object_p_s_ic",
    "Parrot_get_sc_object_p_s_ic",
    0,
    4,
    { PARROT_ARG_P, PARROT_ARG_S, PARROT_ARG_IC },
    { PARROT_ARGDIR_OUT, PARROT_ARGDIR_IN, PARROT_ARGDIR_IN },
  ...
  { /* 755 */
    "get_sc_object",
    "get_sc_object_p_sc_ic",
    "Parrot_get_sc_object_p_sc_ic",
    0,
    4,
    { PARROT_ARG_P, PARROT_ARG_SC, PARROT_ARG_IC },
    { PARROT_ARGDIR_OUT, PARROT_ARGDIR_IN, PARROT_ARGDIR_IN },
  ...
  { /* 761 */
    "set_sc_object",
    "set_sc_object_sc_i_p",
    "Parrot_set_sc_object_sc_i_p",
    0,
    4,
  ...
  { /* 762 */
    "set_sc_object",
    "set_sc_object_s_ic_p",
    "Parrot_set_sc_object_s_ic_p",
    0,
    4,
  ...
  { /* 763 */
    "set_sc_object",
    "set_sc_object_sc_ic_p",
    "Parrot_set_sc_object_sc_ic_p",
    0,
    4,
  ...
  { /* 764 */
    "set_sc_object",
    "set_sc_object_s_i_pc",
    "Parrot_set_sc_object_s_i_pc",
    0,
    4,
  ...
  { /* 765 */
    "set_sc_object",
    "set_sc_object_sc_i_pc",
    "Parrot_set_sc_object_sc_i_pc",
    0,
    4,
  ...
  { /* 766 */
    "set_sc_object",
    "set_sc_object_s_ic_pc",
    "Parrot_set_sc_object_s_ic_pc",
    0,
    4,
  ...
  { /* 767 */
    "set_sc_object",
    "set_sc_object_sc_ic_pc",
    "Parrot_set_sc_object_sc_ic_pc",
    0,
    4,
  ...
  { /* 768 */
    "set_sc_for_object",
    "set_sc_for_object_p_p",
    "Parrot_set_sc_for_object_p_p",
    0,
    3,
    { PARROT_ARG_P, PARROT_ARG_P },
    { PARROT_ARGDIR_IN, PARROT_ARGDIR_IN },
  ...
  { /* 769 */
    "set_sc_for_object",
    "set_sc_for_object_pc_p",
    "Parrot_set_sc_for_object_pc_p",
    0,
    3,
    { PARROT_ARG_PC, PARROT_ARG_P },
    { PARROT_ARGDIR_IN, PARROT_ARGDIR_IN },
  ...
  { /* 770 */
    "set_sc_for_object",
    "set_sc_for_object_p_pc",
    "Parrot_set_sc_for_object_p_pc",
    0,
    3,
    { PARROT_ARG_P, PARROT_ARG_PC },
    { PARROT_ARGDIR_IN, PARROT_ARGDIR_IN },
  ...
  { /* 771 */
    "set_sc_for_object",
    "set_sc_for_object_pc_pc",
    "Parrot_set_sc_for_object_pc_pc",
    0,
    3,
    { PARROT_ARG_PC, PARROT_ARG_PC },
    { PARROT_ARGDIR_IN, PARROT_ARGDIR_IN },
  ...
  { /* 772 */
    "get_sc_for_object",
    "get_sc_for_object_p_p",
    "Parrot_get_sc_for_object_p_p",
    0,
    3,
    { PARROT_ARG_P, PARROT_ARG_P },
    { PARROT_ARGDIR_OUT, PARROT_ARGDIR_IN },
  ...
  { /* 773 */
    "get_sc_for_object",
    "get_sc_for_object_p_pc",
    "Parrot_get_sc_for_object_p_pc",
    0,
    3,
    { PARROT_ARG_P, PARROT_ARG_PC },
    { PARROT_ARGDIR_OUT, PARROT_ARGDIR_IN },
  ...
  { /* 774 */
    "get_package_through_who",
    "get_package_through_who_p_p_s",
    "Parrot_get_package_through_who_p_p_s",
    0,
    4,
    { PARROT_ARG_P, PARROT_ARG_P, PARROT_ARG_S },
    { PARROT_ARGDIR_OUT, PARROT_ARGDIR_IN, PARROT_ARGDIR_IN },
  ...
  { /* 775 */
    "get_package_through_who",
    "get_package_through_who_p_pc_s",
    "Parrot_get_package_through_who_p_pc_s",
    0,
    4,
    { PARROT_ARG_P, PARROT_ARG_PC, PARROT_ARG_S },
    { PARROT_ARGDIR_OUT, PARROT_ARGDIR_IN, PARROT_ARGDIR_IN },
  ...
  { /* 776 */
    "get_package_through_who",
    "get_package_through_who_p_p_sc",
    "Parrot_get_package_through_who_p_p_sc",
    0,
    4,
    { PARROT_ARG_P, PARROT_ARG_P, PARROT_ARG_SC },
    { PARROT_ARGDIR_OUT, PARROT_ARGDIR_IN, PARROT_ARGDIR_IN },
  ...
  { /* 777 */
    "get_package_through_who",
    "get_package_through_who_p_pc_sc",
    "Parrot_get_package_through_who_p_pc_sc",
    0,
    4,
    { PARROT_ARG_P, PARROT_ARG_PC, PARROT_ARG_SC },
    { PARROT_ARGDIR_OUT, PARROT_ARGDIR_IN, PARROT_ARGDIR_IN },
  ...
  { /* 802 */
    "set_invocation_spec",
    "set_invocation_spec_p_p_s_p",
    "Parrot_set_invocation_spec_p_p_s_p",
    0,
    5,
    { PARROT_ARG_P, PARROT_ARG_P, PARROT_ARG_S, PARROT_ARG_P },
    { PARROT_ARGDIR_IN, PARROT_ARGDIR_IN, PARROT_ARGDIR_IN, PARROT_ARGDIR_IN },
  ...
  { /* 803 */
    "set_invocation_spec",
    "set_invocation_spec_p_p_sc_p",
    "Parrot_set_invocation_spec_p_p_sc_p",
    0,
    5,
    { PARROT_ARG_P, PARROT_ARG_P, PARROT_ARG_SC, PARROT_ARG_P },
    { PARROT_ARGDIR_IN, PARROT_ARGDIR_IN, PARROT_ARGDIR_IN, PARROT_ARGDIR_IN },
  ...
  { /* 804 */
    "set_boolification_spec",
    "set_boolification_spec_p_i_p",
    "Parrot_set_boolification_spec_p_i_p",
    0,
    4,
    { PARROT_ARG_P, PARROT_ARG_I, PARROT_ARG_P },
    { PARROT_ARGDIR_IN, PARROT_ARGDIR_IN, PARROT_ARGDIR_IN },
  ...
  { /* 805 */
    "set_boolification_spec",
    "set_boolification_spec_p_ic_p",
    "Parrot_set_boolification_spec_p_ic_p",
    0,
    4,
    { PARROT_ARG_P, PARROT_ARG_IC, PARROT_ARG_P },
    { PARROT_ARGDIR_IN, PARROT_ARGDIR_IN, PARROT_ARGDIR_IN },
...
opcode_t *
Parrot_what_or_null_p_p(opcode_t *cur_opcode, PARROT_INTERP) {
    PMC  * const  var = decontainerize(interp, PREG(2));
...
opcode_t *
Parrot_what_or_null_p_pc(opcode_t *cur_opcode, PARROT_INTERP) {
    PMC  * const  var = decontainerize(interp, PCONST(2));
...
Parrot_set_who_p_p(opcode_t *cur_opcode, PARROT_INTERP) {
    PMC  * const  var = decontainerize(interp, PREG(1));
...
Parrot_set_who_pc_p(opcode_t *cur_opcode, PARROT_INTERP) {
    PMC  * const  var = decontainerize(interp, PCONST(1));
...
Parrot_repr_get_attr_int_i_p_p_s(opcode_t *cur_opcode, PARROT_INTERP) {
    PMC  * const  ch = decontainerize(interp, PREG(3));
...
Parrot_repr_get_attr_int_i_p_pc_s(opcode_t *cur_opcode, PARROT_INTERP) {
    PMC  * const  ch = decontainerize(interp, PCONST(3));
...
Parrot_repr_bind_attr_int_p_p_s_i(opcode_t *cur_opcode, PARROT_INTERP) {
    PMC  * const  ch = decontainerize(interp, PREG(2));
...
Parrot_repr_bind_attr_int_p_pc_s_i(opcode_t *cur_opcode, PARROT_INTERP) {
    PMC  * const  ch = decontainerize(interp, PCONST(2));
...
Parrot_repr_change_type_p_p(opcode_t *cur_opcode, PARROT_INTERP) {
    PMC  * const  obj = decontainerize(interp, PREG(1));
    PMC  * const  new_type = decontainerize(interp, PREG(2));
...
Parrot_repr_change_type_pc_p(opcode_t *cur_opcode, PARROT_INTERP) {
    PMC  * const  obj = decontainerize(interp, PCONST(1));
    PMC  * const  new_type = decontainerize(interp, PREG(2));
...
Parrot_repr_change_type_p_pc(opcode_t *cur_opcode, PARROT_INTERP) {
    PMC  * const  obj = decontainerize(interp, PREG(1));
    PMC  * const  new_type = decontainerize(interp, PCONST(2));
...
Parrot_type_check_i_p_p(opcode_t *cur_opcode, PARROT_INTERP) {
    PMC  * const  val = decontainerize(interp, PREG(2));
    PMC  * const  type = decontainerize(interp, PREG(3));
...
Parrot_type_check_i_pc_p(opcode_t *cur_opcode, PARROT_INTERP) {
    PMC  * const  val = decontainerize(interp, PCONST(2));
    PMC  * const  type = decontainerize(interp, PREG(3));
...
Parrot_type_check_i_p_pc(opcode_t *cur_opcode, PARROT_INTERP) {
    PMC  * const  val = decontainerize(interp, PREG(2));
    PMC  * const  type = decontainerize(interp, PCONST(3));
...
Parrot_publish_type_check_cache_p_p(opcode_t *cur_opcode, PARROT_INTERP) {
    PMC  * const  target = decontainerize(interp, PREG(1));

    if ((target->vtable->base_type == enum_class_SixModelObject)) {
        STable  * const  target_st = STABLE(target);
...
Parrot_publish_type_check_cache_pc_p(opcode_t *cur_opcode, PARROT_INTERP) {
    PMC  * const  target = decontainerize(interp, PCONST(1));
...
Parrot_publish_method_cache_p_p(opcode_t *cur_opcode, PARROT_INTERP) {
    ...
    if ((target->vtable->base_type == enum_class_SixModelObject)) {
        ...
        PMC     * const  iter = VTABLE_get_iter(interp, PREG(2));

        while (VTABLE_get_bool(interp, iter)) {
            STRING  * const  name = VTABLE_shift_string(interp, iter);
            PMC     * const  meth = VTABLE_get_pmc_keyed_str(interp, PREG(2), name);
...
Parrot_publish_method_cache_p_pc(opcode_t *cur_opcode, PARROT_INTERP) {
    ...
    if ((target->vtable->base_type == enum_class_SixModelObject)) {
        STable  * const  target_st = STABLE(target);
        PMC     * const  cache = Parrot_pmc_new(interp, enum_class_Hash);
        PMC     * const  iter = VTABLE_get_iter(interp, PCONST(2));

        while (VTABLE_get_bool(interp, iter)) {
            STRING  * const  name = VTABLE_shift_string(interp, iter);
            PMC     * const  meth = VTABLE_get_pmc_keyed_str(interp, PCONST(2), name);
...
opcode_t *
Parrot_get_sc_object_p_s_i(opcode_t *cur_opcode, PARROT_INTERP) {
...
opcode_t *
Parrot_get_sc_object_p_sc_i(opcode_t *cur_opcode, PARROT_INTERP) {
...
opcode_t *
Parrot_get_sc_object_p_s_ic(opcode_t *cur_opcode, PARROT_INTERP) {
    PMC  * sc = SC_get_sc(interp, SREG(2));
...
opcode_t *
Parrot_get_sc_object_p_sc_ic(opcode_t *cur_opcode, PARROT_INTERP) {
    PMC  * sc = SC_get_sc(interp, SCONST(2));
...
opcode_t *
Parrot_get_sc_p_s(opcode_t *cur_opcode, PARROT_INTERP) {
...
opcode_t *
Parrot_get_sc_p_sc(opcode_t *cur_opcode, PARROT_INTERP) {
...
opcode_t *
Parrot_create_sc_p_s(opcode_t *cur_opcode, PARROT_INTERP) {
    PREG(1) = Parrot_pmc_new(interp, Parrot_pmc_get_type_str(interp, Parrot_str_new(interp, "SerializationContext", 0)));
...
opcode_t *
Parrot_create_sc_p_sc(opcode_t *cur_opcode, PARROT_INTERP) {
    PREG(1) = Parrot_pmc_new(interp, Parrot_pmc_get_type_str(interp, Parrot_str_new(interp, "SerializationContext", 0)));
...
opcode_t *
Parrot_set_sc_object_s_i_p(opcode_t *cur_opcode, PARROT_INTERP) {
...
opcode_t *
Parrot_set_sc_object_sc_i_p(opcode_t *cur_opcode, PARROT_INTERP) {
...
opcode_t *
Parrot_set_sc_object_s_ic_p(opcode_t *cur_opcode, PARROT_INTERP) {
    PMC  * sc = SC_get_sc(interp, SREG(1));
...
opcode_t *
Parrot_set_sc_object_sc_ic_p(opcode_t *cur_opcode, PARROT_INTERP) {
    PMC  * sc = SC_get_sc(interp, SCONST(1));
...
opcode_t *
Parrot_set_sc_object_s_i_pc(opcode_t *cur_opcode, PARROT_INTERP) {
    PMC  * sc = SC_get_sc(interp, SREG(1));
...
opcode_t *
Parrot_set_sc_object_sc_i_pc(opcode_t *cur_opcode, PARROT_INTERP) {
    PMC  * sc = SC_get_sc(interp, SCONST(1));
...
opcode_t *
Parrot_set_sc_object_s_ic_pc(opcode_t *cur_opcode, PARROT_INTERP) {
    PMC  * sc = SC_get_sc(interp, SREG(1));
...
opcode_t *
Parrot_set_sc_object_sc_ic_pc(opcode_t *cur_opcode, PARROT_INTERP) {
    PMC  * sc = SC_get_sc(interp, SCONST(1));
...
opcode_t *
Parrot_set_sc_for_object_p_p(opcode_t *cur_opcode, PARROT_INTERP) {
    if ((PREG(1)->vtable->base_type == enum_class_SixModelObject)) {
        SC_PMC(PREG(1)) = PREG(2);
        PARROT_GC_WRITE_BARRIER(interp, PREG(1));
    }
    else {
        Parrot_ex_throw_from_c_args(interp, NULL, EXCEPTION_INVALID_OPERATION, "Can only use set_sc_for_object with a SixModelObject");
    }
...
opcode_t *
Parrot_set_sc_for_object_pc_p(opcode_t *cur_opcode, PARROT_INTERP) {
    if ((PCONST(1)->vtable->base_type == enum_class_SixModelObject)) {
...
opcode_t *
Parrot_set_sc_for_object_p_pc(opcode_t *cur_opcode, PARROT_INTERP) {
    if ((PREG(1)->vtable->base_type == enum_class_SixModelObject)) {
...
opcode_t *
Parrot_set_sc_for_object_pc_pc(opcode_t *cur_opcode, PARROT_INTERP) {
    if ((PCONST(1)->vtable->base_type == enum_class_SixModelObject)) {
...
opcode_t *
Parrot_get_sc_for_object_p_p(opcode_t *cur_opcode, PARROT_INTERP) {
    if ((PREG(2)->vtable->base_type == enum_class_SixModelObject)) {
        PREG(1) = SC_PMC(PREG(2));
    }
    else {
        Parrot_ex_throw_from_c_args(interp, NULL, EXCEPTION_INVALID_OPERATION, "Can only use get_sc_for_object with a SixModelObject");
    }
...
opcode_t *
Parrot_get_sc_for_object_p_pc(opcode_t *cur_opcode, PARROT_INTERP) {
    if ((PCONST(2)->vtable->base_type == enum_class_SixModelObject)) {
...
opcode_t *
Parrot_get_package_through_who_p_p_s(opcode_t *cur_opcode, PARROT_INTERP) {
    if ((PREG(2)->vtable->base_type == enum_class_SixModelObject)) {
        PMC  * const  who = STABLE(PREG(2))->WHO;
        PMC  *  pkg = VTABLE_get_pmc_keyed_str(interp, who, SREG(3));

        if (PMC_IS_NULL(pkg)) {
            PMC  * const  old_ctx = Parrot_pcc_get_signature(interp, CURRENT_CONTEXT(interp));
            PMC  * const  KnowHOW = VTABLE_get_pmc_keyed_int(interp, interp->iglobals, IGLOBALS_KNOWHOW);
            PMC  * const  meth = VTABLE_find_method(interp, KnowHOW, Parrot_str_new(interp, "new_type", 0));
        ...
        Parrot_ex_throw_from_c_args(interp, NULL, EXCEPTION_INVALID_OPERATION, "Can only use get_package_through_who with a SixModelObject");
    }
...
opcode_t *
Parrot_get_package_through_who_p_pc_s(opcode_t *cur_opcode, PARROT_INTERP) {
    if ((PCONST(2)->vtable->base_type == enum_class_SixModelObject)) {
        PMC  * const  who = STABLE(PCONST(2))->WHO;
        PMC  *  pkg = VTABLE_get_pmc_keyed_str(interp, who, SREG(3));
...
opcode_t *
Parrot_get_package_through_who_p_p_sc(opcode_t *cur_opcode, PARROT_INTERP) {
    if ((PREG(2)->vtable->base_type == enum_class_SixModelObject)) {
        PMC  * const  who = STABLE(PREG(2))->WHO;
...
opcode_t *
Parrot_get_package_through_who_p_pc_sc(opcode_t *cur_opcode, PARROT_INTERP) {
    if ((PCONST(2)->vtable->base_type == enum_class_SixModelObject)) {
        PMC  * const  who = STABLE(PCONST(2))->WHO;
        PMC  *  pkg = VTABLE_get_pmc_keyed_str(interp, who, SCONST(3));
...
Parrot_set_container_spec_p_p_s_p(opcode_t *cur_opcode, PARROT_INTERP) {
    if ((PREG(1)->vtable->base_type == enum_class_SixModelObject)) {
        STable  * const  st = STABLE(PREG(1));
        ContainerSpec  * const  new_spec = mem_allocate_zeroed_typed(ContainerSpec);
...
Parrot_set_container_spec_pc_p_s_p(opcode_t *cur_opcode, PARROT_INTERP) {
    if ((PCONST(1)->vtable->base_type == enum_class_SixModelObject)) {
        STable  * const  st = STABLE(PCONST(1));
        ContainerSpec  * const  new_spec = mem_allocate_zeroed_typed(ContainerSpec);
...
opcode_t *
Parrot_set_invocation_spec_p_p_s_p(opcode_t *cur_opcode, PARROT_INTERP) {
    if ((PREG(1)->vtable->base_type == enum_class_SixModelObject)) {
        STable  * st = STABLE(PREG(1));
        InvocationSpec  * const  new_spec = mem_allocate_zeroed_typed(InvocationSpec);

        new_spec->value_slot.class_handle = PREG(2);
        new_spec->value_slot.attr_name = SREG(3);
        new_spec->value_slot.hint = NO_HINT;
        new_spec->invocation_handler = PREG(4);
        ...
        Parrot_ex_throw_from_c_args(interp, NULL, EXCEPTION_INVALID_OPERATION, "Can only use set_invocation_spec with a SixModelObject");
    }
...
opcode_t *
Parrot_set_invocation_spec_p_p_sc_p(opcode_t *cur_opcode, PARROT_INTERP) {
    if ((PREG(1)->vtable->base_type == enum_class_SixModelObject)) {
        STable  * st = STABLE(PREG(1));
        InvocationSpec  * const  new_spec = mem_allocate_zeroed_typed(InvocationSpec);
...
opcode_t *
Parrot_set_boolification_spec_p_i_p(opcode_t *cur_opcode, PARROT_INTERP) {
    PMC  * target = decontainerize(interp, PREG(1));

    if (((IREG(2) == BOOL_MODE_CALL_METHOD) && PMC_IS_NULL(PREG(3)))) {
        Parrot_ex_throw_from_c_args(interp, NULL, 1, "Boolification mode for type is set to 'call method', but method not specified");
    }

    if ((target->vtable->base_type == enum_class_SixModelObject)) {
        STable  * st = STABLE(target);
        BoolificationSpec  * const  new_spec = mem_allocate_zeroed_typed(BoolificationSpec);

        new_spec->mode = IREG(2);
        new_spec->method = PREG(3);
        ...
        Parrot_ex_throw_from_c_args(interp, NULL, EXCEPTION_INVALID_OPERATION, "Can only use set_boolification_spec with a SixModelObject");
    }
...
opcode_t *
Parrot_set_boolification_spec_p_ic_p(opcode_t *cur_opcode, PARROT_INTERP) {
    PMC  * target = decontainerize(interp, PREG(1));

    if (((ICONST(2) == BOOL_MODE_CALL_METHOD) && PMC_IS_NULL(PREG(3)))) {
        Parrot_ex_throw_from_c_args(interp, NULL, 1, "Boolification mode for type is set to 'call method', but method not specified");
    }
