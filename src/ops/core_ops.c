...
static op_func_t core_op_func_table[1128] = {
  ...
  Parrot_foldcase_s_s,                               /*    896 */
  Parrot_foldcase_s_sc,                              /*    897 */
  Parrot_join_s_s_p,                                 /*    898 */
  Parrot_join_s_sc_p,                                /*    899 */
  Parrot_split_p_s_s,                                /*    900 */
  Parrot_split_p_sc_s,                               /*    901 */
  Parrot_split_p_s_sc,                               /*    902 */
  Parrot_split_p_sc_sc,                              /*    903 */
  Parrot_encoding_i_s,                               /*    904 */
  Parrot_encoding_i_sc,                              /*    905 */
  Parrot_encodingname_s_i,                           /*    906 */
  Parrot_encodingname_s_ic,                          /*    907 */
  Parrot_find_encoding_i_s,                          /*    908 */
  Parrot_find_encoding_i_sc,                         /*    909 */
  Parrot_trans_encoding_s_s_i,                       /*    910 */
  Parrot_trans_encoding_s_sc_i,                      /*    911 */
  Parrot_trans_encoding_s_s_ic,                      /*    912 */
  Parrot_trans_encoding_s_sc_ic,                     /*    913 */
  Parrot_is_cclass_i_i_s_i,                          /*    914 */
  Parrot_is_cclass_i_ic_s_i,                         /*    915 */
  Parrot_is_cclass_i_i_sc_i,                         /*    916 */
  Parrot_is_cclass_i_ic_sc_i,                        /*    917 */
  Parrot_is_cclass_i_i_s_ic,                         /*    918 */
  Parrot_is_cclass_i_ic_s_ic,                        /*    919 */
  Parrot_is_cclass_i_i_sc_ic,                        /*    920 */
  Parrot_is_cclass_i_ic_sc_ic,                       /*    921 */
  Parrot_find_cclass_i_i_s_i_i,                      /*    922 */
  Parrot_find_cclass_i_ic_s_i_i,                     /*    923 */
  Parrot_find_cclass_i_i_sc_i_i,                     /*    924 */
  Parrot_find_cclass_i_ic_sc_i_i,                    /*    925 */
  Parrot_find_cclass_i_i_s_ic_i,                     /*    926 */
  Parrot_find_cclass_i_ic_s_ic_i,                    /*    927 */
  Parrot_find_cclass_i_i_sc_ic_i,                    /*    928 */
  Parrot_find_cclass_i_ic_sc_ic_i,                   /*    929 */
  Parrot_find_cclass_i_i_s_i_ic,                     /*    930 */
  Parrot_find_cclass_i_ic_s_i_ic,                    /*    931 */
  Parrot_find_cclass_i_i_sc_i_ic,                    /*    932 */
  Parrot_find_cclass_i_ic_sc_i_ic,                   /*    933 */
  Parrot_find_cclass_i_i_s_ic_ic,                    /*    934 */
  Parrot_find_cclass_i_ic_s_ic_ic,                   /*    935 */
  Parrot_find_cclass_i_i_sc_ic_ic,                   /*    936 */
  Parrot_find_cclass_i_ic_sc_ic_ic,                  /*    937 */
  Parrot_find_not_cclass_i_i_s_i_i,                  /*    938 */
  Parrot_find_not_cclass_i_ic_s_i_i,                 /*    939 */
  Parrot_find_not_cclass_i_i_sc_i_i,                 /*    940 */
  Parrot_find_not_cclass_i_ic_sc_i_i,                /*    941 */
  Parrot_find_not_cclass_i_i_s_ic_i,                 /*    942 */
  Parrot_find_not_cclass_i_ic_s_ic_i,                /*    943 */
  Parrot_find_not_cclass_i_i_sc_ic_i,                /*    944 */
  Parrot_find_not_cclass_i_ic_sc_ic_i,               /*    945 */
  Parrot_find_not_cclass_i_i_s_i_ic,                 /*    946 */
  Parrot_find_not_cclass_i_ic_s_i_ic,                /*    947 */
  Parrot_find_not_cclass_i_i_sc_i_ic,                /*    948 */
  Parrot_find_not_cclass_i_ic_sc_i_ic,               /*    949 */
  Parrot_find_not_cclass_i_i_s_ic_ic,                /*    950 */
  Parrot_find_not_cclass_i_ic_s_ic_ic,               /*    951 */
  Parrot_find_not_cclass_i_i_sc_ic_ic,               /*    952 */
  Parrot_find_not_cclass_i_ic_sc_ic_ic,              /*    953 */
  Parrot_escape_s_s,                                 /*    954 */
  Parrot_compose_s_s,                                /*    955 */
  Parrot_compose_s_sc,                               /*    956 */
  Parrot_find_codepoint_i_s,                         /*    957 */
  Parrot_find_codepoint_i_sc,                        /*    958 */
  Parrot_spawnw_i_s,                                 /*    959 */
  Parrot_spawnw_i_sc,                                /*    960 */
  Parrot_spawnw_i_p,                                 /*    961 */
  Parrot_err_i,                                      /*    962 */
  Parrot_err_s,                                      /*    963 */
  Parrot_err_s_i,                                    /*    964 */
  Parrot_err_s_ic,                                   /*    965 */
  ...
  Parrot_sleep_n,                                    /*    970 */
  Parrot_sleep_nc,                                   /*    971 */
  Parrot_store_lex_s_p,                              /*    972 */
  Parrot_store_lex_sc_p,                             /*    973 */
  Parrot_store_lex_s_s,                              /*    974 */
  Parrot_store_lex_sc_s,                             /*    975 */
  Parrot_store_lex_s_sc,                             /*    976 */
  Parrot_store_lex_sc_sc,                            /*    977 */
  Parrot_store_lex_s_i,                              /*    978 */
  Parrot_store_lex_sc_i,                             /*    979 */
  Parrot_store_lex_s_ic,                             /*    980 */
  Parrot_store_lex_sc_ic,                            /*    981 */
  Parrot_store_lex_s_n,                              /*    982 */
  Parrot_store_lex_sc_n,                             /*    983 */
  Parrot_store_lex_s_nc,                             /*    984 */
  Parrot_store_lex_sc_nc,                            /*    985 */
  Parrot_store_dynamic_lex_s_p,                      /*    986 */
  Parrot_store_dynamic_lex_sc_p,                     /*    987 */
  Parrot_find_lex_p_s,                               /*    988 */
  Parrot_find_lex_p_sc,                              /*    989 */
  Parrot_find_lex_s_s,                               /*    990 */
  Parrot_find_lex_s_sc,                              /*    991 */
  Parrot_find_lex_i_s,                               /*    992 */
  Parrot_find_lex_i_sc,                              /*    993 */
  Parrot_find_lex_n_s,                               /*    994 */
  Parrot_find_lex_n_sc,                              /*    995 */
  Parrot_find_dynamic_lex_p_s,                       /*    996 */
  Parrot_find_dynamic_lex_p_sc,                      /*    997 */
  Parrot_find_caller_lex_p_s,                        /*    998 */
  Parrot_find_caller_lex_p_sc,                       /*    999 */
  Parrot_get_namespace_p,                            /*   1000 */
  Parrot_get_namespace_p_p,                          /*   1001 */
  Parrot_get_namespace_p_pc,                         /*   1002 */
  Parrot_get_hll_namespace_p,                        /*   1003 */
  Parrot_get_hll_namespace_p_p,                      /*   1004 */
  Parrot_get_hll_namespace_p_pc,                     /*   1005 */
  Parrot_get_root_namespace_p,                       /*   1006 */
  Parrot_get_root_namespace_p_p,                     /*   1007 */
  Parrot_get_root_namespace_p_pc,                    /*   1008 */
  Parrot_get_global_p_s,                             /*   1009 */
  Parrot_get_global_p_sc,                            /*   1010 */
  Parrot_get_global_p_p_s,                           /*   1011 */
  Parrot_get_global_p_pc_s,                          /*   1012 */
  Parrot_get_global_p_p_sc,                          /*   1013 */
  Parrot_get_global_p_pc_sc,                         /*   1014 */
  Parrot_get_hll_global_p_s,                         /*   1015 */
  Parrot_get_hll_global_p_sc,                        /*   1016 */
  Parrot_get_hll_global_p_p_s,                       /*   1017 */
  Parrot_get_hll_global_p_pc_s,                      /*   1018 */
  Parrot_get_hll_global_p_p_sc,                      /*   1019 */
  Parrot_get_hll_global_p_pc_sc,                     /*   1020 */
  Parrot_get_root_global_p_s,                        /*   1021 */
  Parrot_get_root_global_p_sc,                       /*   1022 */
  Parrot_get_root_global_p_p_s,                      /*   1023 */
  Parrot_get_root_global_p_pc_s,                     /*   1024 */
  Parrot_get_root_global_p_p_sc,                     /*   1025 */
  Parrot_get_root_global_p_pc_sc,                    /*   1026 */
  Parrot_set_global_s_p,                             /*   1027 */
  Parrot_set_global_sc_p,                            /*   1028 */
  Parrot_set_global_p_s_p,                           /*   1029 */
  Parrot_set_global_pc_s_p,                          /*   1030 */
  Parrot_set_global_p_sc_p,                          /*   1031 */
  Parrot_set_global_pc_sc_p,                         /*   1032 */
  Parrot_set_hll_global_s_p,                         /*   1033 */
  Parrot_set_hll_global_sc_p,                        /*   1034 */
  Parrot_set_hll_global_p_s_p,                       /*   1035 */
  Parrot_set_hll_global_pc_s_p,                      /*   1036 */
  Parrot_set_hll_global_p_sc_p,                      /*   1037 */
  Parrot_set_hll_global_pc_sc_p,                     /*   1038 */
  Parrot_set_root_global_s_p,                        /*   1039 */
  Parrot_set_root_global_sc_p,                       /*   1040 */
  Parrot_set_root_global_p_s_p,                      /*   1041 */
  Parrot_set_root_global_pc_s_p,                     /*   1042 */
  Parrot_set_root_global_p_sc_p,                     /*   1043 */
  Parrot_set_root_global_pc_sc_p,                    /*   1044 */
  Parrot_find_name_p_s,                              /*   1045 */
  Parrot_find_name_p_sc,                             /*   1046 */
  Parrot_find_sub_not_null_p_s,                      /*   1047 */
  Parrot_find_sub_not_null_p_sc,                     /*   1048 */
  Parrot_trap,                                       /*   1049 */
  Parrot_set_label_p_ic,                             /*   1050 */
  Parrot_get_label_i_p,                              /*   1051 */
  Parrot_get_id_i_p,                                 /*   1052 */
  Parrot_get_id_i_pc,                                /*   1053 */
  Parrot_fetch_p_p_p_p,                              /*   1054 */
  Parrot_fetch_p_pc_p_p,                             /*   1055 */
  Parrot_fetch_p_p_pc_p,                             /*   1056 */
  Parrot_fetch_p_pc_pc_p,                            /*   1057 */
  Parrot_fetch_p_p_p_pc,                             /*   1058 */
  Parrot_fetch_p_pc_p_pc,                            /*   1059 */
  Parrot_fetch_p_p_pc_pc,                            /*   1060 */
  Parrot_fetch_p_pc_pc_pc,                           /*   1061 */
  Parrot_fetch_p_p_i_p,                              /*   1062 */
  Parrot_fetch_p_pc_i_p,                             /*   1063 */
  Parrot_fetch_p_p_ic_p,                             /*   1064 */
  Parrot_fetch_p_pc_ic_p,                            /*   1065 */
  Parrot_fetch_p_p_i_pc,                             /*   1066 */
  Parrot_fetch_p_pc_i_pc,                            /*   1067 */
  Parrot_fetch_p_p_ic_pc,                            /*   1068 */
  Parrot_fetch_p_pc_ic_pc,                           /*   1069 */
  Parrot_fetch_p_p_s_p,                              /*   1070 */
  Parrot_fetch_p_pc_s_p,                             /*   1071 */
  Parrot_fetch_p_p_sc_p,                             /*   1072 */
  Parrot_fetch_p_pc_sc_p,                            /*   1073 */
  Parrot_fetch_p_p_s_pc,                             /*   1074 */
  Parrot_fetch_p_pc_s_pc,                            /*   1075 */
  Parrot_fetch_p_p_sc_pc,                            /*   1076 */
  Parrot_fetch_p_pc_sc_pc,                           /*   1077 */
  Parrot_vivify_p_p_p_p,                             /*   1078 */
  Parrot_vivify_p_pc_p_p,                            /*   1079 */
  Parrot_vivify_p_p_pc_p,                            /*   1080 */
  Parrot_vivify_p_pc_pc_p,                           /*   1081 */
  Parrot_vivify_p_p_p_pc,                            /*   1082 */
  Parrot_vivify_p_pc_p_pc,                           /*   1083 */
  Parrot_vivify_p_p_pc_pc,                           /*   1084 */
  Parrot_vivify_p_pc_pc_pc,                          /*   1085 */
  Parrot_vivify_p_p_i_p,                             /*   1086 */
  Parrot_vivify_p_pc_i_p,                            /*   1087 */
  Parrot_vivify_p_p_ic_p,                            /*   1088 */
  Parrot_vivify_p_pc_ic_p,                           /*   1089 */
  Parrot_vivify_p_p_i_pc,                            /*   1090 */
  Parrot_vivify_p_pc_i_pc,                           /*   1091 */
  Parrot_vivify_p_p_ic_pc,                           /*   1092 */
  Parrot_vivify_p_pc_ic_pc,                          /*   1093 */
  Parrot_vivify_p_p_s_p,                             /*   1094 */
  Parrot_vivify_p_pc_s_p,                            /*   1095 */
  Parrot_vivify_p_p_sc_p,                            /*   1096 */
  Parrot_vivify_p_pc_sc_p,                           /*   1097 */
  Parrot_vivify_p_p_s_pc,                            /*   1098 */
  Parrot_vivify_p_pc_s_pc,                           /*   1099 */
  Parrot_vivify_p_p_sc_pc,                           /*   1100 */
  Parrot_vivify_p_pc_sc_pc,                          /*   1101 */
  Parrot_new_p_s_i,                                  /*   1102 */
  Parrot_new_p_sc_i,                                 /*   1103 */
  Parrot_new_p_s_ic,                                 /*   1104 */
  Parrot_new_p_sc_ic,                                /*   1105 */
  Parrot_new_p_p_i,                                  /*   1106 */
  Parrot_new_p_pc_i,                                 /*   1107 */
  Parrot_new_p_p_ic,                                 /*   1108 */
  Parrot_new_p_pc_ic,                                /*   1109 */
  Parrot_root_new_p_p_i,                             /*   1110 */
  Parrot_root_new_p_pc_i,                            /*   1111 */
  Parrot_root_new_p_p_ic,                            /*   1112 */
  Parrot_root_new_p_pc_ic,                           /*   1113 */
  Parrot_get_context_p,                              /*   1114 */
  Parrot_new_call_context_p,                         /*   1115 */
  Parrot_invokecc_p_p,                               /*   1116 */
  Parrot_flatten_array_into_p_p_i,                   /*   1117 */
  Parrot_flatten_array_into_p_p_ic,                  /*   1118 */
  Parrot_flatten_hash_into_p_p_i,                    /*   1119 */
  Parrot_flatten_hash_into_p_p_ic,                   /*   1120 */
  Parrot_slurp_array_from_p_p_i,                     /*   1121 */
  Parrot_slurp_array_from_p_p_ic,                    /*   1122 */
  Parrot_receive_p,                                  /*   1123 */
  Parrot_wait_p,                                     /*   1124 */
  Parrot_wait_pc,                                    /*   1125 */
  Parrot_pass,                                       /*   1126 */
