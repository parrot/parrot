...
=item C<void Parrot_hash_chash_destroy_values(PARROT_INTERP, Hash *hash, value_free
func)>
...
=item C<void* Parrot_hash_key_from_int(PARROT_INTERP, const Hash *hash, INTVAL key)>
...
=item C<void* Parrot_hash_key_from_string(PARROT_INTERP, const Hash *hash, STRING
*key)>
...
=item C<void* Parrot_hash_key_from_pmc(PARROT_INTERP, const Hash *hash, PMC *key)>
...
=item C<INTVAL Parrot_hash_key_to_int(PARROT_INTERP, const Hash *hash, void *key)>
...
=item C<STRING* Parrot_hash_key_to_string(PARROT_INTERP, const Hash *hash, void *key)>
...
=item C<PMC* Parrot_hash_key_to_pmc(PARROT_INTERP, const Hash * const hash, void *key)>
...
=item C<void* Parrot_hash_value_from_string(PARROT_INTERP, const Hash *hash, STRING
*value)>
...
=item C<void* Parrot_hash_value_from_pmc(PARROT_INTERP, const Hash *hash, PMC *value)>
...
=item C<void* Parrot_hash_value_from_number(PARROT_INTERP, const Hash *hash, FLOATVAL
value)>
...
=item C<INTVAL Parrot_hash_value_to_int(PARROT_INTERP, const Hash *hash, void *value)>
...
=item C<STRING* Parrot_hash_value_to_string(PARROT_INTERP, const Hash *hash, void
*value)>
...
=item C<PMC* Parrot_hash_value_to_pmc(PARROT_INTERP, const Hash *hash, void *value)>
...
=item C<FLOATVAL Parrot_hash_value_to_number(PARROT_INTERP, const Hash *hash, void
*value)>
