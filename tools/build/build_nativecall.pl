...
tools/build/build_nativecall.pl - Build up the native call routines

=head1 SYNOPSIS

    % perl tools/build/build_nativecall.pl src/call_list.txt
 ...
 *
 * This file is generated automatically by tools/build/build_nativecall.pl.
 *
