...
my $cwd = cwd();
{
    ...
    mkpath ( [ $corejitdir ], 0, 0755 ) or croak "Unable to make testing directory";
...

{
    ...
    mkpath ( [ $asmdir ], 0, 0755 ) or croak "Unable to make testing directory";
    mkpath ( [ q{src} ], 0, 0755 ) or croak "Unable to make testing directory";
