...
.sub 'test_keyed_access'
    ...
    $P3 = new ['CallSignature']
    $I1 = $P0['unexisting']
    is($I1, 0, 'get_integer_keyed whith empty CallSignature')

    $N1 = $P0['unexisting']
    is($N1, 0.0, 'get_number_keyed whith empty CallSignature')

    $S1 = $P0['unexisting']
    null $S2
    is($S1, $S2, 'get_string_keyed whith empty CallSignature')

    $P3 = $P0['unexisting']
    null $P4
    is($P3, $P4, 'get_pmc_keyed whith empty CallSignature')
.end
...
.sub 'test_exists'
    ...
    $P1 = new ['CallSignature']
    $I0 = exists $P1[1]
    nok($I0, 'test exists_keyed_int whith empty CallSignature')

    $P2 = new ['String']
    $P2 = 'unexisting'
    $I0 = exists $P1[$P2]
    nok($I0, 'test exists_keyed whith empty CallSignature')
.end
...
first_eh:
    pop_eh
    ok($I0, 'exception when shift_pmc an empty CallSignature')
...
second_eh:
    pop_eh
    ok($I0, 'exception when shift_string an empty CallSignature')
.end
